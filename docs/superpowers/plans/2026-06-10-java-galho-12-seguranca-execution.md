...
8. `## Veja também` — wikilinks SEM backticks, SEM âncoras same-file `[[#...]]`. Sempre: notas do galho + `[[03-Dominios/Tecnologia/Java/Segurança/index|Segurança (MOC do galho)]]` + `[[03-Dominios/Tecnologia/Java/index|Trilha Java]]` + (quando tocar mecanismo AOP/method security/bean) a nota do **Galho 8** + (quando tocar filter/DispatcherServlet/CORS/borda) a nota do **Galho 9** + (nota 06) a Servlet API do **Galho 7** + verbetes do Dicionário.
...
**Files:**
- Create: `03-Dominios/Tecnologia/Java/Segurança/` (pasta)
...
```bash
mkdir -p "03-Dominios/Tecnologia/Java/Segurança"
```

- [ ] **Step 3: Confirmar títulos exatos das notas dos Galhos 7/8/9 (linkadas de volta)**

```bash
ls "03-Dominios/Tecnologia/Java/Spring Core e Boot/" | grep -E "^(06|09|10|17) "
ls "03-Dominios/Tecnologia/Java/Web e APIs REST/" | grep -E "^(06|11|12) "
ls "03-Dominios/Tecnologia/Java/Jakarta EE/" | grep -E "^03 "
```
...
```bash
grep -rn "Galho 12\|galho 12\|planejado" "03-Dominios/Tecnologia/Java/Spring Core e Boot/17 - Actuator e observabilidade.md" "03-Dominios/Tecnologia/Java/Spring Core e Boot/index.md" "03-Dominios/Tecnologia/Java/Web e APIs REST/11 - Interceptors vs Filters.md" "03-Dominios/Tecnologia/Java/Web e APIs REST/12 - Documentando a API com OpenAPI e Swagger.md" "03-Dominios/Tecnologia/Java/Web e APIs REST/index.md" "03-Dominios/Tecnologia/Java/Persistência de dados/index.md"
grep -n "Segurança\|planejado" "03-Dominios/Tecnologia/Java/index.md"
```
...
```bash
grep -nE "^## " "03-Dominios/Tecnologia/Java/Backend/Spring Security.md"
grep -niE "Patient|Doctor|Appointment|MedEspecialista|minha experiência|pentest|incidente memorável|How to explain" "03-Dominios/Tecnologia/Java/Backend/Spring Security.md"
```
...
**Files:**
- Create: `03-Dominios/Tecnologia/Java/Segurança/01 - O que é Spring Security — authn, authz e o filter chain.md`
...
- [ ] **Step 2: Escrever** — `fase: iniciado`, tags `[java, seguranca, iniciado, spring-security, filter-chain]`, aliases `["Spring Security", "o que é Spring Security", "filter chain"]`. **Nota-assinatura da DUPLA fronteira.** Conteúdo:
  ...
  - `## Em entrevista` + `## Veja também` ([[02 - SecurityContext, Authentication e Principal — o usuário atual]], [[06 - A arquitetura do filter chain em profundidade]], **[[03-Dominios/Tecnologia/Java/Web e APIs REST/11 - Interceptors vs Filters|Interceptors vs Filters]]** (o `Filter` genérico vs o `SecurityFilterChain`), **[[03-Dominios/Tecnologia/Java/Web e APIs REST/06 - O pipeline do DispatcherServlet|O pipeline do DispatcherServlet]]** (o chain senta na frente dele), MOC galho, MOC central, verbetes `Spring Security`/`SecurityFilterChain`/`FilterChainProxy`) + `## Referências`.

- [ ] **Step 3: Verificar**
```bash
grep -cE "^## (O que é|Por que importa|Como funciona|Na prática|Armadilhas|Em entrevista|Veja também|Referências)" "03-Dominios/Tecnologia/Java/Segurança/01 - O que é Spring Security — authn, authz e o filter chain.md"
grep -riE "Patient|Doctor|Appointment|MedEspecialista|minha experiência|pentest" "03-Dominios/Tecnologia/Java/Segurança/01 - O que é Spring Security — authn, authz e o filter chain.md"
grep -c "Web e APIs REST/11" "03-Dominios/Tecnologia/Java/Segurança/01 - O que é Spring Security — authn, authz e o filter chain.md"
```
...
**Files:**
- Create: `03-Dominios/Tecnologia/Java/Segurança/02 - SecurityContext, Authentication e Principal — o usuário atual.md`
...
**Files:**
- Create: `03-Dominios/Tecnologia/Java/Segurança/03 - Autenticação — UserDetailsService, AuthenticationManager, Form e Basic.md`
...
**Files:**
- Create: `03-Dominios/Tecnologia/Java/Segurança/04 - Password encoding — BCrypt, Argon2 e o DelegatingPasswordEncoder.md`
...
**Files:**
- Create: `03-Dominios/Tecnologia/Java/Segurança/05 - Autorização baseada em URL — authorizeHttpRequests, roles vs authorities.md`
...
**Files:**
- Create: `03-Dominios/Tecnologia/Java/Segurança/06 - A arquitetura do filter chain em profundidade.md`
...
**Files:**
- Create: `03-Dominios/Tecnologia/Java/Segurança/07 - Method security — @PreAuthorize, @PostAuthorize e SpEL.md`
...
**Files:**
- Create: `03-Dominios/Tecnologia/Java/Segurança/08 - JWT — estrutura, assinatura e validação.md`
...
**Files:**
- Create: `03-Dominios/Tecnologia/Java/Segurança/09 - OAuth2 Resource Server — validando JWT na API.md`
...
**Files:**
- Create: `03-Dominios/Tecnologia/Java/Segurança/10 - CSRF — por que ligado por default e quando desligar.md`
...
**Files:**
- Create: `03-Dominios/Tecnologia/Java/Segurança/11 - CORS — a borda, o preflight e a config de segurança.md`
...
- [ ] **Step 2: Escrever** — `fase: adepto`, tags `[java, seguranca, adepto, cors]`. **Liga a borda do Galho 9 (CORS tratado como config MVC lá).** ≥3 H3s: "CORS é do **browser**, não do servidor (`curl` bypassa — **não é segurança server-side**)", "`CorsConfigurationSource`: origens/métodos/headers/credentials", "O preflight OPTIONS: quando o browser pergunta antes", "`allowedOrigins('*')` + `allowCredentials(true)`: por que o browser rejeita", "CORS no filter chain (Spring Security) vs config MVC (Galho 9)". `## Na prática` — um `CorsConfigurationSource` com `allowedOrigins(List.of("https://app.example.com"))` (neutro!), `allowCredentials(true)`, `maxAge`; `http.cors(Customizer.withDefaults())` (```java). `## Armadilhas` ≥3: (1) `allowedOrigins("*")` + `allowCredentials(true)` (browser rejeita); (2) assumir que CORS protege o servidor (só o browser — `curl`/Postman ignoram; a auth ainda é obrigatória); (3) preflight OPTIONS não permitido (request "complexo" falha). `## Veja também` — [[10 - CSRF — por que ligado por default e quando desligar]], [[06 - A arquitetura do filter chain em profundidade]] (o `CorsFilter` na cadeia), **[[03-Dominios/Tecnologia/Java/Web e APIs REST/11 - Interceptors vs Filters|Interceptors vs Filters]]** (onde o Galho 9 tratou filtros/CORS na camada MVC), verbetes `CORS`.
...
**Files:**
- Create: `03-Dominios/Tecnologia/Java/Segurança/12 - OAuth2 e OIDC Client e os grant types.md`
...
**Files:**
- Create: `03-Dominios/Tecnologia/Java/Segurança/13 - Refresh tokens e revogação de token.md`
...
**Files:**
- Create: `03-Dominios/Tecnologia/Java/Segurança/14 - Autorização avançada — AuthorizationManager, RBAC vs ABAC.md`
...
**Files:**
- Create: `03-Dominios/Tecnologia/Java/Segurança/15 - Session management e security headers.md`
...
**Files:**
- Create: `03-Dominios/Tecnologia/Java/Segurança/16 - OWASP Top 10 no contexto Java.md`
...
**Files:**
- Create: `03-Dominios/Tecnologia/Java/Segurança/17 - Uma request autenticada do token à autorização no método.md`
...
- [ ] **Step 2: Escrever** — `fase: magus`, tags `[java, seguranca, magus, filter-chain, jwt]`. **Capstone-trace.** Conteúdo:
  ...
  - `## Armadilhas` (de raciocínio) ≥3: (1) "o token chega direto no controller" (há o filter chain inteiro antes); (2) "autorização é só no controller" (é URL **e** método — duas camadas); (3) "validar JWT é só checar a assinatura" (`iss`/`aud`/`exp`/`alg` também). `## Veja também` — [[06 - A arquitetura do filter chain em profundidade]], [[09 - OAuth2 Resource Server — validando JWT na API]], [[18 - Capstone — projetando a segurança de uma API Spring production-grade]], **[[03-Dominios/Tecnologia/Java/Spring Core e Boot/09 - AOP e proxies no Spring|AOP e proxies no Spring]]** (o proxy do `@PreAuthorize`), verbetes `BearerTokenAuthenticationFilter`/`ExceptionTranslationFilter`.
...
**Files:**
- Create: `03-Dominios/Tecnologia/Java/Segurança/18 - Capstone — projetando a segurança de uma API Spring production-grade.md`
...
**Files:**
- Create: `03-Dominios/Tecnologia/Java/Segurança/index.md`

- [ ] **Step 1: Escrever** — modelar pelo `03-Dominios/Tecnologia/Java/Programação Reativa/index.md`. Frontmatter: `type: moc`, `status: growing`, `publish: true`, `title: "Segurança"`, tags `[java, seguranca, moc]`, aliases `["Segurança", "Spring Security", "Segurança em Java", "Galho 12 - Segurança"]`, `created`/`updated: 2026-06-10`. Conteúdo:
  ...
  - `## Todas as notas` — Dataview (`FROM "03-Dominios/Tecnologia/Java/Segurança"`, `WHERE type = "concept"`).
  - `## Veja também` — MOC central, **[[03-Dominios/Tecnologia/Java/Spring Core e Boot/index|Spring Core e Boot]]** (o mecanismo AOP), **[[03-Dominios/Tecnologia/Java/Web e APIs REST/index|Web e APIs REST]]** (a borda protegida), **[[03-Dominios/Tecnologia/Java/Jakarta EE/index|Jakarta EE]]** (a Servlet API por baixo), [[Redes e Protocolos]] (HTTPS/TLS), Dicionário; Galhos 13/16/17 como texto "(planejado)" SEM wikilink.

- [ ] **Step 2: Verificar**
```bash
grep -cE "^## (Iniciado|Adepto|Magus|Rotas alternativas)" "03-Dominios/Tecnologia/Java/Segurança/index.md"
grep -c "\[\[" "03-Dominios/Tecnologia/Java/Segurança/index.md"
grep -E "\[\[[^]]*(Galho (13|16|17))" "03-Dominios/Tecnologia/Java/Segurança/index.md"
```
...
```bash
grep -rhoE "Dicionário de Java#[^]|]+" "03-Dominios/Tecnologia/Java/Segurança/" | sort -u
```
...
```bash
grep -nE "^### (CORS|Filter|Servlet|DispatcherServlet|access token|scope|JWT|OAuth2)" "03-Dominios/Tecnologia/Java/Dicionário de Java.md"
```
...
- [ ] **Step 4: Verificar**
```bash
grep -E "^### (SecurityFilterChain|JWT \(JSON|OAuth2 Resource Server|CSRF|OWASP Top 10|@PreAuthorize)" "03-Dominios/Tecnologia/Java/Dicionário de Java.md"
grep -cE "^### " "03-Dominios/Tecnologia/Java/Dicionário de Java.md"
```
...
- [ ] **Step 2: Verificar**
```bash
grep -E "Segurança/index" "03-Dominios/Tecnologia/Java/index.md"
...
**Files:**
- Modify: `03-Dominios/Tecnologia/Java/Backend/Spring Security.md`

- [ ] **Step 1: Ler o tronco e confirmar o frontmatter** (política §9 — ler antes de podar)
```bash
sed -n '1,16p' "03-Dominios/Tecnologia/Java/Backend/Spring Security.md"
```
...
```bash
wc -l "03-Dominios/Tecnologia/Java/Backend/Spring Security.md"
grep -c "Migrado para galho próprio" "03-Dominios/Tecnologia/Java/Backend/Spring Security.md"
grep -riE "Patient|Doctor|Appointment|MedEspecialista|minha experiência|pentest|incidente memorável|How to explain|alg: none" "03-Dominios/Tecnologia/Java/Backend/Spring Security.md"
grep -E "^publish: false" "03-Dominios/Tecnologia/Java/Backend/Spring Security.md"
```
...
```bash
git status --short "03-Dominios/Tecnologia/Java/Backend/Spring Boot.md" "03-Dominios/Tecnologia/Java/Backend/Spring Data JPA.md" "03-Dominios/Tecnologia/Java/Backend/Kafka/" "03-Dominios/Tecnologia/Java/Backend/Testes em Java.md"
```
Expected: **VAZIO** (nenhum outro tronco modificado).

- [ ] **Step 5: Commit** — `git add "03-Dominios/Tecnologia/Java/Backend/Spring Security.md"` && `git commit -m "refactor(java): poda integral do tronco Spring Security — vira hub do galho 12"`
...
**Files:**
- Modify: `03-Dominios/Tecnologia/Java/Spring Core e Boot/17 - Actuator e observabilidade.md`
- Modify: `03-Dominios/Tecnologia/Java/Web e APIs REST/12 - Documentando a API com OpenAPI e Swagger.md`
- Modify: `03-Dominios/Tecnologia/Java/Web e APIs REST/11 - Interceptors vs Filters.md`
...
```bash
grep -rn "Galho 12\|galho 12" "03-Dominios/Tecnologia/Java/Spring Core e Boot/17 - Actuator e observabilidade.md" "03-Dominios/Tecnologia/Java/Web e APIs REST/12 - Documentando a API com OpenAPI e Swagger.md" "03-Dominios/Tecnologia/Java/Web e APIs REST/11 - Interceptors vs Filters.md" "03-Dominios/Tecnologia/Java/Spring Core e Boot/index.md" "03-Dominios/Tecnologia/Java/Web e APIs REST/index.md" "03-Dominios/Tecnologia/Java/Persistência de dados/index.md"
```
...
- [ ] **Step 2: Aplicar os wikilinks** — em cada ponteiro, trocar "Galho 12 (planejado)" pelo wikilink, **mantendo natural a frase** e atualizando `updated: 2026-06-10` no frontmatter de cada arquivo tocado:
  - **Spring Core/17 - Actuator (:52):** "Segurança de endpoints (autenticação e autorização do Actuator) é tema do Galho 12 (planejado)." → "...é tema do galho [[03-Dominios/Tecnologia/Java/Segurança/05 - Autorização baseada em URL — authorizeHttpRequests, roles vs authorities|Segurança]]."
  - **Spring Core/17 - Actuator (:111):** "Proteção com Spring Security é abordada no Galho 12 (planejado)." → "Proteção com Spring Security é abordada no galho [[03-Dominios/Tecnologia/Java/Segurança/05 - Autorização baseada em URL — authorizeHttpRequests, roles vs authorities|Segurança]]."
  - **Spring Core/17 - Actuator (:288):** "...exponha apenas o necessário e proteja com Spring Security (Galho 12, planejado)." → "...exponha apenas o necessário e proteja com Spring Security ([[03-Dominios/Tecnologia/Java/Segurança/index|Galho 12 — Segurança]])."
  - **Web/12 - OpenAPI (:167):** "Segurança de API é assunto do Galho 12 (planejado)." → "Segurança de API é assunto do galho [[03-Dominios/Tecnologia/Java/Segurança/01 - O que é Spring Security — authn, authz e o filter chain|Segurança]]."
  - **Web/11 - Interceptors vs Filters (:357):** "Autenticação, CSRF e autorização pertencem ao Galho 12 (Segurança com Spring Security — planejado), que explora a camada de filtros do Spring Security em profundidade." → "Autenticação, CSRF e autorização pertencem ao galho [[03-Dominios/Tecnologia/Java/Segurança/06 - A arquitetura do filter chain em profundidade|Segurança]], que explora a camada de filtros do Spring Security em profundidade."
  - **Spring Core e Boot/index (:32, parágrafo de fronteira):** "...Spring Security (Galho 12), Testes no ecossistema Spring (Galho 13), e Microservices/Cloud com Spring Cloud (Galhos 16 e 17) são planejados..." → "...Spring Security é o galho [[03-Dominios/Tecnologia/Java/Segurança/index|Segurança]]; Testes no ecossistema Spring (Galho 13) e Microservices/Cloud com Spring Cloud (Galhos 16 e 17) são planejados..." **NÃO tocar o horizonte-list :97.**
  - **Web e APIs REST/index (:32, parágrafo de fronteira):** "...Spring Security (Galho 12), Testes no ecossistema Spring (Galho 13), Microservices (Galho 16) e Spring Cloud (Galho 17) são planejados..." → "...Spring Security é o galho [[03-Dominios/Tecnologia/Java/Segurança/index|Segurança]]; Testes no ecossistema Spring (Galho 13), Microservices (Galho 16) e Spring Cloud (Galho 17) são planejados..." **NÃO tocar o horizonte-list :95.**
  - **Persistência de dados/index (:32, parágrafo de fronteira):** "...segurança de dados (Galho 12), testes de repositório (Galho 13) e dados distribuídos/saga (Galho 16) são planejados, sem cobertura aqui." → "...segurança (incluindo a ponte com `AuditorAware`/`SecurityContext`) é o galho [[03-Dominios/Tecnologia/Java/Segurança/index|Segurança]]; testes de repositório (Galho 13) e dados distribuídos/saga (Galho 16) são planejados, sem cobertura aqui." **NÃO tocar o horizonte-list :92.** (Manter honesto: row-level/field-level fica de leve no Galho 12.)

- [ ] **Step 3: Verificar**
```bash
grep -rn "Galho 12\|galho 12" "03-Dominios/Tecnologia/Java/Spring Core e Boot/17 - Actuator e observabilidade.md" "03-Dominios/Tecnologia/Java/Web e APIs REST/12 - Documentando a API com OpenAPI e Swagger.md" "03-Dominios/Tecnologia/Java/Web e APIs REST/11 - Interceptors vs Filters.md" "03-Dominios/Tecnologia/Java/Spring Core e Boot/index.md" "03-Dominios/Tecnologia/Java/Web e APIs REST/index.md" "03-Dominios/Tecnologia/Java/Persistência de dados/index.md" | grep -iE "planejado" | grep -vE ":(95|97|92):"
grep -rn "Segurança/index\|Segurança/01\|Segurança/05\|Segurança/06" "03-Dominios/Tecnologia/Java/Spring Core e Boot/17 - Actuator e observabilidade.md" "03-Dominios/Tecnologia/Java/Web e APIs REST/12 - Documentando a API com OpenAPI e Swagger.md" "03-Dominios/Tecnologia/Java/Web e APIs REST/11 - Interceptors vs Filters.md" "03-Dominios/Tecnologia/Java/Spring Core e Boot/index.md" "03-Dominios/Tecnologia/Java/Web e APIs REST/index.md" "03-Dominios/Tecnologia/Java/Persistência de dados/index.md"
```
...
```bash
grep -n "segurança reativa (Galho 12)" "03-Dominios/Tecnologia/Java/Programação Reativa/index.md"
```
...
- [ ] **Step 1: 18 notas + MOC**
```bash
ls "03-Dominios/Tecnologia/Java/Segurança/" | sort
```
Expected: 01..18 + index.md (19 arquivos).

- [ ] **Step 2: Fases (5/6/7)**
```bash
for f in "03-Dominios/Tecnologia/Java/Segurança/"[0-9]*.md; do grep -H "^fase:" "$f"; done
```
Expected: 01-05 `iniciado`, 06-11 `adepto`, 12-18 `magus`.

- [ ] **Step 3: Seções obrigatórias (3 por nota)**
```bash
for f in "03-Dominios/Tecnologia/Java/Segurança/"[0-9]*.md; do echo "$f: $(grep -cE '^## (Em entrevista|Armadilhas|Veja também)' "$f")"; done
```
Expected: 3 em todas.

- [ ] **Step 4: Anti-fabricação + estatística inventada + fronteiras (greps decisivos)**
```bash
grep -riE "minha experiência|no meu projeto|josenaldo|Patient|Doctor|Appointment|MedEspecialista|pentest|incidente memorável|medespecialista\.com|% d[ao]s (brechas|ataques|breaches|dev|empresas)|maioria d[ao]s (ataques|brechas)" "03-Dominios/Tecnologia/Java/Segurança/"
grep -rE "\[\[[^]]*(Galho (13|16|17)|Testcontainers|Keycloak|Spring Cloud|circuit breaker|WebFlux Security|ReactiveSecurityContext)" "03-Dominios/Tecnologia/Java/Segurança/"
grep -rn '\[\[#' "03-Dominios/Tecnologia/Java/Segurança/"
```
Expected: **todos VAZIOS**.

- [ ] **Step 5: Dupla fronteira-assinatura (links de volta aos Galhos 8 e 9 presentes; Galho 7 na nota 06)**
```bash
grep -rl "Spring Core e Boot/09" "03-Dominios/Tecnologia/Java/Segurança/" | sort
grep -rl "Spring Core e Boot/10" "03-Dominios/Tecnologia/Java/Segurança/" | sort
grep -rl "Web e APIs REST/(06|11)" "03-Dominios/Tecnologia/Java/Segurança/" | sort
grep -rl "Jakarta EE/03" "03-Dominios/Tecnologia/Java/Segurança/" | sort
```
...
```bash
for f in "03-Dominios/Tecnologia/Java/Segurança/"[0-9]*.md; do echo "$f: $(grep -c '### Frase pronta (inglês)' "$f")"; done
```
Expected: 1 em todas.
...
wc -l "03-Dominios/Tecnologia/Java/Backend/Spring Security.md"
grep -c "Migrado para galho próprio" "03-Dominios/Tecnologia/Java/Backend/Spring Security.md"
grep -riE "Patient|MedEspecialista|How to explain|## Na prática" "03-Dominios/Tecnologia/Java/Backend/Spring Security.md"
git status --short "03-Dominios/Tecnologia/Java/Backend/Spring Boot.md" "03-Dominios/Tecnologia/Java/Backend/Spring Data JPA.md" "03-Dominios/Tecnologia/Java/Backend/Kafka/" "03-Dominios/Tecnologia/Java/Backend/Testes em Java.md"
```
