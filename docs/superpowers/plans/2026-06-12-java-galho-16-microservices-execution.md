...
8. `## Veja também` — wikilinks SEM backticks, SEM âncoras same-file. Sempre: notas do galho + `[[03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/index|Microservices e sistemas distribuídos (MOC do galho)]]` + `[[03-Dominios/Tecnologia/Java/index|Trilha Java]]` + (quando aplicável) a nota da fronteira + verbetes do Dicionário.
...
- **FRONTEIRA-ASSINATURA (linkar de volta, NUNCA re-explicar).** Mapeamento de link-back (paths confirmados na Task 0):
  - **G14 (Mensageria) — atrás:** saga → `03-Dominios/Tecnologia/Java/Mensageria/22 - Saga — transações distribuídas por eventos`; idempotência → `Mensageria/20 - Idempotência — o pilar do at-least-once`; outbox → `Mensageria/21 - O padrão Outbox`; event sourcing/CQRS → `Mensageria/23 - Event sourcing e CQRS`; gRPC → `Mensageria/28 - gRPC em Java — RPC síncrono sobre HTTP_2`; Protobuf → `Mensageria/27 - Protocol Buffers — a IDL e a serialização binária`. **NÃO re-explicar saga/outbox/idempotência/gRPC.**
  - **G12 (Segurança):** OAuth2/OIDC/JWT/filter chain → `03-Dominios/Tecnologia/Java/Segurança/12 - OAuth2 e OIDC Client e os grant types` + `Segurança/index`. **A nota 17 cobre só propagação distribuída (token relay).**
  - **G11 (Reativa):** WebFlux/Netty/backpressure → `03-Dominios/Tecnologia/Java/Programação Reativa/10 - Spring WebFlux — o stack não-bloqueante sobre Netty e o DispatcherHandler` + `Programação Reativa/index`.
  - **G9 (Web/REST):** clientes HTTP/RestClient → `03-Dominios/Tecnologia/Java/Web e APIs REST/15 - Clientes HTTP — RestClient, WebClient, RestTemplate`.
  - **G15 (Build):** multi-módulo/BOM → `03-Dominios/Tecnologia/Java/Build e tooling/12 - Projetos multi-módulo`.
  - **G13 (Testes):** contract testing/Pact → `03-Dominios/Tecnologia/Java/Testes/20 - Contract testing — Pact`.
...
**Files:**
- Create: `03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/` (pasta)

- [ ] **Step 1:** Confirmar `main` limpa: `git status` e `git branch --show-current` (deve ser `main`).
- [ ] **Step 2:** Criar a pasta do galho: `mkdir -p "03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos"`.
- [ ] **Step 3:** Confirmar os paths EXATOS das notas-fronteira (devem existir; usar nos wikilinks):
```bash
ls "03-Dominios/Tecnologia/Java/Mensageria/22 - Saga — transações distribuídas por eventos.md" \
   "03-Dominios/Tecnologia/Java/Mensageria/20 - Idempotência — o pilar do at-least-once.md" \
   "03-Dominios/Tecnologia/Java/Mensageria/21 - O padrão Outbox.md" \
   "03-Dominios/Tecnologia/Java/Mensageria/23 - Event sourcing e CQRS.md" \
   "03-Dominios/Tecnologia/Java/Mensageria/28 - gRPC em Java — RPC síncrono sobre HTTP_2.md" \
   "03-Dominios/Tecnologia/Java/Mensageria/27 - Protocol Buffers — a IDL e a serialização binária.md" \
   "03-Dominios/Tecnologia/Java/Segurança/12 - OAuth2 e OIDC Client e os grant types.md" \
   "03-Dominios/Tecnologia/Java/Programação Reativa/10 - Spring WebFlux — o stack não-bloqueante sobre Netty e o DispatcherHandler.md" \
   "03-Dominios/Tecnologia/Java/Web e APIs REST/15 - Clientes HTTP — RestClient, WebClient, RestTemplate.md" \
   "03-Dominios/Tecnologia/Java/Build e tooling/12 - Projetos multi-módulo.md" \
   "03-Dominios/Tecnologia/Java/Testes/20 - Contract testing — Pact.md"
```
- [ ] **Step 4:** Confirmar a linha do Galho 16 no MOC central e o estado do Dicionário:
```bash
grep -n "16\. Microservices" "03-Dominios/Tecnologia/Java/index.md"   # ~linha 49
grep -c "^### " "03-Dominios/Tecnologia/Java/Dicionário de Java.md"   # baseline ~475
...
```bash
grep -n "## Spring Cloud\|### API timeout\|cascading\|### Distributed tracing\|## Quando usar\|Resilience4j\|OpenFeign\|Micrometer Tracing" "03-Dominios/Tecnologia/Java/Backend/Spring Boot.md"
```
...
grep -rn "Galho 16\|(planejado)" \
  ...
  "03-Dominios/Tecnologia/Java/Mensageria/22 - Saga — transações distribuídas por eventos.md" \
  "03-Dominios/Tecnologia/Java/Persistência de dados/index.md" \
  "03-Dominios/Tecnologia/Java/Testes/20 - Contract testing — Pact.md" \
  "03-Dominios/Tecnologia/Java/Testes/21 - Capstone — a estratégia de testes de uma app Spring production-grade.md"
```
- [ ] **Step 7:** Conferir possíveis verbetes duplicados no Dicionário (linkar, não duplicar): `grep -ni "^### \(retry\|saga\|Spring Cloud\|idempot\|backpressure\|circuit\|bulkhead\|service\)" "03-Dominios/Tecnologia/Java/Dicionário de Java.md"`. Anotar quais já existem (esperado: `retry / retryWhen`, `saga`, `Spring Cloud Stream`).
...
**Files:**
- Create: `03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/01 - O que são microservices e a tese honesta.md`
...
- [ ] **Step 3 (commit):**
```bash
git add "03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/01 - O que são microservices e a tese honesta.md"
...
**Files:**
- Create: `03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/02 - Monorepo vs multi-repo.md`
...
- [ ] **Step 3 (commit):**
```bash
git add "03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/02 - Monorepo vs multi-repo.md"
...
**Files:**
- Create: `03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/03 - Os 12 fatores e o serviço cloud-native.md`
...
- [ ] **Step 3 (commit):**
```bash
git add "03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/03 - Os 12 fatores e o serviço cloud-native.md"
...
**Files:**
- Create: `03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/04 - Panorama do Spring Cloud — e o que morreu.md`
...
- [ ] **Step 3 (commit):**
```bash
git add "03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/04 - Panorama do Spring Cloud — e o que morreu.md"
...
**Files:**
- Create: `03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/05 - Comunicação inter-serviços — síncrono vs assíncrono.md`
...
- [ ] **Step 3 (commit):**
```bash
git add "03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/05 - Comunicação inter-serviços — síncrono vs assíncrono.md"
...
**Files:**
- Create: `03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/06 - Service discovery — o conceito e o Eureka.md`
...
- [ ] **Step 3 (commit):**
```bash
git add "03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/06 - Service discovery — o conceito e o Eureka.md"
...
**Files:**
- Create: `03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/07 - Discovery — Consul e Kubernetes-native.md`
...
- [ ] **Step 3 (commit):**
```bash
git add "03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/07 - Discovery — Consul e Kubernetes-native.md"
...
**Files:**
- Create: `03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/08 - Client-side load balancing — Spring Cloud LoadBalancer.md`
...
- [ ] **Step 3 (commit):**
```bash
git add "03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/08 - Client-side load balancing — Spring Cloud LoadBalancer.md"
...
**Files:**
- Create: `03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/09 - Comunicação síncrona — OpenFeign e HTTP Interface.md`
...
- [ ] **Step 3 (commit):**
```bash
git add "03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/09 - Comunicação síncrona — OpenFeign e HTTP Interface.md"
...
**Files:**
- Create: `03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/10 - API Gateway — papel, roteamento, predicates e filters.md`
...
- [ ] **Step 3 (commit):**
```bash
git add "03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/10 - API Gateway — papel, roteamento, predicates e filters.md"
...
**Files:**
- Create: `03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/11 - Gateway reativo vs MVC — as duas variantes.md`
...
- [ ] **Step 3 (commit):**
```bash
git add "03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/11 - Gateway reativo vs MVC — as duas variantes.md"
...
**Files:**
- Create: `03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/12 - Config centralizado — Spring Cloud Config.md`
...
- [ ] **Step 3 (commit):**
```bash
git add "03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/12 - Config centralizado — Spring Cloud Config.md"
...
**Files:**
- Create: `03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/13 - Resiliência I — a falha distribuída e o Circuit Breaker.md`
...
- [ ] **Step 3 (commit):**
```bash
git add "03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/13 - Resiliência I — a falha distribuída e o Circuit Breaker.md"
...
**Files:**
- Create: `03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/14 - Resiliência II — Retry e Time Limiter.md`
...
- [ ] **Step 3 (commit):**
```bash
git add "03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/14 - Resiliência II — Retry e Time Limiter.md"
...
**Files:**
- Create: `03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/15 - Resiliência III — Bulkhead e Rate Limiter.md`
...
- [ ] **Step 3 (commit):**
```bash
git add "03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/15 - Resiliência III — Bulkhead e Rate Limiter.md"
...
**Files:**
- Create: `03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/16 - Resiliência IV — compondo os padrões.md`
...
- [ ] **Step 3 (commit):**
```bash
git add "03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/16 - Resiliência IV — compondo os padrões.md"
...
**Files:**
- Create: `03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/17 - Segurança entre serviços.md`
...
- [ ] **Step 3 (commit):**
```bash
git add "03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/17 - Segurança entre serviços.md"
...
**Files:**
- Create: `03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/18 - Tracing distribuído I — correlação no código.md`
...
- [ ] **Step 3 (commit):**
```bash
git add "03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/18 - Tracing distribuído I — correlação no código.md"
...
**Files:**
- Create: `03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/19 - Tracing distribuído II — exportando o trace.md`
...
- [ ] **Step 3 (commit):**
```bash
git add "03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/19 - Tracing distribuído II — exportando o trace.md"
...
**Files:**
- Create: `03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/20 - Consistência em sistemas distribuídos.md`
...
- [ ] **Step 3 (commit):**
```bash
git add "03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/20 - Consistência em sistemas distribuídos.md"
...
**Files:**
- Create: `03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/21 - Os padrões de falha distribuída.md`
...
- [ ] **Step 3 (commit):**
```bash
git add "03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/21 - Os padrões de falha distribuída.md"
...
**Files:**
- Create: `03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/22 - Service mesh — quando a resiliência sai do código.md`
...
- [ ] **Step 3 (commit):**
```bash
git add "03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/22 - Service mesh — quando a resiliência sai do código.md"
...
**Files:**
- Create: `03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/23 - Quando NÃO fazer microservices.md`
...
- [ ] **Step 3 (commit):**
```bash
git add "03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/23 - Quando NÃO fazer microservices.md"
...
**Files:**
- Create: `03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/24 - Capstone — uma requisição ponta a ponta na plataforma.md`
...
- [ ] **Step 3 (commit):**
```bash
git add "03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/24 - Capstone — uma requisição ponta a ponta na plataforma.md"
...
**Files:**
- Create: `03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/index.md`
...
- [ ] **Step 2 (commit):**
```bash
git add "03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/index.md"
...
- [ ] **Step 1 (conferir dups):** `grep -ni "^### " "03-Dominios/Tecnologia/Java/Dicionário de Java.md"` filtrando os candidatos a colisão (do Task 0 Step 7): `retry / retryWhen`, `saga`, `Spring Cloud Stream`, `idempotência`, `backpressure`. Onde já existir, **linkar/complementar** (não duplicar) — ex.: `retry` ganha o ângulo Resilience4j; `saga` aponta pra G14.
...
- [ ] **Step 1:** Ler `03-Dominios/Tecnologia/Java/index.md` e localizar a linha do Galho 16 (Task 0 confirmou ~linha 49: `16. Microservices e sistemas distribuídos *(planejado)* — ...`).
...
> O ecossistema Spring Cloud (service discovery, gateway, config centralizado, OpenFeign, resiliência) foi expandido no galho [[03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/index|Microservices e sistemas distribuídos]]. Veja [[03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/04 - Panorama do Spring Cloud — e o que morreu|Panorama do Spring Cloud]], [[03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/06 - Service discovery — o conceito e o Eureka|Service discovery]], [[03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/09 - Comunicação síncrona — OpenFeign e HTTP Interface|OpenFeign e @HttpExchange]] e [[03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/10 - API Gateway — papel, roteamento, predicates e filters|API Gateway]].
```
...
> [!nota] Migrado para galho próprio
> A resiliência com Resilience4j (circuit breaker, retry, time limiter, bulkhead, fallback) foi expandida no galho [[03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/index|Microservices e sistemas distribuídos]]. Veja [[03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/13 - Resiliência I — a falha distribuída e o Circuit Breaker|Circuit Breaker]], [[03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/14 - Resiliência II — Retry e Time Limiter|Retry e Time Limiter]] e [[03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/16 - Resiliência IV — compondo os padrões|compondo os padrões]].
```
...
> [!nota] Migrado para galho próprio
> O tracing distribuído (Micrometer Tracing, OpenTelemetry, propagação de contexto) foi expandido no galho [[03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/index|Microservices e sistemas distribuídos]]. Veja [[03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/18 - Tracing distribuído I — correlação no código|correlação no código]] e [[03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/19 - Tracing distribuído II — exportando o trace|exportando o trace]]. (A operação de coletores/dashboards de produção fica para o Galho 17, planejado.)
```
...
- [ ] **Step 4 (commit):**
```bash
git add "03-Dominios/Tecnologia/Java/Web e APIs REST/15 - Clientes HTTP — RestClient, WebClient, RestTemplate.md" \
        "03-Dominios/Tecnologia/Java/Web e APIs REST/index.md" \
        "03-Dominios/Tecnologia/Java/Programação Reativa/index.md" \
        "03-Dominios/Tecnologia/Java/Build e tooling/12 - Projetos multi-módulo.md" \
        "03-Dominios/Tecnologia/Java/Segurança/12 - OAuth2 e OIDC Client e os grant types.md" \
...
- [ ] **Step 1 (verificar-wikilinks):** rodar a skill `verificar-wikilinks` na pasta `03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/` + nos arquivos tocados (Dicionário, MOC central, Spring Boot.md, e os 10 da Task 32). Corrigir quebrados. Atenção aos **títulos EXATOS** das notas-fronteira (em-dash `—`) e do Dicionário.
- [ ] **Step 2 (grep de sanidade):**
```bash
# zero wikilink pra galho inexistente (17/18) ou conteúdo de produção
grep -rn "\[\[[^]]*\(Galho 1[78]\|container\|Docker\|Kubernetes\|native image\|GraalVM native\|deploy\)" "03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/"
# zero fabricação
grep -rni "MedEspecialista\|josenaldo\|minha experiência\|minha plataforma\|incidente de produção" "03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/"
# zero percentual de adoção inventado
grep -rn "% \(dos\|das\|usa\|adota\|das empresas\)" "03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/"
# Resilience4j 3.x não deve aparecer como versão estável
grep -rni "Resilience4j 3\|resilience4j-spring-boot3.*3\." "03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/"
# 24 notas + index
ls "03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/" | wc -l   # deve ser 25
```
