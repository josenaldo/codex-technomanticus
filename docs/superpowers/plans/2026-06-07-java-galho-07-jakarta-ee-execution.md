...
8. `## Veja também` — wikilinks SEM backticks, SEM âncoras same-file `[[#...]]`. Sempre: notas do galho + `[[03-Dominios/Tecnologia/Java/Jakarta EE/index|Jakarta EE (MOC do galho)]]` + `[[03-Dominios/Tecnologia/Java/index|Trilha Java]]` + (quando conectar) Galhos 1/2/3/4 + verbetes do Dicionário.
...
**Files:**
- Create: `03-Dominios/Tecnologia/Java/Jakarta EE/` (pasta)
...
```bash
mkdir -p "03-Dominios/Tecnologia/Java/Jakarta EE"
```

- [ ] **Step 3: Confirmar que não há conteúdo Jakarta preexistente (galho novo)**

```bash
ls "03-Dominios/Tecnologia/Java/"
grep -rli "jakarta" "03-Dominios/Tecnologia/Java/" --include="*.md" | grep -viE "Backend/|index.md|Annotations|O modelo da linguagem|A evolução do Java|Certificação|Records"
```
...
```bash
ls "03-Dominios/Tecnologia/Java/Linguagem e sintaxe moderna/" | grep -E "^11 "
ls "03-Dominios/Tecnologia/Java/Collections e Streams/" | grep -E "^04 "
ls "03-Dominios/Tecnologia/Java/JVM/" | grep -E "^08 "
ls "03-Dominios/Tecnologia/Java/Concorrência e paralelismo/" | grep -E "^(02|08) "
```
...
```bash
grep -n "planejado" "03-Dominios/Tecnologia/Java/index.md" | grep -i "jakarta"
grep -n "Galhos 7 e 8" "03-Dominios/Tecnologia/Java/Linguagem e sintaxe moderna/11 - Annotations.md"
grep -n "Galho 8" "03-Dominios/Tecnologia/Java/JavaFX/11 - Arquitetura — MVC, MVVM e injeção de dependência.md"
```
...
**Files:**
- Create: `03-Dominios/Tecnologia/Java/Jakarta EE/01 - O modelo Jakarta EE — especificações e implementações.md`
...
- `## Em entrevista` + `## Veja também` ([[02 - De Java EE a Jakarta EE]], [[04 - CDI — beans e injeção]], [[14 - Jakarta EE hoje — a plataforma sob o Spring]], MOC galho, MOC central, [[03-Dominios/Tecnologia/Java/Dicionário de Java#Jakarta EE|Jakarta EE (Dicionário)]], [[03-Dominios/Tecnologia/Java/Dicionário de Java#Web Profile|Web Profile (Dicionário)]], [[03-Dominios/Tecnologia/Java/Dicionário de Java#Core Profile|Core Profile (Dicionário)]]) + `## Referências`.
...
```bash
grep -cE "^## (O que é|Por que importa|Como funciona|Na prática|Armadilhas|Em entrevista|Veja também|Referências)" "03-Dominios/Tecnologia/Java/Jakarta EE/01 - O modelo Jakarta EE — especificações e implementações.md"
grep -E "TCK|Web Profile|Core Profile|implementação|WildFly|Open Liberty" "03-Dominios/Tecnologia/Java/Jakarta EE/01 - O modelo Jakarta EE — especificações e implementações.md" | head
grep -E "\[\[[^]]*Spring" "03-Dominios/Tecnologia/Java/Jakarta EE/01 - O modelo Jakarta EE — especificações e implementações.md"
```
...
```bash
git add "03-Dominios/Tecnologia/Java/Jakarta EE/01 - O modelo Jakarta EE — especificações e implementações.md"
...
**Files:**
- Create: `03-Dominios/Tecnologia/Java/Jakarta EE/02 - De Java EE a Jakarta EE.md`
...
- `## Em entrevista` + `## Veja também` (01, 14, MOC galho, MOC central, [[03-Dominios/Tecnologia/Java/Dicionário de Java#javax → jakarta (rename)|javax → jakarta (Dicionário)]], [[03-Dominios/Tecnologia/Java/Dicionário de Java#Jakarta EE|Jakarta EE (Dicionário)]]) + `## Referências`.
...
```bash
grep -E "2017|2019|2020|2022|2025|trademark|big-bang|Eclipse Foundation" "03-Dominios/Tecnologia/Java/Jakarta EE/02 - De Java EE a Jakarta EE.md" | head
grep -c "javax" "03-Dominios/Tecnologia/Java/Jakarta EE/02 - De Java EE a Jakarta EE.md"
```
...
```bash
git add "03-Dominios/Tecnologia/Java/Jakarta EE/02 - De Java EE a Jakarta EE.md"
...
**Files:**
- Create: `03-Dominios/Tecnologia/Java/Jakarta EE/03 - Servlet API — o alicerce HTTP.md`
...
- `## Em entrevista` + `## Veja também` (01, 07, [[03-Dominios/Tecnologia/Java/Concorrência e paralelismo/index|Concorrência (Galho 4)]], MOC galho, MOC central, [[03-Dominios/Tecnologia/Java/Dicionário de Java#servlet|servlet (Dicionário)]], [[03-Dominios/Tecnologia/Java/Dicionário de Java#servlet container|servlet container (Dicionário)]]) + `## Referências`.
...
```bash
grep -E "HttpServlet|doGet|FilterChain|HttpSession|@WebServlet|init|destroy" "03-Dominios/Tecnologia/Java/Jakarta EE/03 - Servlet API — o alicerce HTTP.md" | head
grep -E "import javax" "03-Dominios/Tecnologia/Java/Jakarta EE/03 - Servlet API — o alicerce HTTP.md"
```
...
```bash
git add "03-Dominios/Tecnologia/Java/Jakarta EE/03 - Servlet API — o alicerce HTTP.md"
...
**Files:**
- Create: `03-Dominios/Tecnologia/Java/Jakarta EE/04 - CDI — beans e injeção.md`
...
- `## Como funciona` — H3s: "O que é um bean (requisitos de managed bean; o que o container instancia)", "`@Inject` (campo vs construtor vs método — construtor preferido: testabilidade e imutabilidade)", "Bean discovery (`annotated` vs `all`; o `beans.xml` no CDI 4)", "Resolução typesafe (por tipo; ambiguidade → teaser qualifiers, nota 06)", "Annotations por baixo (linka [[03-Dominios/Tecnologia/Java/Linguagem e sintaxe moderna/11 - Annotations|Annotations (Galho 1)]] — RUNTIME retention + reflection, sem re-explicar)".
...
- `## Em entrevista` + `## Veja também` (01, 05, 06, 13, [[03-Dominios/Tecnologia/Java/Linguagem e sintaxe moderna/11 - Annotations|Annotations (Galho 1)]], MOC galho, MOC central, [[03-Dominios/Tecnologia/Java/Dicionário de Java#CDI (Contexts and Dependency Injection)|CDI (Dicionário)]], [[03-Dominios/Tecnologia/Java/Dicionário de Java#bean (CDI)|bean (Dicionário)]], [[03-Dominios/Tecnologia/Java/Dicionário de Java#@Inject|@Inject (Dicionário)]], [[03-Dominios/Tecnologia/Java/Dicionário de Java#bean discovery / beans.xml|bean discovery (Dicionário)]]) + `## Referências`.
...
```bash
grep -E "@Inject|bean discovery|beans.xml|managed bean|Weld|typesafe" "03-Dominios/Tecnologia/Java/Jakarta EE/04 - CDI — beans e injeção.md" | head
grep -E "\[\[[^]]*Spring" "03-Dominios/Tecnologia/Java/Jakarta EE/04 - CDI — beans e injeção.md"
```
...
```bash
git add "03-Dominios/Tecnologia/Java/Jakarta EE/04 - CDI — beans e injeção.md"
...
**Files:**
- Create: `03-Dominios/Tecnologia/Java/Jakarta EE/05 - CDI — escopos e contextos.md`
...
- `## Em entrevista` + `## Veja também` (04, 06, 13, [[03-Dominios/Tecnologia/Java/Concorrência e paralelismo/index|Concorrência (Galho 4)]], MOC galho, MOC central, [[03-Dominios/Tecnologia/Java/Dicionário de Java#escopo (CDI)|escopo (Dicionário)]], [[03-Dominios/Tecnologia/Java/Dicionário de Java#client proxy (CDI)|client proxy (Dicionário)]]) + `## Referências`.
...
```bash
grep -E "@ApplicationScoped|@RequestScoped|@Dependent|client proxy|@PostConstruct|ContextNotActive" "03-Dominios/Tecnologia/Java/Jakarta EE/05 - CDI — escopos e contextos.md" | head
```

- [ ] **Step 4: Commit**

```bash
git add "03-Dominios/Tecnologia/Java/Jakarta EE/05 - CDI — escopos e contextos.md"
...
**Files:**
- Create: `03-Dominios/Tecnologia/Java/Jakarta EE/06 - CDI — qualifiers, producers e eventos.md`
...
- `## Em entrevista` + `## Veja também` (04, 05, 07 (o outro `@Produces`), 13, MOC galho, MOC central, [[03-Dominios/Tecnologia/Java/Dicionário de Java#qualifier (CDI)|qualifier (Dicionário)]], [[03-Dominios/Tecnologia/Java/Dicionário de Java#@Produces (producer CDI)|@Produces (Dicionário)]], [[03-Dominios/Tecnologia/Java/Dicionário de Java#@Observes / eventos CDI|@Observes (Dicionário)]]) + `## Referências`.
...
```bash
grep -E "@Qualifier|@Produces|@Disposes|@Observes|fireAsync|@Alternative|Instance<" "03-Dominios/Tecnologia/Java/Jakarta EE/06 - CDI — qualifiers, producers e eventos.md" | head
grep -c "JAX-RS" "03-Dominios/Tecnologia/Java/Jakarta EE/06 - CDI — qualifiers, producers e eventos.md"
```
...
```bash
git add "03-Dominios/Tecnologia/Java/Jakarta EE/06 - CDI — qualifiers, producers e eventos.md"
...
**Files:**
- Create: `03-Dominios/Tecnologia/Java/Jakarta EE/07 - JAX-RS — REST declarativo.md`
...
- `## Em entrevista` + `## Veja também` (03, 06, 08, 09, MOC galho, MOC central, [[03-Dominios/Tecnologia/Java/Dicionário de Java#JAX-RS (Jakarta RESTful Web Services)|JAX-RS (Dicionário)]], [[03-Dominios/Tecnologia/Java/Dicionário de Java#ExceptionMapper|ExceptionMapper (Dicionário)]]) + `## Referências`.
...
```bash
grep -E "@Path|@GET|@PathParam|@QueryParam|MessageBodyReader|ExceptionMapper|ClientBuilder|@ApplicationPath" "03-Dominios/Tecnologia/Java/Jakarta EE/07 - JAX-RS — REST declarativo.md" | head
grep -E "jakarta.ws.rs|jakarta.enterprise.inject" "03-Dominios/Tecnologia/Java/Jakarta EE/07 - JAX-RS — REST declarativo.md" | head -5
```
...
```bash
git add "03-Dominios/Tecnologia/Java/Jakarta EE/07 - JAX-RS — REST declarativo.md"
...
**Files:**
- Create: `03-Dominios/Tecnologia/Java/Jakarta EE/08 - Bean Validation.md`
...
- `## Em entrevista` + `## Veja também` (04, 07, 09, [[03-Dominios/Tecnologia/Java/Linguagem e sintaxe moderna/11 - Annotations|Annotations (Galho 1)]], MOC galho, MOC central, [[03-Dominios/Tecnologia/Java/Dicionário de Java#Bean Validation (Jakarta Validation)|Bean Validation (Dicionário)]]) + `## Referências`.
...
```bash
grep -E "@NotNull|@NotBlank|@Valid|ConstraintValidator|ConstraintViolation|groups" "03-Dominios/Tecnologia/Java/Jakarta EE/08 - Bean Validation.md" | head
```

- [ ] **Step 4: Commit**

```bash
git add "03-Dominios/Tecnologia/Java/Jakarta EE/08 - Bean Validation.md"
...
**Files:**
- Create: `03-Dominios/Tecnologia/Java/Jakarta EE/09 - JPA — a especificação de persistência.md`
...
- `## Em entrevista` + `## Veja também` (01, 10, 11, [[03-Dominios/Tecnologia/Java/Linguagem e sintaxe moderna/11 - Annotations|Annotations (Galho 1)]], MOC galho, MOC central, [[03-Dominios/Tecnologia/Java/Dicionário de Java#JPA (Jakarta Persistence)|JPA (Dicionário)]], [[03-Dominios/Tecnologia/Java/Dicionário de Java#entity (JPA)|entity (Dicionário)]], [[03-Dominios/Tecnologia/Java/Dicionário de Java#persistence unit / persistence.xml|persistence unit (Dicionário)]]) + `## Referências`.
...
```bash
grep -E "@Entity|@GeneratedValue|mappedBy|owning side|persistence.xml|provider|EclipseLink" "03-Dominios/Tecnologia/Java/Jakarta EE/09 - JPA — a especificação de persistência.md" | head
grep -iE "N\+1|fetch join|cache de segundo nível|Spring Data" "03-Dominios/Tecnologia/Java/Jakarta EE/09 - JPA — a especificação de persistência.md"
```
...
```bash
git add "03-Dominios/Tecnologia/Java/Jakarta EE/09 - JPA — a especificação de persistência.md"
...
**Files:**
- Create: `03-Dominios/Tecnologia/Java/Jakarta EE/10 - EntityManager e o ciclo de vida da entidade.md`
...
- `## Em entrevista` + `## Veja também` (09, 11, MOC galho, MOC central, [[03-Dominios/Tecnologia/Java/Dicionário de Java#EntityManager|EntityManager (Dicionário)]], [[03-Dominios/Tecnologia/Java/Dicionário de Java#persistence context|persistence context (Dicionário)]], [[03-Dominios/Tecnologia/Java/Dicionário de Java#dirty checking|dirty checking (Dicionário)]], [[03-Dominios/Tecnologia/Java/Dicionário de Java#JPQL|JPQL (Dicionário)]]) + `## Referências`.
...
```bash
grep -E "persistence context|managed|detached|merge|flush|dirty checking|TypedQuery" "03-Dominios/Tecnologia/Java/Jakarta EE/10 - EntityManager e o ciclo de vida da entidade.md" | head
grep -iE "fetch join|N\+1|Spring Data|Hibernate Session" "03-Dominios/Tecnologia/Java/Jakarta EE/10 - EntityManager e o ciclo de vida da entidade.md"
```
...
```bash
git add "03-Dominios/Tecnologia/Java/Jakarta EE/10 - EntityManager e o ciclo de vida da entidade.md"
...
**Files:**
- Create: `03-Dominios/Tecnologia/Java/Jakarta EE/11 - JTA — transações na plataforma.md`
...
- `## Em entrevista` + `## Veja também` (05, 10, 13, [[03-Dominios/Tecnologia/Java/Concorrência e paralelismo/index|Concorrência (Galho 4)]], MOC galho, MOC central, [[03-Dominios/Tecnologia/Java/Dicionário de Java#JTA (Jakarta Transactions)|JTA (Dicionário)]], [[03-Dominios/Tecnologia/Java/Dicionário de Java#@Transactional (Jakarta)|@Transactional (Dicionário)]], [[03-Dominios/Tecnologia/Java/Dicionário de Java#CMT / BMT|CMT / BMT (Dicionário)]], [[03-Dominios/Tecnologia/Java/Dicionário de Java#two-phase commit (2PC / XA)|two-phase commit (Dicionário)]]) + `## Referências`.
...
```bash
grep -E "UserTransaction|@Transactional|REQUIRES_NEW|rollback|two-phase|XA|TransactionScoped" "03-Dominios/Tecnologia/Java/Jakarta EE/11 - JTA — transações na plataforma.md" | head
grep -E "\[\[[^]]*Spring" "03-Dominios/Tecnologia/Java/Jakarta EE/11 - JTA — transações na plataforma.md"
```
...
```bash
git add "03-Dominios/Tecnologia/Java/Jakarta EE/11 - JTA — transações na plataforma.md"
...
**Files:**
- Create: `03-Dominios/Tecnologia/Java/Jakarta EE/12 - EJB — o legado que moldou a plataforma.md`
...
- `## Em entrevista` + `## Veja também` (04, 11, 13, 14, MOC galho, MOC central, [[03-Dominios/Tecnologia/Java/Dicionário de Java#EJB (Enterprise JavaBeans)|EJB (Dicionário)]], [[03-Dominios/Tecnologia/Java/Dicionário de Java#session bean|session bean (Dicionário)]], [[03-Dominios/Tecnologia/Java/Dicionário de Java#MDB (message-driven bean)|MDB (Dicionário)]]) + `## Referências`.
...
```bash
grep -E "stateless|stateful|singleton|MDB|timer|home interface|entity bean" "03-Dominios/Tecnologia/Java/Jakarta EE/12 - EJB — o legado que moldou a plataforma.md" | head
grep -riE "% d[ao]s|market share|maioria das empresas" "03-Dominios/Tecnologia/Java/Jakarta EE/12 - EJB — o legado que moldou a plataforma.md"
```
...
```bash
git add "03-Dominios/Tecnologia/Java/Jakarta EE/12 - EJB — o legado que moldou a plataforma.md"
...
**Files:**
- Create: `03-Dominios/Tecnologia/Java/Jakarta EE/13 - CDI avançado — interceptors, decorators e extensões.md`
...
- `## Em entrevista` + `## Veja também` (04, 05, 06, 11, 14, MOC galho, MOC central, [[03-Dominios/Tecnologia/Java/Dicionário de Java#interceptor (CDI)|interceptor (Dicionário)]], [[03-Dominios/Tecnologia/Java/Dicionário de Java#decorator (CDI)|decorator (Dicionário)]], [[03-Dominios/Tecnologia/Java/Dicionário de Java#portable extension (CDI)|portable extension (Dicionário)]]) + `## Referências`.
...
```bash
grep -E "@InterceptorBinding|@AroundInvoke|InvocationContext|@Priority|@Decorator|@Delegate|Lite" "03-Dominios/Tecnologia/Java/Jakarta EE/13 - CDI avançado — interceptors, decorators e extensões.md" | head
```

- [ ] **Step 4: Commit**

```bash
git add "03-Dominios/Tecnologia/Java/Jakarta EE/13 - CDI avançado — interceptors, decorators e extensões.md"
...
**Files:**
- Create: `03-Dominios/Tecnologia/Java/Jakarta EE/14 - Jakarta EE hoje — a plataforma sob o Spring.md`
...
- `## Veja também` — (01, 02, 04, 13, [[03-Dominios/Tecnologia/Java/index|Trilha Java]], MOC galho, [[03-Dominios/Tecnologia/Java/Dicionário de Java#Jakarta EE|Jakarta EE (Dicionário)]], [[03-Dominios/Tecnologia/Java/Dicionário de Java#Core Profile|Core Profile (Dicionário)]]) + `## Referências`.
...
```bash
grep -iE "EE 11|EE 12|Core Profile|MicroProfile|cheatsheet|TCK" "03-Dominios/Tecnologia/Java/Jakarta EE/14 - Jakarta EE hoje — a plataforma sob o Spring.md" | head
grep -riE "minha experiência|no meu projeto|josenaldo|Patient|% d[ao]s|market share" "03-Dominios/Tecnologia/Java/Jakarta EE/14 - Jakarta EE hoje — a plataforma sob o Spring.md"
grep -E "\[\[[^]]*(Spring|Quarkus|Hibernate)" "03-Dominios/Tecnologia/Java/Jakarta EE/14 - Jakarta EE hoje — a plataforma sob o Spring.md"
```
...
```bash
git add "03-Dominios/Tecnologia/Java/Jakarta EE/14 - Jakarta EE hoje — a plataforma sob o Spring.md"
...
**Files:**
- Create: `03-Dominios/Tecnologia/Java/Jakarta EE/index.md`
...
Conteúdo (modelar pelo `03-Dominios/Tecnologia/Java/JavaFX/index.md`):
...
- `## Todas as notas` — Dataview (`FROM "03-Dominios/Tecnologia/Java/Jakarta EE"`, `WHERE type = "concept"`).
- `## Veja também` — MOC central, Galhos 1/2/3/4 (index), Dicionário; Galhos 8/9/10 como texto "(planejado)" SEM wikilink.

- [ ] **Step 2: Verificar**

```bash
grep -cE "^## (Iniciado|Adepto|Magus|Rotas alternativas)" "03-Dominios/Tecnologia/Java/Jakarta EE/index.md"
grep -c "\[\[" "03-Dominios/Tecnologia/Java/Jakarta EE/index.md"
grep -E "\[\[[^]]*Spring" "03-Dominios/Tecnologia/Java/Jakarta EE/index.md"
```
...
```bash
git add "03-Dominios/Tecnologia/Java/Jakarta EE/index.md"
...
```bash
grep -rhoE "Dicionário de Java#[^]|]+" "03-Dominios/Tecnologia/Java/Jakarta EE/" | sort -u
```
...
```bash
grep -E "^### (Jakarta EE|CDI \(Contexts and Dependency Injection\)|EntityManager|JPQL|servlet|Web Profile)" "03-Dominios/Tecnologia/Java/Dicionário de Java.md"
grep -cE "^### " "03-Dominios/Tecnologia/Java/Dicionário de Java.md"
```
...
```bash
grep -E "Jakarta EE/index" "03-Dominios/Tecnologia/Java/index.md"
...
**Files:**
- Modify: `03-Dominios/Tecnologia/Java/Linguagem e sintaxe moderna/11 - Annotations.md`
- Modify: `03-Dominios/Tecnologia/Java/JavaFX/11 - Arquitetura — MVC, MVVM e injeção de dependência.md`
...
grep -n "Galhos 7 e 8" "03-Dominios/Tecnologia/Java/Linguagem e sintaxe moderna/11 - Annotations.md"
grep -n "Galho 8" "03-Dominios/Tecnologia/Java/JavaFX/11 - Arquitetura — MVC, MVVM e injeção de dependência.md"
grep -n "Bean Validation" "03-Dominios/Tecnologia/Java/Linguagem e sintaxe moderna/11 - Annotations.md"
```

- [ ] **Step 2: Annotations.md (~linha 309)** — trocar o trecho `Este é o ponto de conexão com os **Galhos 7 e 8** (Spring e Jakarta EE).` por:

```markdown
Este é o ponto de conexão com o galho [[03-Dominios/Tecnologia/Java/Jakarta EE/index|Jakarta EE]] (CDI, JPA, Bean Validation — specs construídas sobre annotations RUNTIME) e com o Galho 8 (Spring, planejado).
```

Opcional, se natural: na linha ~383 (menção a Bean Validation), linkar `[[03-Dominios/Tecnologia/Java/Jakarta EE/08 - Bean Validation|Bean Validation]]`. Atualizar `updated: 2026-06-07` no frontmatter.

- [ ] **Step 3: JavaFX/11 (~linhas 35 e 110)** — **corrigir a atribuição** (CDI é do Galho 7, não do 8):
- Linha ~35: trocar `(Guice, Weld, ou frameworks de terceiros como mvvmFX; Spring/CDI ficam para o Galho 8, planejado)` por `(Guice, Weld, ou frameworks de terceiros como mvvmFX; [[03-Dominios/Tecnologia/Java/Jakarta EE/04 - CDI — beans e injeção|CDI]] tem galho próprio; Spring fica para o Galho 8, planejado)`.
- Linha ~110: trocar `Weld/CDI e outros containers ficam para o Galho 8 (planejado)` por `Weld/[[03-Dominios/Tecnologia/Java/Jakarta EE/04 - CDI — beans e injeção|CDI]] têm galho próprio; Spring fica para o Galho 8 (planejado)`.
...
```bash
grep -n "Galhos 7 e 8" "03-Dominios/Tecnologia/Java/Linguagem e sintaxe moderna/11 - Annotations.md"
grep -n "CDI ficam para o Galho 8\|CDI e outros containers ficam" "03-Dominios/Tecnologia/Java/JavaFX/11 - Arquitetura — MVC, MVVM e injeção de dependência.md"
grep -c "Jakarta EE" "03-Dominios/Tecnologia/Java/JavaFX/11 - Arquitetura — MVC, MVVM e injeção de dependência.md"
```
...
```bash
git add "03-Dominios/Tecnologia/Java/Linguagem e sintaxe moderna/11 - Annotations.md" "03-Dominios/Tecnologia/Java/JavaFX/11 - Arquitetura — MVC, MVVM e injeção de dependência.md"
...
```bash
ls "03-Dominios/Tecnologia/Java/Jakarta EE/" | sort
```
...
```bash
for f in "03-Dominios/Tecnologia/Java/Jakarta EE/"[0-9]*.md; do grep -H "^fase:" "$f"; done
```
...
```bash
for f in "03-Dominios/Tecnologia/Java/Jakarta EE/"[0-9]*.md; do echo "$f: $(grep -cE '^## (Em entrevista|Armadilhas|Veja também)' "$f")"; done
```
Expected: 3 em todas.
...
```bash
grep -riE "minha experiência|no meu projeto|josenaldo|Patient|getSpecialty|market share|% d[ao]s" "03-Dominios/Tecnologia/Java/Jakarta EE/"
grep -rE "\[\[[^]]*(Spring|Hibernate|Quarkus|EclipseLink|Kafka|Galho (8|9|10|14))" "03-Dominios/Tecnologia/Java/Jakarta EE/"
grep -rn '\[\[#' "03-Dominios/Tecnologia/Java/Jakarta EE/"
grep -rn "import javax" "03-Dominios/Tecnologia/Java/Jakarta EE/" | grep -v "02 - De Java EE a Jakarta EE"
```
...
```bash
for f in "03-Dominios/Tecnologia/Java/Jakarta EE/"[0-9]*.md; do echo "$f: $(grep -c '### Frase pronta (inglês)' "$f")"; done
```

- [ ] **Step 6: Troncos intocados**

```bash
git log --oneline -5 -- "03-Dominios/Tecnologia/Java/Backend/"
git status --short "03-Dominios/Tecnologia/Java/Backend/"
```
Expected: nenhum commit novo deste galho em `Backend/`; working tree limpa ali.

- [ ] **Step 7: Skill `verificar-wikilinks`**

Rodar na pasta `03-Dominios/Tecnologia/Java/Jakarta EE/` + conferir os arquivos tocados fora (MOC central, Dicionário, Annotations.md, JavaFX/11). Âncoras `Dicionário de Java#...` resolvem 1:1 (cross-check com o grep da Task 16 Step 1). As ~204 quebras legadas da árvore Java NÃO são deste galho — só corrigir o que este galho introduziu. Corrigir e commitar à parte se houver.
