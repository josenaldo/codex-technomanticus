...
| Trilha                                                                                  | Estado | Nota                                                                                                                           |
| --------------------------------------------------------------------------------------- | ------ | ------------------------------------------------------------------------------------------------------------------------------ |
| [[03-Dominios/Engenharia/Design de Software/index\|Design de Software]]                 | 🟡     | OO ✅ (13) + SOLID ✅ (8). **Design Patterns escalou de "1 galho" para galho-pai [[03-Dominios/Engenharia/Design de Software/Padrões de Projeto/roadmap\|Padrões de Projeto]]** (catálogo de consulta p/ sênior/legado, lente cross-linguagem Java/TS/Python/Go, peso no "quando NÃO usar"): 6 famílias, ~90-100 notas, construção sequencial. **Família 1 (Clássicos/GoF) COMPLETA 23/23 + Família 2 (Acesso a Dados) COMPLETA 15/15** (2026-07-28). Monólito `Design Patterns.md` podado. Próxima: família 3 (Integração Empresarial/EIP). |
...
| [[03-Dominios/Engenharia/UX/index\|UX]] | 🔶 | **Scaffold criado (2026-07-28).** 8 sub-galhos, alvo 48 notas + capstone; galho-irmão [[03-Dominios/Tecnologia/Ferramentas de Design/index\|Tecnologia/Ferramentas de Design]] (9 notas). 0/48+1 escritas. Ver [[03-Dominios/Engenharia/UX/roadmap\|roadmap]]. |
...
- 🔶 **UX** — sem domínio, sem senda, sem tag sistemática antes de 2026-07-28. **Scaffold criado (2026-07-28)**: [[03-Dominios/Engenharia/UX/index|Engenharia/UX]] (8 sub-galhos, alvo **48 notas + capstone**) + [[03-Dominios/Tecnologia/Ferramentas de Design/index|Tecnologia/Ferramentas de Design]] (galho-irmão volátil, alvo **9 notas**). Público-alvo: o fractional engineer full-cycle (cliente ≠ usuário; escala de um). Ordem de execução: SG1 → SG2 → SG4 → SG6 → SG5 → SG3 → SG7 → SG8 → Ferramentas de Design → capstone. Ver [[00-Meta/specs/2026-07-28-dominio-ux-design|design do domínio]] e o [[03-Dominios/Engenharia/UX/roadmap|roadmap]].
...
- **Design de Software** — OO ✅ + SOLID ✅. **EM CURSO (2026-07-28):** o antigo "galho de Design Patterns" foi promovido a galho-pai **[[03-Dominios/Engenharia/Design de Software/Padrões de Projeto/roadmap|Padrões de Projeto]]** — um **catálogo de consulta** para o sênior (inclusive legado), com lente cross-linguagem (Java/TS/Python/Go) e peso no "quando NÃO usar". **6 famílias** (Clássicos/GoF · Acesso a Dados · Integração Empresarial/EIP · Aplicação Corporativa/PoEAA · Arquitetura de Eventos · Nuvem e Resiliência), ~90-100 notas, construção **sequencial**. Roadmaps montados; **família 1 Clássicos (GoF) COMPLETA 23/23** + **família 2 Acesso a Dados COMPLETA 15/15 (2026-07-28)** — GoF em 3 fases (lente cross-linguagem); Acesso a Dados em lente cross-ORM, eixo dorsal Active Record × Data Mapper (Iniciado 01-06 lógica+entrada · Adepto 07-13 mapper/repository/maquinaria ORM · Magus 14-15 NoSQL/poliglota). Monólito `Design Patterns.md` **podado** (virou o index do galho-pai, alias `Design Patterns`). Próxima: **família 3 (Integração Empresarial/EIP)**. Rosters das 6 famílias no roadmap-pai (anti-drift).
