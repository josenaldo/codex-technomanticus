...
| Trilha                                                                                  | Estado | Nota                                                                                                                           |
| --------------------------------------------------------------------------------------- | ------ | ------------------------------------------------------------------------------------------------------------------------------ |
| [[03-Dominios/Engenharia/Design de Software/index\|Design de Software]]                 | 🟡     | OO ✅ (13) + SOLID ✅ (8). **Design Patterns escalou de "1 galho" para galho-pai [[03-Dominios/Engenharia/Design de Software/Padrões de Projeto/roadmap\|Padrões de Projeto]]** (catálogo de consulta p/ sênior/legado, lente cross-linguagem Java/TS/Python/Go, peso no "quando NÃO usar"): 6 famílias, ~90-100 notas, construção sequencial. **Família 1 (Clássicos/GoF) 23/23 + Família 2 (Acesso a Dados) 15/15 + Família 3 (Integração Empresarial/EIP) 14/14 COMPLETAS** (2026-07-28/29). Monólito `Design Patterns.md` podado. Próxima: família 4 (Aplicação Corporativa/PoEAA). |
