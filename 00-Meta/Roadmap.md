...
| Trilha                                                                                  | Estado | Nota                                                                                                                           |
| --------------------------------------------------------------------------------------- | ------ | ------------------------------------------------------------------------------------------------------------------------------ |
| [[03-Dominios/Engenharia/Design de Software/index\|Design de Software]]                 | 🟡     | OO ✅ (13) + SOLID ✅ (8). **Design Patterns escalou de "1 galho" para galho-pai [[03-Dominios/Engenharia/Design de Software/Padrões de Projeto/roadmap\|Padrões de Projeto]]** (catálogo de consulta p/ sênior/legado, lente cross-linguagem Java/TS/Python/Go, peso no "quando NÃO usar"): 6 famílias, ~90-100 notas, construção sequencial. **5 de 6 famílias COMPLETAS — 76 notas** (2026-07-28 a 31): GoF 23/23 · Acesso a Dados 15/15 · EIP 14/14 · Aplicação Corporativa 14/14 · Arquitetura de Eventos 10/10. Cada família com lente própria: cross-linguagem · cross-ORM · cross-ferramenta · **arqueológica** (era × hoje, seção "A ressurreição") · **acoplamento** (o que o evento carrega e a quem amarra). Monólito `Design Patterns.md` podado. Falta só a família 6 (Nuvem e Resiliência). |
