...
- **A âncora** — uma frase que define o diferencial, obtida por drill-down de quatro camadas (ferramentas → tipo de sistema → o movimento que se repete → o diferencial). Currículo, pitch, resposta comportamental e negociação salarial são quatro saídas da mesma âncora; sem ela, cada saída improvisa uma versão diferente e o leitor sente a inconsistência.
    - **Material real verificado em 2026-08-20 para a nota 20.** O autor tem a mesma âncora publicada em duas renderizações, e o contraste é o exemplo trabalhado que a nota precisa. No currículo-base ela é declaração sobre si — *"I build delivery machines"*. Na home de `josenaldo.com.br` ela é promessa ao leitor, em segunda pessoa — *"I build the machine that ships your software"*, sob o cargo *"Fractional Software Engineer & Architect. 20+ years."* Mesma âncora, dois públicos, duas formas. Isso demonstra que a âncora não é um slogan fixo a repetir literalmente, e sim uma posição que se reescreve conforme quem lê — sem nunca virar outra posição.
