...
- **Profundidade — medida em PALAVRAS, não em linhas.** Faixa alvo **~4.500-6.500 palavras** (`wc -w`), que é a banda demonstrada pelas notas mais densas do vault. Contagem de linhas NÃO serve de régua aqui: com a regra de um parágrafo por linha, ela mede quantos parágrafos a nota tem, não quanto conteúdo. Medido em 2026-08-20: as notas de referência do vault ficam em 4.400-6.300 palavras com 11-13 palavras por linha, enquanto as duas primeiras notas deste galho ficaram em ~9.400 palavras com 28-31 palavras por linha — densas demais, não rasas. Mire o topo da banda, não o dobro dela. Diagrama Mermaid onde ele mostra mecanismo, não como enfeite. Nota curta é sinal de pesquisa preguiçosa; nota muito acima da banda cansa o leitor e provavelmente cobre dois assuntos, e aí a convenção do vault manda dividir. Capstone e brotos são exceção.
...
- [ ] **Lado do recrutador.** O achado mais sólido do levantamento: Wilson & Caliskan (AAAI/ACM AIES 2024) — **números conferidos no abstract da fonte primária em 2026-08-20**: mais de 500 currículos públicos cruzados com mais de 500 descrições de vaga; nomes associados a brancos favorecidos em **85,1%** dos casos; nomes associados a **mulheres** favorecidos em apenas **11,1%** dos casos (o eixo de gênero pesa contra as mulheres, não a favor dos homens); **homens negros desfavorecidos em até 100% dos casos** — não amaciar este dado. E o follow-up da UW de nov/2025, sugerindo que humanos expostos a ranking enviesado de IA absorvem o viés. Tratar com a gravidade que o dado tem, sem transformar a nota em panfleto.
