...
> [!info] Pré-requisitos
> Esta nota aprofunda a distinção de [[03-Dominios/Tecnologia/React/Ecossistema/02 - Server state vs client state|Nota 02 — Server vs client state]].
> Se você ainda não viu por que `useState` e `useContext` não foram feitos para dados remotos,
> leia a nota 02 primeiro. Para integração com Suspense, veja
> [[03-Dominios/Tecnologia/React/React core/19 - Suspense e data fetching no cliente|React core 19 — Suspense e data fetching]].
> Contexto geral do ecossistema em [[03-Dominios/Tecnologia/React/Ecossistema/01 - O ecossistema React - o mapa|Nota 01 — O mapa]].
