...
Veja também: [[03-Dominios/Tecnologia/Java/Testes/02 - JUnit 5 — anatomia, lifecycle e o padrão AAA|JUnit 5]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Segurança/14 - Autorização avançada — AuthorizationManager, RBAC vs ABAC|Autorização avançada]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Mensageria/10 Ack modes e commit de offset|Ack modes e commit de offset]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Swing/11 - Action API, key bindings e performance|Action API]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Swing/04 - O modelo de eventos|Modelo de eventos]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Spring Core e Boot/09 - AOP e proxies no Spring|AOP e proxies no Spring]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Segurança/08 - JWT — estrutura, assinatura e validação|JWT]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/22 - Service mesh — quando a resiliência sai do código|Service mesh]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Mensageria/15 Spring AMQP e RabbitMQ|Spring AMQP e RabbitMQ]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/10 - API Gateway — papel, roteamento, predicates e filters|API Gateway]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Web e APIs REST/13 - Versionamento de API|Versionamento de API]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Spring Core e Boot/06 - ApplicationContext — o container e seu ciclo|ApplicationContext — o container e seu ciclo]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Testes/19 - Fitness functions — ArchUnit (testes de arquitetura)|Fitness functions — ArchUnit]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Testes/07 - Mockito — verify, ArgumentCaptor e quando NÃO mockar|Mockito: verify e ArgumentCaptor]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Build e tooling/02 - Maven — POM, coordenadas e lifecycle|Maven — coordenadas]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Programação Reativa/04 - Nada acontece até o subscribe — lazy, assembly vs subscription, cold vs hot|Nada acontece até o subscribe]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Testes/03 - AssertJ — fluent assertions|AssertJ]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Cloud-native e produção/19 - Continuous profiling no cluster — Pyroscope e async-profiler|Continuous profiling no cluster]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Mensageria/03 Garantias de entrega — e a falácia do exactly-once|Garantias de entrega]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Segurança/03 - Autenticação — UserDetailsService, AuthenticationManager, Form e Basic|Autenticação]].

### @AuthenticationPrincipal
Anotação que injeta o principal autenticado (`UserDetails`, `Jwt` ou `OidcUser`) direto num parâmetro do controller.

Veja também: [[03-Dominios/Tecnologia/Java/Segurança/02 - SecurityContext, Authentication e Principal — o usuário atual|SecurityContext, Authentication e Principal]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Segurança/05 - Autorização baseada em URL — authorizeHttpRequests, roles vs authorities|Autorização baseada em URL]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Spring Core e Boot/15 - Auto-configuration e starters|Auto-configuration e starters]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Spring Core e Boot/02 - IoC e injeção de dependência no Spring|IoC e injeção de dependência no Spring]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Testes/14 - Testando código assíncrono — Awaitility|Testando código assíncrono]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Swing/01 - O modelo do Swing|Modelo do Swing]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Mensageria/14 Schema e contratos — Avro e Schema Registry|Schema e contratos — Avro e Schema Registry]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Programação Reativa/09 - Backpressure — request(n) e as estratégias BUFFER, DROP, LATEST|Backpressure]]. Para o controle de fluxo entre serviços, veja [[#backpressure distribuído|backpressure distribuído]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/21 - Os padrões de falha distribuída|Os padrões de falha distribuída]], [[#backpressure|backpressure (Reactive Streams)]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Segurança/04 - Password encoding — BCrypt, Argon2 e o DelegatingPasswordEncoder|Password encoding]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Spring Core e Boot/05 - @Configuration e @Bean — definição explícita de beans|@Configuration e @Bean]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Jakarta EE/04 - CDI — beans e injeção|CDI — beans e injeção]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Spring Core e Boot/07 - Ciclo de vida e escopos de beans|Ciclo de vida e escopos de beans]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Jakarta EE/08 - Bean Validation|Bean Validation]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Spring Core e Boot/13 - BeanPostProcessor e BeanFactoryPostProcessor|BeanPostProcessor e BeanFactoryPostProcessor]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Segurança/09 - OAuth2 Resource Server — validando JWT na API|OAuth2 Resource Server]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Build e tooling/11 - BOM e dependency management|BOM e dependency management]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/01 - O que são microservices e a tese honesta|O que são microservices]], [[03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/23 - Quando NÃO fazer microservices|Quando NÃO fazer microservices]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Programação Reativa/08 - Schedulers — subscribeOn, publishOn e em qual thread o código roda|Schedulers]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/19 - Tracing distribuído II — exportando o trace|Tracing distribuído II — exportando o trace]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Mensageria/04 O ecossistema de brokers na JVM|O ecossistema de brokers na JVM]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Collections e Streams/09 - Streams primitivos|Streams primitivos]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Build e tooling/07 - Gradle — performance, build cache e daemon|Gradle — performance e build cache]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Cloud-native e produção/06 - Buildpacks — imagem sem Dockerfile|Buildpacks — imagem sem Dockerfile]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/15 - Resiliência III — Bulkhead e Rate Limiter|Resiliência III — Bulkhead e Rate Limiter]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/20 - Consistência em sistemas distribuídos|Consistência em sistemas distribuídos]].
...
`cascade` propaga operações (PERSIST, MERGE, REMOVE, ALL) do lado pai para o filho de uma associação. `orphanRemoval = true` apaga o filho quando ele é removido da coleção do pai — vai além do `cascade = REMOVE`. Veja também: [[03-Dominios/Tecnologia/Java/Persistência de dados/06 - @ManyToMany, @OneToOne, cascade e orphanRemoval|@ManyToMany, @OneToOne, cascade e orphanRemoval]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/21 - Os padrões de falha distribuída|Os padrões de falha distribuída]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Mensageria/21 O padrão Outbox|O padrão Outbox]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Swing/08 - Renderers e editors|Renderers e editors]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Build e tooling/19 - Publicação de artefatos|Publicação de artefatos]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Certificação OCP/17 - O dia da prova e depois|O dia da prova e depois]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Cloud-native e produção/02 - A JVM dentro de um container|A JVM dentro de um container]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Build e tooling/16 - Quality gates no build|Quality gates no build]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Cloud-native e produção/20 - CI-CD e o caminho até produção|CI-CD e o caminho até produção]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/13 - Resiliência I — a falha distribuída e o Circuit Breaker|Resiliência I — Circuit Breaker]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Segurança/12 - OAuth2 e OIDC Client e os grant types|OAuth2 e OIDC Client]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Jakarta EE/05 - CDI — escopos e contextos|CDI — escopos e contextos]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/06 - Service discovery — o conceito e o Eureka|Service discovery — o conceito e o Eureka]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/08 - Client-side load balancing — Spring Cloud LoadBalancer|Client-side load balancing]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Cloud-native e produção/08 - GraalVM Native Image — conceito e trade-offs|GraalVM Native Image — conceito e trade-offs]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Jakarta EE/11 - JTA — transações na plataforma|JTA — transações na plataforma]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Mensageria/01 O que é mensageria e arquitetura orientada a eventos|O que é mensageria e arquitetura orientada a eventos]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Collections e Streams/08 - Collectors e agrupamento|Collectors]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Collections e Streams/01 - O Collections Framework|Collections Framework]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Collections e Streams/06 - Comparable e Comparator|Comparable e Comparator]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Spring Core e Boot/03 - Beans e estereótipos — @Component, @Service, @Repository, @Controller|Beans e estereótipos]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Programação Reativa/05 - map e flatMap — transformando o fluxo|map e flatMap]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Spring Core e Boot/14 - Conditional beans — @Conditional e os @ConditionalOn|Conditional beans]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Build e tooling/05 - Gradle — build script, tasks e configurations|Gradle — build script e configurations]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Spring Core e Boot/12 - Configuração e profiles|Configuração e profiles]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Spring Core e Boot/04 - Tipos de injeção — constructor, setter, field|Tipos de injeção]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/07 - Discovery — Consul e Kubernetes-native|Discovery — Consul e Kubernetes-native]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Web e APIs REST/07 - Content negotiation|Content negotiation]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Mensageria/26 Observabilidade em mensageria|Observabilidade em mensageria]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Testes/20 - Contract testing — Pact|Contract testing — Pact]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Web e APIs REST/09 - Tratamento de exceções com @ControllerAdvice|Tratamento de exceções com @ControllerAdvice]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Spring Core e Boot/01 - O que é Spring — Framework, Boot e o ecossistema|O que é Spring]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Jakarta EE/01 - O modelo Jakarta EE — especificações e implementações|O modelo Jakarta EE]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Mensageria/22 Saga — transações distribuídas por eventos|Saga — transações distribuídas por eventos]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/18 - Tracing distribuído I — correlação no código|Tracing distribuído I — correlação no código]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Segurança/11 - CORS — a borda, o preflight e a config de segurança|CORS]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Mensageria/23 Event sourcing e CQRS|Event sourcing e CQRS]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Segurança/10 - CSRF — por que ligado por default e quando desligar|CSRF]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Build e tooling/18 - Supply chain e SBOM|Supply chain e SBOM]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Programação Reativa/13 - R2DBC — persistência reativa sem EntityManager|R2DBC]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Testes/10 - @DataJpaTest — testando repositories|@DataJpaTest]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Mensageria/12 Dead Letter Topic — o padrão DLQ|Dead Letter Topic — o padrão DLQ]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Jakarta EE/13 - CDI avançado — interceptors, decorators e extensões|CDI avançado]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Mensageria/11 Tratamento de erro no consumo|Tratamento de erro no consumo]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Build e tooling/03 - Maven — dependências, scopes e exclusions|Maven — dependências e scopes]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Build e tooling/10 - Resolução de dependências e conflitos de versão|Resolução de dependências e conflitos]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Collections e Streams/02 - Listas, conjuntos e filas|Listas, conjuntos e filas]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Jakarta EE/10 - EntityManager e o ciclo de vida da entidade|EntityManager e o ciclo de vida da entidade]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Programação Reativa/10 - Spring WebFlux — o stack não-bloqueante sobre Netty e o DispatcherHandler|Spring WebFlux]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Web e APIs REST/06 - O pipeline do DispatcherServlet|O pipeline do DispatcherServlet]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Cloud-native e produção/05 - Imagem enxuta e segura — distroless e scanning|Imagem enxuta e segura — distroless e scanning]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Swing/07 - MVC em Swing e os models|MVC em Swing]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Swing/10 - Custom painting e componentes customizados|Custom painting]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Collections e Streams/11 - java.time — Date e Time API|java.time]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Swing/05 - A Event Dispatch Thread|EDT]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Jakarta EE/12 - EJB — o legado que moldou a plataforma|EJB — o legado que moldou a plataforma]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Collections e Streams/04 - Lambdas e interfaces funcionais|Lambdas e interfaces funcionais]], [[03-Dominios/Tecnologia/Java/Collections e Streams/13 - Composição funcional e funções de alta ordem|Composição funcional]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Spring Core e Boot/16 - SpringApplication e o embedded server|SpringApplication e o embedded server]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Segurança/07 - Method security — @PreAuthorize, @PostAuthorize e SpEL|Method security]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Certificação OCP/16 - Estratégia de estudo e recursos|Estratégia de estudo e recursos]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Jakarta EE/09 - JPA — a especificação de persistência|JPA — a especificação de persistência]].

### @EntityGraph
Anotação do Spring Data que define declarativamente quais associações carregar junto numa query (`attributePaths`) — a solução preferida para o problema N+1, sem o `JOIN FETCH` manual. Veja também: [[03-Dominios/Tecnologia/Java/Persistência de dados/08 - O problema N+1 e suas soluções — @EntityGraph, JOIN FETCH, batch size|O problema N+1]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Spring Core e Boot/11 - Eventos do ApplicationContext|Eventos do ApplicationContext]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Mensageria/13 Transações e exactly-once no Spring Kafka|Transações e exactly-once no Spring Kafka]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Certificação OCP/04 - O mapa objetivo → galho — revisar a trilha pra prova|O mapa objetivo → galho]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Jakarta EE/07 - JAX-RS — REST declarativo|JAX-RS — REST declarativo]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Segurança/06 - A arquitetura do filter chain em profundidade|A arquitetura do filter chain]].
...
### expand-and-contract
Padrão de migração de schema em três passos para mudar tabelas grandes sem downtime: expand (coluna nullable), backfill (em lotes), contract (aplica a constraint, ex.: NOT NULL) — cada passo numa migration separada, deployada em sequência. Veja também: [[03-Dominios/Tecnologia/Java/Persistência de dados/16 - Migrations de schema — Flyway, Liquibase e expand-and-contract|Migrations de schema]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Build e tooling/15 - Empacotamento — fat jar, thin jar e repackage|Empacotamento — fat jar e thin jar]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Swing/09 - Look and Feel e temas|Look and Feel]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Programação Reativa/02 - Reactive Streams — a spec das 4 interfaces e o Flow do Java 9|Reactive Streams]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Programação Reativa/03 - Mono e Flux — os publishers do Project Reactor|Mono e Flux]].

### Flyway
Ferramenta de migração de schema baseada em SQL versionado (`V<versão>__<descrição>.sql`) e repeatable (`R__`), com a tabela de controle `flyway_schema_history` e enforcement de checksum. Veja também: [[03-Dominios/Tecnologia/Java/Persistência de dados/16 - Migrations de schema — Flyway, Liquibase e expand-and-contract|Migrations de schema]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Web e APIs REST/01 - O que é Spring MVC — a camada web sobre o container|O que é Spring MVC]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Programação Reativa/12 - Functional endpoints — RouterFunction e HandlerFunction|Functional endpoints]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Collections e Streams/15 - Collectors customizados e Gatherers|Gatherers]].
...
### @GeneratedValue
Anotação JPA que define a estratégia de geração da chave primária: IDENTITY (auto-increment, impede batch), SEQUENCE (recomendado, permite batch via `allocationSize`), TABLE, AUTO e UUID (adicionada na JPA 3.1). Veja também: [[03-Dominios/Tecnologia/Java/Persistência de dados/02 - A entidade JPA — @Entity, @Id e geração de chave|A entidade JPA]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Web e APIs REST/02 - @RestController e os mapeamentos|@RestController e os mapeamentos]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Cloud-native e produção/12 - Graceful shutdown e deploy sem downtime|Graceful shutdown e deploy sem downtime]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Build e tooling/05 - Gradle — build script, tasks e configurations|Gradle — build script, tasks e configurations]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Cloud-native e produção/15 - Dashboards e alertas — Grafana|Dashboards e alertas — Grafana]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Swing/03 - Layout managers|Layout managers]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Mensageria/28 gRPC em Java — RPC síncrono sobre HTTP_2|gRPC em Java — RPC síncrono sobre HTTP/2]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Testes/11 - Testcontainers — infra real em testes|Testcontainers]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Web e APIs REST/11 - Interceptors vs Filters|Interceptors vs Filters]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Collections e Streams/03 - Mapas|Mapas]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Web e APIs REST/14 - HATEOAS|HATEOAS]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Cloud-native e produção/16 - OpenTelemetry Collector e sampling de produção|OpenTelemetry Collector e sampling de produção]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Web e APIs REST/05 - Serialização JSON com Jackson|Serialização JSON com Jackson]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Mensageria/20 Idempotência — o pilar do at-least-once|Idempotência — o pilar do at-least-once]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Testes/06 - Mockito — mocks, stubbing e matchers|Mockito]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Collections e Streams/04 - Lambdas e interfaces funcionais|Lambdas e interfaces funcionais]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Jakarta EE/02 - De Java EE a Jakarta EE|De Java EE a Jakarta EE]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Collections e Streams/12 - I-O moderno com java.nio.file|I/O moderno]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Build e tooling/09 - Distribuições do JDK e o ecossistema|Distribuições do JDK]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Cloud-native e produção/07 - Jib — imagem daemonless|Jib — imagem daemonless]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Build e tooling/15 - Empacotamento — fat jar, thin jar e repackage|Empacotamento]], [[03-Dominios/Tecnologia/Java/JVM/08 - JPMS — o sistema de módulos|JPMS]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Testes/18 - Performance — JMH e microbenchmarks|Performance — JMH]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Mensageria/02 Os modelos de mensageria — queue vs topic|Os modelos de mensageria — queue vs topic]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Mensageria/08 @KafkaListener — consumindo mensagens|@KafkaListener — consumindo mensagens]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Mensageria/07 KafkaTemplate — produzindo mensagens|KafkaTemplate — produzindo mensagens]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Mensageria/05 Kafka numa página para o dev de aplicação|Kafka numa página para o dev de aplicação]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Cloud-native e produção/04 - Dockerfile na prática — multi-stage e layered jar|Dockerfile na prática — multi-stage e layered jar]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Build e tooling/02 - Maven — POM, coordenadas e lifecycle|Maven — lifecycle]].
...
### Liquibase
Ferramenta de migração de schema baseada em changelog declarativo (changesets em XML/YAML/JSON/SQL), com rollback declarativo e a tabela de controle `DATABASECHANGELOG` (com MD5SUM). Alternativa ao Flyway. Veja também: [[03-Dominios/Tecnologia/Java/Persistência de dados/16 - Migrations de schema — Flyway, Liquibase e expand-and-contract|Migrations de schema]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Cloud-native e produção/10 - Health e probes — o contrato com o orquestrador|Health e probes — o contrato com o orquestrador]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Build e tooling/14 - Annotation processing — Lombok e MapStruct|Annotation processing — Lombok e MapStruct]].
...
### @ManyToMany
Associação muitos-para-muitos, mapeada por uma tabela de junção (`@JoinTable`). Quando a relação tem atributos próprios (quantidade, data), prefira uma entidade associativa explícita. Veja também: [[03-Dominios/Tecnologia/Java/Persistência de dados/06 - @ManyToMany, @OneToOne, cascade e orphanRemoval|@ManyToMany, @OneToOne, cascade e orphanRemoval]].

### @ManyToOne / @OneToMany
O par que modela uma associação um-para-muitos. O `@ManyToOne` é o owning side (tem a foreign key); o `@OneToMany(mappedBy = ...)` é o inverse side (só espelha). Veja também: [[03-Dominios/Tecnologia/Java/Persistência de dados/05 - Relacionamentos — @ManyToOne, @OneToMany e o owning side|Relacionamentos]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Build e tooling/02 - Maven — POM, coordenadas e lifecycle|Maven — POM, coordenadas e lifecycle]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Programação Reativa/06 - Combinando publishers — zip, merge, concat, filter|Combinando publishers]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Web e APIs REST/08 - Validação na borda|Validação na borda]], [[Dicionário de Java#Bean Validation (Jakarta Validation)|Bean Validation]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/01 - O que são microservices e a tese honesta|O que são microservices e a tese honesta]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Testes/08 - Spring Boot Test e os slices — o contexto de teste|Spring Boot Test e os slices]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Testes/09 - @WebMvcTest — testando controllers com MockMvc|@WebMvcTest]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Testes/16 - Mockando HTTP externo — WireMock e MockRestServiceServer|Mockando HTTP externo]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/23 - Quando NÃO fazer microservices|Quando NÃO fazer microservices]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/02 - Monorepo vs multi-repo|Monorepo vs multi-repo]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/22 - Service mesh — quando a resiliência sai do código|Service mesh]], [[03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/17 - Segurança entre serviços|Segurança entre serviços]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Build e tooling/12 - Projetos multi-módulo|Projetos multi-módulo]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Testes/17 - Mutation testing — PIT e cobertura honesta|Mutation testing — PIT]].
...
### N+1 (problema)
O bug de performance mais comum da JPA: ao carregar N entidades pai e acessar uma associação lazy de cada uma, geram-se 1 (pai) + N (filhos) queries. Resolve-se com `@EntityGraph`, `JOIN FETCH`, `@BatchSize` ou DTO projection. Veja também: [[03-Dominios/Tecnologia/Java/Persistência de dados/08 - O problema N+1 e suas soluções — @EntityGraph, JOIN FETCH, batch size|O problema N+1]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Testes/04 - Testes parametrizados e organização|Testes parametrizados e organização]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Programação Reativa/01 - O que é programação reativa — o modelo push, assíncrono e não-bloqueante|O que é programação reativa]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Certificação OCP/03 - Formato, logística e mecânica da prova|Formato, logística e mecânica da prova]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Jakarta EE/06 - CDI — qualifiers, producers e eventos|CDI — qualifiers, producers e eventos]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Certificação OCP/01 - A certificação OCP — o que é, por que (e por que não) fazer|A certificação OCP]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Cloud-native e produção/03 - Empacotando o app numa imagem — o panorama|Empacotando o app numa imagem — o panorama]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Certificação OCP/index|Certificação OCP (Galho 18)]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Programação Reativa/09 - Backpressure — request(n) e as estratégias BUFFER, DROP, LATEST|Backpressure]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Programação Reativa/07 - Error handling reativo — onErrorResume, onErrorReturn, retry|Error handling reativo]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Web e APIs REST/12 - Documentando a API com OpenAPI e Swagger|Documentando a API com OpenAPI e Swagger]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Collections e Streams/05 - Introdução à Stream API|Stream API]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Collections e Streams/10 - Optional|Optional]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Segurança/16 - OWASP Top 10 no contexto Java|OWASP Top 10 no contexto Java]].
...
### Pageable / Page / Slice
Abstrações de paginação do Spring Data: `Pageable`/`PageRequest` definem página+tamanho+ordenação; `Page<T>` traz o total (query `count` extra); `Slice<T>` só sabe se há próxima página (sem count, mais barato). Veja também: [[03-Dominios/Tecnologia/Java/Persistência de dados/11 - Paginação e ordenação — Pageable, Page e Slice|Paginação e ordenação]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Web e APIs REST/03 - Recebendo dados da request|Recebendo dados da request]].
...
### pessimistic locking
Bloqueio explícito no banco (`@Lock(LockModeType.PESSIMISTIC_WRITE)` → `SELECT ... FOR UPDATE`) que segura o lock até o commit; usado quando conflitos de escrita são frequentes. Cuidado com deadlocks (adquira locks em ordem consistente). Veja também: [[03-Dominios/Tecnologia/Java/Persistência de dados/13 - Locking — optimistic (@Version) e pessimistic|Locking]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Spring Core e Boot/08 - Qualificação de beans — @Qualifier, @Primary, @Profile|Qualificação de beans]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Web e APIs REST/10 - Problem Details — RFC 9457|Problem Details — RFC 9457]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Cloud-native e produção/14 - Métricas em produção — Micrometer e Prometheus|Métricas em produção — Micrometer e Prometheus]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Mensageria/27 Protocol Buffers — a IDL e a serialização binária|Protocol Buffers — a IDL e a serialização binária]].
...
### @Query (JPQL/native)
Anotação do Spring Data para escrever a query explicitamente — em JPQL (sobre entidades/atributos) ou SQL nativo (`nativeQuery = true`, sobre tabelas/colunas) — quando a derived query não basta. Veja também: [[03-Dominios/Tecnologia/Java/Persistência de dados/09 - Consultas com @Query — JPQL, native e @Modifying|Consultas com @Query]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Mensageria/25 Mensageria reativa — Reactor Kafka|Mensageria reativa — Reactor Kafka]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Segurança/13 - Refresh tokens e revogação de token|Refresh tokens e revogação de token]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Build e tooling/17 - Reprodutibilidade e reproducible builds|Reprodutibilidade e reproducible builds]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/13 - Resiliência I — a falha distribuída e o Circuit Breaker|Resiliência I — Circuit Breaker]], [[03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/16 - Resiliência IV — compondo os padrões|Resiliência IV — compondo os padrões]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Web e APIs REST/04 - ResponseEntity e status codes|ResponseEntity e status codes]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Web e APIs REST/15 - Clientes HTTP — RestClient, WebClient, RestTemplate|Clientes HTTP — RestClient, WebClient, RestTemplate]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Web e APIs REST/02 - @RestController e os mapeamentos|@RestController e os mapeamentos]], [[Dicionário de Java#@Component / estereótipos Spring|@Component / estereótipos Spring]].
...
Cache de entidades compartilhado entre transações/sessões (application-wide), opt-in no Hibernate (`@Cacheable` + `@Cache(usage = ...)`, com estratégias READ_ONLY/NONSTRICT_READ_WRITE/READ_WRITE/TRANSACTIONAL). Indicado para dados de referência lidos muito e mudados pouco. Veja também: [[03-Dominios/Tecnologia/Java/Persistência de dados/14 - Caching — 1º nível, 2º nível e Spring Cache|Caching]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Segurança/01 - O que é Spring Security — authn, authz e o filter chain|O que é Spring Security]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Spring Core e Boot/10 - Self-invocation e os limites do proxy|Self-invocation e os limites do proxy]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Collections e Streams/14 - SequencedCollection e SequencedMap|SequencedCollection]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/22 - Service mesh — quando a resiliência sai do código|Service mesh — quando a resiliência sai do código]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Jakarta EE/03 - Servlet API — o alicerce HTTP|Servlet API — o alicerce HTTP]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Segurança/15 - Session management e security headers|Session management e security headers]].
...
Predicado componível (`Specification<T>`) sobre a Criteria API, usado com `JpaSpecificationExecutor` para construir filtros dinâmicos (`where(...).and(...).or(...)`) — comum em APIs de busca. Veja também: [[03-Dominios/Tecnologia/Java/Persistência de dados/15 - Consultas dinâmicas e os limites da JPA — Specifications, Criteria e SQL|Consultas dinâmicas e os limites da JPA]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Spring Core e Boot/17 - Actuator e observabilidade|Actuator e observabilidade]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Spring Core e Boot/15 - Auto-configuration e starters|Auto-configuration e starters]], [[03-Dominios/Tecnologia/Java/Cloud-native e produção/09 - Native Image com Spring — Spring AOT na prática|Native Image com Spring — Spring AOT na prática]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Testes/12 - Testes de integração ponta a ponta|Testes de integração ponta a ponta]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/04 - Panorama do Spring Cloud — e o que morreu|Panorama do Spring Cloud — e o que morreu]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/12 - Config centralizado — Spring Cloud Config|Config centralizado — Spring Cloud Config]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/10 - API Gateway — papel, roteamento, predicates e filters|API Gateway]], [[03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/11 - Gateway reativo vs MVC — as duas variantes|Gateway reativo vs MVC]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Mensageria/17 Spring Cloud Stream — a abstração de binders|Spring Cloud Stream — a abstração de binders]].

### Spring Data JPA
Camada do Spring sobre a JPA/Hibernate que elimina o boilerplate do repositório: interfaces `JpaRepository`, queries derivadas, paginação, projections e Specifications. Veja também: [[03-Dominios/Tecnologia/Java/Persistência de dados/01 - O que é a camada de persistência — Spring Data, JPA e Hibernate|O que é a camada de persistência]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Testes/15 - Testando código reativo — StepVerifier e @WebFluxTest|Testando código reativo]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Cloud-native e produção/17 - Logs estruturados em produção|Logs estruturados em produção]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Swing/06 - SwingWorker e tarefas em background|SwingWorker]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Testes/05 - Test data builders e fixtures|Test data builders e fixtures]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Testes/01 - O que é testar em Java — a pirâmide e o stack moderno|O que é testar em Java]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/14 - Resiliência II — Retry e Time Limiter|Resiliência II — Retry e Time Limiter]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/17 - Segurança entre serviços|Segurança entre serviços]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Build e tooling/13 - Toolchains — buildar com um JDK, mirar outro|Toolchains]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Jakarta EE/11 - JTA — transações na plataforma|JTA — transações na plataforma]]; ver também o homônimo do Spring em [[#@Transactional (Spring)]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Spring Core e Boot/09 - AOP e proxies no Spring|AOP e proxies no Spring]]; ver também o homônimo da plataforma em [[#@Transactional (Jakarta)]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/03 - Os 12 fatores e o serviço cloud-native|Os 12 fatores e o serviço cloud-native]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Build e tooling/06 - Gradle — dependências, Version Catalogs e o wrapper|Gradle — dependências e Version Catalogs]].

### @Version (optimistic locking)
Campo de versão numa entidade que habilita o optimistic locking: o Hibernate adiciona `WHERE version = ?` no UPDATE e incrementa a versão; se 0 linhas forem afetadas, lança `OptimisticLockException`. Veja também: [[03-Dominios/Tecnologia/Java/Persistência de dados/13 - Locking — optimistic (@Version) e pessimistic|Locking]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Web e APIs REST/15 - Clientes HTTP — RestClient, WebClient, RestTemplate|Clientes HTTP — RestClient, WebClient, RestTemplate]], [[03-Dominios/Tecnologia/Java/Programação Reativa/11 - WebClient — o cliente HTTP reativo a fundo|WebClient a fundo]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Segurança/18 - Capstone — projetando a segurança de uma API Spring production-grade|Capstone de segurança]]. [[03-Dominios/Tecnologia/Java/Testes/13 - Testando a segurança|Testando a segurança]].
...
Veja também: [[03-Dominios/Tecnologia/Java/Build e tooling/04 - Maven — plugins, profiles e o wrapper|Maven — wrapper]], [[03-Dominios/Tecnologia/Java/Build e tooling/06 - Gradle — dependências, Version Catalogs e o wrapper|Gradle — wrapper]].
