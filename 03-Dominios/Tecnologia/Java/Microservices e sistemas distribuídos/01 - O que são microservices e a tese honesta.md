...
(O empacotamento e a produção desses serviços — containers, orquestração — são assunto do **[[03-Dominios/Tecnologia/Java/Cloud-native e produção/index|Galho 17]]**. Aqui a decisão é de fronteira, não de infra.)
...
- [[03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/23 - Quando NÃO fazer microservices|Quando NÃO fazer microservices]]
