...
O [[03-Dominios/Tecnologia/Java/Collections e Streams/01 - O Collections Framework|Collections Framework]] define as interfaces `Map`, `List`, `Queue` e `Set`. As concurrent collections implementam essas mesmas interfaces, de modo que substituem as versões não thread-safe sem alterar o código cliente.
...
- [[Java Concurrency]]
- [[03-Dominios/Tecnologia/Java/Dicionário de Java#ConcurrentHashMap|ConcurrentHashMap]]
- [[03-Dominios/Tecnologia/Java/Dicionário de Java#BlockingQueue|BlockingQueue]]
