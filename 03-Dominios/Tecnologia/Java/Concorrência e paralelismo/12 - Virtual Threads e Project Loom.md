...
> Este card não ensina programação reativa. O confronto detalhado (backpressure, operadores, quando reativo ainda vence) pertence ao **Galho 11** — [[03-Dominios/Tecnologia/Java/Programação Reativa/14 - Reativo vs Virtual Threads — o confronto honesto|Reativo vs Virtual Threads]]. Para o panorama de concorrência completo, ver o tronco [[Java Concurrency]].
...
- [[Java Concurrency]]
- [[Java Fundamentals]]
- [[03-Dominios/Tecnologia/Java/Dicionário de Java#Virtual thread|virtual thread]]
- [[03-Dominios/Tecnologia/Java/Dicionário de Java#Carrier thread|carrier thread]]
- [[03-Dominios/Tecnologia/Java/Dicionário de Java#Pinning|pinning]]
- [[03-Dominios/Tecnologia/Java/Dicionário de Java#Thread pool|thread pool]]
