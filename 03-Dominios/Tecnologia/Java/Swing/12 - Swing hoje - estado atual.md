...
- **FlatLaf** — um *Look and Feel* moderno (flat, com *dark mode* e temas tipo IntelliJ) que tira o "cara de 2005" de um app Swing com poucas linhas. É o exemplo mais citado de que Swing pode parecer moderno hoje. Veja [[03-Dominios/Tecnologia/Java/Swing/09 - Look and Feel e temas|Look and Feel e temas]].
...
A comparação detalhada — quando preferir JavaFX a Swing, o modelo de *scene graph*, *properties* e *binding* — é assunto do Galho 6: ver [[03-Dominios/Tecnologia/Java/JavaFX/14 - JavaFX hoje — estado do projeto e Swing vs JavaFX|JavaFX hoje — estado do projeto e Swing vs JavaFX]]. Aqui o JavaFX entra só como **gancho**: saiba que existe, que é a alternativa desktop "moderna" do Java, e que vive fora do JDK desde o Java 11.
...
| Greenfield com UI rica/animada | Não — avalie [[03-Dominios/Tecnologia/Java/JavaFX/index|JavaFX]] ou web |
...
- **"App de produto com UI animada, gráficos, terá versão web no roadmap, time vem de front-end web."** → desktop talvez, mas web no horizonte → UI rica → time só-web → **Swing está fora**: avalie uma stack web (que cobre o futuro web de graça) ou, se desktop nativo for mandatório, [[03-Dominios/Tecnologia/Java/JavaFX/index|JavaFX]].
...
| Preciso de… | Nota |
|-------------|------|
| Fundamentos: o que é Swing, lightweight vs heavyweight, top-level containers | [[03-Dominios/Tecnologia/Java/Swing/01 - O modelo do Swing\|01 – O modelo do Swing]] |
| Componentes e containers; layout; modelo de eventos | 02 – Componentes / 03 – Layout managers / 04 – Modelo de eventos |
| Threading / EDT: por que single-thread, `invokeLater`/`invokeAndWait` | [[03-Dominios/Tecnologia/Java/Swing/05 - A Event Dispatch Thread\|05 – EDT]] |
| Background work sem congelar a UI | 06 – SwingWorker |
| Models (MVC em Swing): `TableModel`, `ListModel`, separar dado de view | [[03-Dominios/Tecnologia/Java/Swing/07 - MVC em Swing e os models\|07 – MVC e models]] |
| Renderizar/editar células de tabelas, listas, árvores | 08 – Renderers e editors |
| Aparência: Look and Feel, temas, FlatLaf, dark mode | [[03-Dominios/Tecnologia/Java/Swing/09 - Look and Feel e temas\|09 – Look and Feel]] |
...
- [[03-Dominios/Tecnologia/Java/Swing/01 - O modelo do Swing|O modelo do Swing]]
...
- [[03-Dominios/Tecnologia/Java/Swing/09 - Look and Feel e temas|Look and Feel e temas]]
...
- [[03-Dominios/Tecnologia/Java/JavaFX/index|JavaFX (Galho 6)]] — a alternativa desktop moderna do Java; comparação em [[03-Dominios/Tecnologia/Java/JavaFX/14 - JavaFX hoje — estado do projeto e Swing vs JavaFX|JavaFX hoje]].
...
- Cross-ref interno (Galho 4): [[03-Dominios/Tecnologia/Java/Concorrência e paralelismo/12 - Virtual Threads e Project Loom|Virtual Threads e Project Loom]] — base do *caveat* de que virtual threads não alteram a EDT.
