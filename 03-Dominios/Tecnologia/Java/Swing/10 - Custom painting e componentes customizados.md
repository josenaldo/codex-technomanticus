...
3. **Sobrescrever `getPreferredSize()`** — diz ao layout manager quanto espaço o componente precisa. Sem isso, o tamanho preferido é `(0, 0)` e o componente pode se tornar invisível com `FlowLayout` ou `BoxLayout` (ver Armadilha 3 da nota [[03-Dominios/Tecnologia/Java/Swing/03 - Layout managers|Layout managers]]).
...
Além disso, pintar de uma thread que não seja a EDT viola a single-thread rule do Swing (ver [[03-Dominios/Tecnologia/Java/Swing/05 - A Event Dispatch Thread|A Event Dispatch Thread]]) — o Swing não sincroniza o acesso à superfície de pintura.
...
- [[03-Dominios/Tecnologia/Java/Dicionário de Java#paintComponent / custom painting|paintComponent / custom painting]]
- [[03-Dominios/Tecnologia/Java/Dicionário de Java#double buffering|double buffering]]
