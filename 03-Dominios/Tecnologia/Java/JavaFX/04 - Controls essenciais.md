...
> O tratamento de `Optional<ButtonType>` retornado por `showAndWait()` usa o mesmo padrão de `Optional` explorado em [[03-Dominios/Tecnologia/Java/Collections e Streams/10 - Optional|Optional (Galho 2)]].
