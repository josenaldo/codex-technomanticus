...
**Descrição.** Achar que Swing foi deprecado/marcado para remoção e que isso *obriga* a migrar para JavaFX. **Falso.** Swing é **core Java SE**, suportado enquanto o JDK for suportado, sem *deprecation* e sem data de remoção — cravado na [[03-Dominios/Tecnologia/Java/Swing/12 - Swing hoje - estado atual|capstone do Galho 5]]. "Modo de manutenção" é **jargão da comunidade** sobre o ritmo de evolução, **não** termo oficial da Oracle.
...
- [[03-Dominios/Tecnologia/Java/Swing/12 - Swing hoje - estado atual|Swing hoje (Galho 5)]]
- [[03-Dominios/Tecnologia/Java/Swing/index|Swing (MOC do Galho 5)]]
- [[03-Dominios/Tecnologia/Java/JavaFX/index|JavaFX (MOC do galho)]]
- [[03-Dominios/Tecnologia/Java/index|Trilha Java]]
- [[03-Dominios/Tecnologia/Java/Dicionário de Java#OpenJFX|OpenJFX (Dicionário)]]
- [[03-Dominios/Tecnologia/Java/Dicionário de Java#Gluon|Gluon (Dicionário)]]
...
- [[03-Dominios/Tecnologia/Java/Swing/12 - Swing hoje - estado atual|Swing hoje (Galho 5)]] — base do fato "Swing é core Java SE suportado; 'modo de manutenção' é jargão de comunidade, não termo oficial".
