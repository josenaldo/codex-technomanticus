...
- [[03-Dominios/Tecnologia/Java/Spring Core e Boot/05 - @Configuration e @Bean — definição explícita de beans|@Configuration e @Bean]]
...
- [[03-Dominios/Tecnologia/Java/Dicionário de Java#@Conditional / @ConditionalOnX|@Conditional / @ConditionalOnX]]
