...
- **Exec-form**: define se o seu processo Java recebe ou não o `SIGTERM` que o orquestrador manda na hora de desligar — e isso decide se o [[03-Dominios/Tecnologia/Java/Cloud-native e produção/12 - Graceful shutdown e deploy sem downtime|graceful shutdown]] funciona ou não.
...
- [[03-Dominios/Tecnologia/Java/Cloud-native e produção/05 - Imagem enxuta e segura — distroless e scanning|Imagem enxuta e segura]]
