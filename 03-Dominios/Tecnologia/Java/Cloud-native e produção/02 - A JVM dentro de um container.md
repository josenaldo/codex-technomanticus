...
> O que acontece **dentro** do heap — como o GC organiza e recicla a memória, gerações, coletores — é assunto do [[03-Dominios/Tecnologia/Java/JVM/03 - Garbage Collection — o conceito|Garbage Collection (Galho 3)]]. Aqui o foco é só **quanto** heap a JVM se concede a partir do limite do container, não **como** ela o gerencia por dentro.
...
- [[03-Dominios/Tecnologia/Java/Cloud-native e produção/01 - Production-ready e cloud-native — a tese honesta|Production-ready e cloud-native]]
- [[03-Dominios/Tecnologia/Java/Cloud-native e produção/11 - Config e recursos no Kubernetes|Config e recursos no Kubernetes]]
- [[03-Dominios/Tecnologia/Java/JVM/03 - Garbage Collection — o conceito|Garbage Collection (Galho 3)]]
- [[03-Dominios/Tecnologia/Java/Cloud-native e produção/index|Cloud-native e produção (MOC do galho)]]
- [[03-Dominios/Tecnologia/Java/index|Trilha Java]]

A observabilidade interna dessa JVM (JFR, heap, GC) é o [[03-Dominios/Tecnologia/Java/JVM/13 - JFR e JMC — observabilidade de produção|Galho 3]]; operar as métricas dela no cluster é a [[03-Dominios/Tecnologia/Java/Cloud-native e produção/13 - Observabilidade de operação — o panorama e os 3 seams|observabilidade de operação]] deste galho.
