...
> Há **3 vias** de construir a imagem: Dockerfile à mão ([[03-Dominios/Tecnologia/Java/Cloud-native e produção/04 - Dockerfile na prática — multi-stage e layered jar|nota 04]]), Buildpacks ([[03-Dominios/Tecnologia/Java/Cloud-native e produção/06 - Buildpacks — imagem sem Dockerfile|nota 06]]) e Jib ([[03-Dominios/Tecnologia/Java/Cloud-native e produção/07 - Jib — imagem daemonless|nota 07]]).
> **Não confunda** com o empacotamento do *JAR* (fat/thin/repackage) — isso é o [[03-Dominios/Tecnologia/Java/Build e tooling/15 - Empacotamento — fat jar, thin jar e repackage|Galho 15]]. Aqui o assunto é a **imagem de container**.
