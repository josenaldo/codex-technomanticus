...
> [!abstract] TL;DR
> CDI é a especificação de **Contexts and Dependency Injection** da plataforma Jakarta EE: o container constrói o grafo de objetos por você, gerencia o ciclo de vida de cada instância e resolve automaticamente quem depende de quem. **É isso que o `@Autowired` esconde** — o Spring (veja [[03-Dominios/Tecnologia/Java/Spring Core e Boot/02 - IoC e injeção de dependência no Spring|IoC e DI no Spring]]) implementa um container próprio inspirado nesse modelo; entender CDI torna o Spring transparente, não o contrário.
...
Se você ainda não conhece bem annotations e retention policies, leia primeiro: [[03-Dominios/Tecnologia/Java/Linguagem e sintaxe moderna/11 - Annotations|Annotations (Galho 1)]]. CDI é um uso intenso de annotations RUNTIME + reflection; entender a mecânica base evita confusão.
...
- [[03-Dominios/Tecnologia/Java/Dicionário de Java#CDI (Contexts and Dependency Injection)|CDI (Dicionário)]]
- [[03-Dominios/Tecnologia/Java/Dicionário de Java#bean (CDI)|bean (Dicionário)]]
- [[03-Dominios/Tecnologia/Java/Dicionário de Java#@Inject|@Inject (Dicionário)]]
- [[03-Dominios/Tecnologia/Java/Dicionário de Java#bean discovery / beans.xml|bean discovery (Dicionário)]]
