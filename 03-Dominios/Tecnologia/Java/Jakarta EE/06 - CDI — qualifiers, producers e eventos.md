...
> Observers assíncronos rodam fora do contexto da requisição original. Para processamento concorrente mais elaborado — pools, virtual threads, `CompletableFuture` — veja [[03-Dominios/Tecnologia/Java/Concorrência e paralelismo/index|Concorrência (Galho 4)]]; esta nota não re-explica o modelo de threading.
...
- [[03-Dominios/Tecnologia/Java/Dicionário de Java#qualifier (CDI)|qualifier (Dicionário)]]
- [[03-Dominios/Tecnologia/Java/Dicionário de Java#@Produces (producer CDI)|@Produces (Dicionário)]]
- [[03-Dominios/Tecnologia/Java/Dicionário de Java#@Observes / eventos CDI|@Observes (Dicionário)]]
