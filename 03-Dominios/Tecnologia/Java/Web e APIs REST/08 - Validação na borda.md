...
- [[03-Dominios/Tecnologia/Java/Jakarta EE/08 - Bean Validation|Bean Validation]] (a spec — as constraints `@NotBlank`/`@Email`/...)
- [[03-Dominios/Tecnologia/Java/Spring Core e Boot/12 - Configuração e profiles|Configuração e profiles]] (`@Validated` na config)
- [[03-Dominios/Tecnologia/Java/Web e APIs REST/index|Web e APIs REST]]
- [[03-Dominios/Tecnologia/Java/index|Trilha Java]]
- Verbete: [[03-Dominios/Tecnologia/Java/Dicionário de Java#MethodArgumentNotValidException|MethodArgumentNotValidException]]
...
- Jakarta Bean Validation spec (Galho 7): [[03-Dominios/Tecnologia/Java/Jakarta EE/08 - Bean Validation|Bean Validation]]
