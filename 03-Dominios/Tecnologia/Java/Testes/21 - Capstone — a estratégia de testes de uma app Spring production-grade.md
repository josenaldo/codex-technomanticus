...
| --- | --- |
| Como começo? Qual a pirâmide e o stack? | [[03-Dominios/Tecnologia/Java/Testes/01 - O que é testar em Java — a pirâmide e o stack moderno\|nota 01]] |
| Como escrevo um teste JUnit 5 (lifecycle, AAA)? | [[03-Dominios/Tecnologia/Java/Testes/02 - JUnit 5 — anatomia, lifecycle e o padrão AAA\|nota 02]] |
| Como faço asserções legíveis? | [[03-Dominios/Tecnologia/Java/Testes/03 - AssertJ — fluent assertions\|nota 03]] |
| Como rodo o mesmo teste com vários inputs? | [[03-Dominios/Tecnologia/Java/Testes/04 - Testes parametrizados e organização\|nota 04]] |
| Como evito setup duplicado e construtores enormes? | [[03-Dominios/Tecnologia/Java/Testes/05 - Test data builders e fixtures\|nota 05]] |
| Como mocko colaboradores? | [[03-Dominios/Tecnologia/Java/Testes/06 - Mockito — mocks, stubbing e matchers\|nota 06]] |
| Como verifico interações / capturo argumentos? | [[03-Dominios/Tecnologia/Java/Testes/07 - Mockito — verify, ArgumentCaptor e quando NÃO mockar\|nota 07]] |
| Qual slice do Spring uso? | [[03-Dominios/Tecnologia/Java/Testes/08 - Spring Boot Test e os slices — o contexto de teste\|nota 08]] |
| Como testo um controller? | [[03-Dominios/Tecnologia/Java/Testes/09 - @WebMvcTest — testando controllers com MockMvc\|nota 09]] |
| Como testo um repository? | [[03-Dominios/Tecnologia/Java/Testes/10 - @DataJpaTest — testando repositories\|nota 10]] |
| Como uso banco real no teste? | [[03-Dominios/Tecnologia/Java/Testes/11 - Testcontainers — infra real em testes\|nota 11]] |
| Como testo o fluxo inteiro? | [[03-Dominios/Tecnologia/Java/Testes/12 - Testes de integração ponta a ponta\|nota 12]] |
| Como testo endpoint protegido? | [[03-Dominios/Tecnologia/Java/Testes/13 - Testando a segurança\|nota 13]] |
| Como testo código assíncrono? | [[03-Dominios/Tecnologia/Java/Testes/14 - Testando código assíncrono — Awaitility\|nota 14]] |
| Como testo Mono/Flux? | [[03-Dominios/Tecnologia/Java/Testes/15 - Testando código reativo — StepVerifier e @WebFluxTest\|nota 15]] |
| Como mocko uma API externa? | [[03-Dominios/Tecnologia/Java/Testes/16 - Mockando HTTP externo — WireMock e MockRestServiceServer\|nota 16]] |
| Meus testes pegam bug de verdade? | [[03-Dominios/Tecnologia/Java/Testes/17 - Mutation testing — PIT e cobertura honesta\|nota 17]] |
| Como meço performance corretamente? | [[03-Dominios/Tecnologia/Java/Testes/18 - Performance — JMH e microbenchmarks\|nota 18]] |
| Como protejo a arquitetura? | [[03-Dominios/Tecnologia/Java/Testes/19 - Fitness functions — ArchUnit (testes de arquitetura)\|nota 19]] |
| Como garanto contrato entre serviços? | [[03-Dominios/Tecnologia/Java/Testes/20 - Contract testing — Pact\|nota 20]] |
...
- [[03-Dominios/Tecnologia/Java/Testes/01 - O que é testar em Java — a pirâmide e o stack moderno|O que é testar em Java]]
...
Galhos seguintes da trilha — mensageria e eventos ([[03-Dominios/Tecnologia/Java/Mensageria/index|Galho 14]]), microservices ([[03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/index|Galho 16]]) e cloud-native/produção ([[03-Dominios/Tecnologia/Java/Cloud-native e produção/index|Galho 17]]) — vão exigir suas próprias estratégias de teste, mas a base da pirâmide construída aqui permanece a mesma.

Se você for ler uma nota só depois desta, leia a [[03-Dominios/Tecnologia/Java/Testes/17 - Mutation testing — PIT e cobertura honesta|17 (mutation testing)]]: é o verbete que mais muda a forma como você enxerga a própria suíte, porque transforma "tenho testes" em "sei que meus testes funcionam". É o passo que separa cobertura de teatro de cobertura de verdade.
