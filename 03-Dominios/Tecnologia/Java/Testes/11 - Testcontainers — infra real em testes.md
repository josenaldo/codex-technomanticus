...
O **LocalStack** merece destaque: emula serviços AWS (S3, SQS, DynamoDB) num container, deixando você testar integração com a nuvem sem credenciais nem custo. Kafka aprofundado (rebalance, exactly-once, schemas) é o galho [[03-Dominios/Tecnologia/Java/Mensageria/index|Mensageria]]; aqui basta saber que o módulo existe e que `@ServiceConnection` o auto-configura.
