...
O `@RestControllerAdvice` é o gancho central para tratamento de exceções em APIs REST — tema aprofundado em [[03-Dominios/Tecnologia/Java/Web e APIs REST/09 - Tratamento de exceções com @ControllerAdvice|Tratamento de exceções com @ControllerAdvice]]. O formato `ProblemDetail` ([[03-Dominios/Tecnologia/Java/Web e APIs REST/10 - Problem Details — RFC 9457|RFC 9457]]) é o padrão moderno de resposta de erro em Spring Boot 3+.
