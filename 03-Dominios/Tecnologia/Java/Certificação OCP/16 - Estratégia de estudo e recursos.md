...
> Esta edição do guia de estudo cobre exclusivamente o **1Z0-830 / Java 21**. Até o momento **não há edição para Java 25** (1Z0-831). Quem mira o Java 25 precisa complementar o livro com a documentação oficial das mudanças de versão. Esse é mais um argumento de peso para [[03-Dominios/Tecnologia/Java/Certificação OCP/02 - Qual prova mirar — Java 21 (1Z0-830) vs Java 25 (1Z0-831)|mirar o Java 21]] na primeira tentativa.
