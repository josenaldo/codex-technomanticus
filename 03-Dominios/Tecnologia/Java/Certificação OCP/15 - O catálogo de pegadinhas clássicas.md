...
O compilador *desce* essa escada e para no primeiro nível que tem candidato. Por isso `handle(1)` chama `int` (match exato), e não `Integer` nem `Object`, mesmo que ambos sirvam. Veja o domínio em [[03-Dominios/Tecnologia/Java/Certificação OCP/07 - Domínio 3 — Orientação a objetos|Domínio 3 — Orientação a objetos]].
...
- [[03-Dominios/Tecnologia/Java/Certificação OCP/16 - Estratégia de estudo e recursos|Estratégia de estudo e recursos]]
