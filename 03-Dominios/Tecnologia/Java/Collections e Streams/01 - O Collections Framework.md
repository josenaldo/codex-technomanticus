...
O Collections Framework inclui wrappers thread-safe (`Collections.synchronizedList`) e implementações concorrentes (`ConcurrentHashMap`, `CopyOnWriteArrayList`). Este é um tópico do [[03-Dominios/Tecnologia/Java/Concorrência e paralelismo/07 - Concurrent collections|Galho 4 — Concurrent collections]]. Aqui apenas se registra que a necessidade existe; o design correto para ambientes multi-thread vai para esse galho.
...
- [[03-Dominios/Tecnologia/Java/Linguagem e sintaxe moderna/12 - Generics em profundidade|Generics]]
- [[03-Dominios/Tecnologia/Java/Concorrência e paralelismo/07 - Concurrent collections|Concurrent collections]]
- [[03-Dominios/Tecnologia/Java/Dicionário de Java#Collections Framework|Collections Framework]]
