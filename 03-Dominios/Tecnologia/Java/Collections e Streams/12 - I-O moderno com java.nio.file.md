...
Para o funcionamento detalhado do `try-with-resources` (exceções suprimidas, ordem de fechamento, multi-recurso), veja [[03-Dominios/Tecnologia/Java/Linguagem e sintaxe moderna/10 - Exceções e tratamento de erros|Exceções e tratamento de erros]].
...
- [[03-Dominios/Tecnologia/Java/Linguagem e sintaxe moderna/10 - Exceções e tratamento de erros|Exceções]]
- [[03-Dominios/Tecnologia/Java/Dicionário de Java#java.nio.file (Path / Files)|java.nio.file]]
- [[03-Dominios/Tecnologia/Java/Dicionário de Java#try-with-resources|try-with-resources]]
