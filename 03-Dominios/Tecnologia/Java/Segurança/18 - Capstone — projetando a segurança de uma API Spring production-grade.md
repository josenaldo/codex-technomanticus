...
- Veja [[03-Dominios/Tecnologia/Java/Segurança/01 - O que é Spring Security — authn, authz e o filter chain|O que é Spring Security]] e [[03-Dominios/Tecnologia/Java/Segurança/06 - A arquitetura do filter chain em profundidade|A arquitetura do filter chain]].
...
- Veja [[03-Dominios/Tecnologia/Java/Segurança/08 - JWT — estrutura, assinatura e validação|JWT]] e [[03-Dominios/Tecnologia/Java/Segurança/09 - OAuth2 Resource Server — validando JWT na API|OAuth2 Resource Server]].
...
- Veja [[03-Dominios/Tecnologia/Java/Segurança/04 - Password encoding — BCrypt, Argon2 e o DelegatingPasswordEncoder|Password encoding]].
...
- Veja [[03-Dominios/Tecnologia/Java/Segurança/10 - CSRF — por que ligado por default e quando desligar|CSRF]].
...
- Veja [[03-Dominios/Tecnologia/Java/Segurança/11 - CORS — a borda, o preflight e a config de segurança|CORS]].
...
- Veja [[03-Dominios/Tecnologia/Java/Segurança/15 - Session management e security headers|Session management e security headers]].
...
- Veja [[03-Dominios/Tecnologia/Java/Segurança/13 - Refresh tokens e revogação de token|Refresh tokens]].
...
A montagem completa dessa stack de teste (slices, `MockMvc`, fixtures de identidade, asserts) é assunto do galho [[03-Dominios/Tecnologia/Java/Testes/13 - Testando a segurança|Testes]]. Aqui fica só a fronteira: se você desenhou a segurança como acima, você a valida com mock user / JWT de teste — não testando no navegador na unha.
...
| --- | --- |
| Como funciona o filter chain de ponta a ponta? | [[03-Dominios/Tecnologia/Java/Segurança/01 - O que é Spring Security — authn, authz e o filter chain\|nota 01]] |
| Como guardo senha sem fazer besteira? | [[03-Dominios/Tecnologia/Java/Segurança/04 - Password encoding — BCrypt, Argon2 e o DelegatingPasswordEncoder\|nota 04]] |
| Como protejo URLs por padrão? | [[03-Dominios/Tecnologia/Java/Segurança/05 - Autorização baseada em URL — authorizeHttpRequests, roles vs authorities\|nota 05]] |
| Como configuro tudo com a lambda DSL moderna? | [[03-Dominios/Tecnologia/Java/Segurança/06 - A arquitetura do filter chain em profundidade\|nota 06]] |
| Por que `@PreAuthorize` não funciona? | [[03-Dominios/Tecnologia/Java/Segurança/07 - Method security — @PreAuthorize, @PostAuthorize e SpEL\|nota 07]] |
| Quem emite e quem valida o token? | [[03-Dominios/Tecnologia/Java/Segurança/08 - JWT — estrutura, assinatura e validação\|nota 08]] |
| Como valido um JWT (JWKS, claims, `alg`)? | [[03-Dominios/Tecnologia/Java/Segurança/09 - OAuth2 Resource Server — validando JWT na API\|nota 09]] |
| Ligo ou desligo CSRF? | [[03-Dominios/Tecnologia/Java/Segurança/10 - CSRF — por que ligado por default e quando desligar\|nota 10]] |
| Por que CORS com `*` e credenciais quebra? | [[03-Dominios/Tecnologia/Java/Segurança/11 - CORS — a borda, o preflight e a config de segurança\|nota 11]] |
| Como revogo uma sessão antes do `exp`? | [[03-Dominios/Tecnologia/Java/Segurança/13 - Refresh tokens e revogação de token\|nota 13]] |
| Como escrevo regra de autorização avançada (RBAC/ABAC)? | [[03-Dominios/Tecnologia/Java/Segurança/14 - Autorização avançada — AuthorizationManager, RBAC vs ABAC\|nota 14]] |
| Quais headers de segurança ligar? | [[03-Dominios/Tecnologia/Java/Segurança/15 - Session management e security headers\|nota 15]] |
| Onde isso tudo encaixa no OWASP Top 10? | [[03-Dominios/Tecnologia/Java/Segurança/16 - OWASP Top 10 no contexto Java\|nota 16]] |
| Como é uma request autenticada de ponta a ponta? | [[03-Dominios/Tecnologia/Java/Segurança/17 - Uma request autenticada do token à autorização no método\|nota 17]] |
