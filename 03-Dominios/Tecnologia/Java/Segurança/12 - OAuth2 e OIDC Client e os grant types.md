...
> OAuth2 como SSO/gateway entre microservices (propagação de token, token relay) é o galho [[03-Dominios/Tecnologia/Java/Microservices e sistemas distribuídos/17 - Segurança entre serviços|Microservices e sistemas distribuídos]].
...
Detalhe de validação do JWT (assinatura, claims, `exp`) é a [[03-Dominios/Tecnologia/Java/Segurança/08 - JWT — estrutura, assinatura e validação|nota 08]] e o lado Resource Server é a nota 09. Aqui o foco é **chegar** ao token.
...
- [[03-Dominios/Tecnologia/Java/Segurança/13 - Refresh tokens e revogação de token|Refresh tokens e revogação de token]]
