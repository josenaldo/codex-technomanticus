...
Para a anatomia do JWT em si (header, payload, assinatura, validação), veja [[03-Dominios/Tecnologia/Java/Segurança/08 - JWT — estrutura, assinatura e validação|JWT]]; aqui o foco é o ciclo de vida e a revogação.
