...
Após esgotar as tentativas, o `DeadLetterPublishingRecoverer` envia a mensagem para o tópico DLT (Dead Letter Topic). O detalhamento desse padrão está na [[03-Dominios/Tecnologia/Java/Mensageria/12 - Dead Letter Topic — o padrão DLQ|nota 12]].
...
- [[03-Dominios/Tecnologia/Java/Mensageria/12 - Dead Letter Topic — o padrão DLQ|Dead Letter Topic — o padrão DLQ]]
- [[03-Dominios/Tecnologia/Java/Mensageria/10 - Ack modes e commit de offset|Ack modes e commit de offset]]
- [[03-Dominios/Tecnologia/Java/Mensageria/09 - (De)serialização de mensagens|(De)serialização de mensagens]]
