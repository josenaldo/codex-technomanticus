...
A nota [[03-Dominios/Tecnologia/Java/Backend/Kafka/Kafka Concepts/17. Kafka Connect|Kafka Connect (infra)]] cobre a arquitetura interna, workers standalone vs. distributed e o modelo de tasks. Esta nota foca em **quando e como usar Connect do ponto de vista de quem desenvolve serviços**.
...
- [[03-Dominios/Tecnologia/Java/Backend/Kafka/Kafka Concepts/17. Kafka Connect|Kafka Connect (infra)]]
- [[03-Dominios/Tecnologia/Java/Mensageria/21 - O padrão Outbox|O padrão Outbox]]
- [[03-Dominios/Tecnologia/Java/Mensageria/18 - Kafka Streams pela API Java|Kafka Streams pela API Java]]
