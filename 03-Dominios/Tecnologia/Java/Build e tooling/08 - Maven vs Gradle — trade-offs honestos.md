...
Você já viu os dois modelos nas notas anteriores: o [[03-Dominios/Tecnologia/Java/Build e tooling/02 - Maven — POM, coordenadas e lifecycle|POM e o lifecycle do Maven]] e o [[03-Dominios/Tecnologia/Java/Build e tooling/05 - Gradle — build script, tasks e configurations|build script, tasks e configurations do Gradle]]. Esta nota não reapresenta nenhum dos dois — ela junta os dois numa **moldura de decisão honesta**.
...
Aqui o Gradle tem vantagem técnica concreta, já detalhada na nota [[03-Dominios/Tecnologia/Java/Build e tooling/07 - Gradle — performance, build cache e daemon|Gradle — performance, build cache e daemon]]:
...
- [[03-Dominios/Tecnologia/Java/Build e tooling/20 - Capstone — o mesmo projeto em Maven e Gradle|Capstone comparativo]]
