...
>
> Talk oficial da AWS inteiramente dedicada a lifecycle e classes de armazenamento — cobre o mesmo mapa de classes desta nota (Standard até Glacier Deep Archive) com exemplos de padrões de acesso reais que motivam cada transição. Vale assistir a primeira parte para ver o raciocínio por trás do Intelligent-Tiering antes de seguir pras lifecycle policies manuais. Trecho de destaque [2:00]: *"so esri intelligent tiering is the only storage class in the cloud [that delivers automatic storage cost savings]"*
>
