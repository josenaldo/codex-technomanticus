...
- [Google Cloud — Architecture Framework](https://cloud.google.com/architecture/framework) — categorias do framework equivalente do Google Cloud, usado só como vocabulário de tradução; acessado em 2026-07-20.
