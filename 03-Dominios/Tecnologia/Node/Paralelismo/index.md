...
Pré-requisito: galho 1 ([[03-Dominios/Tecnologia/Node/Runtime e Event Loop/index]]). Em particular as notas [[09 - async-await - o que é, o que não é]] (mito da performance) e [[10 - Bloqueio do event loop - sintomas e causas]] (sintomas que pedem paralelismo).
