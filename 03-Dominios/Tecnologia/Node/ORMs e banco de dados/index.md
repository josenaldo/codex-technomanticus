...
**Pré-requisito:** [[03-Dominios/Tecnologia/Node/Frameworks e arquitetura/index]] (galho 4) — pressupõe entender como uma API Node está estruturada antes de conectar banco. [[Node.js]] (tronco) — especialmente async/await e event loop para entender o comportamento de queries assíncronas.
