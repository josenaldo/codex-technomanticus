...
>
> Critério de escolha: `fetch` para padrão moderno, `undici` para performance crítica, `got` para retry/stream embutidos, `axios` quando interceptors ou legado exigem. Veja [[03-Dominios/Tecnologia/Node/Integrações/index|Integrações]] para o contexto completo do galho.
