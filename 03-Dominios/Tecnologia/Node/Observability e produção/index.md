...
**Pré-requisitos:**
- [[03-Dominios/Tecnologia/Node/Runtime e Event Loop/index]] (galho 1) — event loop phases, libuv thread pool, bloqueio — necessário para entender event loop lag e clinic.js
- [[03-Dominios/Tecnologia/Node/Frameworks e arquitetura/index]] (galho 4) — middleware pipeline e hooks de shutdown nos frameworks
