...
- [[03-Dominios/Tecnologia/Node/Segurança/01 - Supply chain attacks e npm audit]] — npm audit, socket.dev, lockfile integrity
- [[03-Dominios/Tecnologia/Node/Segurança/02 - Segredos e variáveis de ambiente]] — vault, env validation, rotação de segredos
- [[03-Dominios/Tecnologia/Node/Segurança/03 - Validação de entrada com Zod e Joi]] — Zod v3, Joi v17, middleware de validação
- [[03-Dominios/Tecnologia/Node/Segurança/04 - JWT e autenticação com jsonwebtoken]] — sign/verify, access+refresh, blacklist Redis
- [[03-Dominios/Tecnologia/Node/Segurança/05 - OAuth 2.0 e OIDC com openid-client]] — Authorization Code + PKCE, ID Token, openid-client v5
- [[03-Dominios/Tecnologia/Node/Segurança/06 - RBAC e ABAC com casl e casbin]] — defineAbility, can/cannot, casbin policies
- [[03-Dominios/Tecnologia/Node/Segurança/07 - Rate limiting com express-rate-limit]] — express-rate-limit v7, Redis store, algoritmos
