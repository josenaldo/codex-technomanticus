...
- [[03-Dominios/Tecnologia/Node/Segurança/05 - OAuth 2.0 e OIDC com openid-client|OAuth 2.0 e OIDC]] — autenticação complementar ao hardening HTTP
- [[03-Dominios/Tecnologia/Node/Segurança/04 - JWT e autenticação com jsonwebtoken|JWT e jsonwebtoken]] — autenticação complementar ao hardening HTTP
- [[03-Dominios/Tecnologia/Node/Segurança/07 - Rate limiting com express-rate-limit|Rate limiting]] — proteção contra abuso de API, par natural do Helmet
- [[03-Dominios/Tecnologia/Node/Segurança/09 - OWASP Top 10 para Node|OWASP Top 10 para Node]] — contexto de ameaças que estes headers mitigam
