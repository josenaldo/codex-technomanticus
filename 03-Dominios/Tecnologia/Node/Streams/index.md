...
Pré-requisito: galho 1 ([[03-Dominios/Tecnologia/Node/Runtime e Event Loop/index]]) — pressupõe entender event loop e bloqueio. Galho 2 ([[03-Dominios/Tecnologia/Node/Paralelismo/index]]) é referência cruzada onde workers + streams se cruzam (`postMessage` + `transferList` para zero-copy).
...
12. [[03-Dominios/Tecnologia/Node/Streams/12 - Armadilhas, regras práticas, cheatsheet]]
...
- [[03-Dominios/Tecnologia/Node/Runtime e Event Loop/index]] — galho 1 (pré-requisito)
- [[03-Dominios/Tecnologia/Node/Paralelismo/index]] — galho 2 (referência cruzada onde workers + streams)
