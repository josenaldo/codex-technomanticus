...
- **Glosa** — [IA do Zero ao Sênior — Trilha Completa (board Excalidraw)](https://app.excalidraw.com/l/8JV6z3OmEvu/8GgtBGSpQGS) — a aula 4.5 do board de Gabriel Dias é a origem do enquadramento em quatro passos e da tese de que abstenção precisa ser recompensada no eval; aqui expandida com a matriz de calibração e as famílias de anti-test.
