...
- **Score auto-reportado entre os mais altos do mercado em abril de 2026.** **96,6% R@5 raw** e **98,4% no modo hybrid v4** (com LLM [[Dicionário de IA#reranking|reranking]] — ≥99% reportado em alguns canais externos) no LongMemEval — com a ressalva crítica detalhada na seção *Crítica externa*.
