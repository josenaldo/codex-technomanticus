...
- **[[03-Dominios/Tecnologia/IA/Anatomia de Agents/10 - Workflow vs Agent — quando usar cada um|10 - Workflow vs Agent]]** — discussão profunda (a ser publicada).
- **[[03-Dominios/Tecnologia/IA/Anatomia de Agents/08 - Patterns comuns de agents|Patterns comuns de agents]]** — orchestrator-worker, planning, ReAct.
