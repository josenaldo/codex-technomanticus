...
**Fix**: crie `.claude/CLAUDE.md` com pelo menos: stack, comandos de teste, e a seção `## Restrições`. Ver [[03-Dominios/Tecnologia/IA/Claude Code/Configuração/02 - CLAUDE.md anatomia|02 - CLAUDE.md anatomia]].
