...
TABLE
  ...
  status AS "Status",
  join(tags, ", ") AS "Tags"
FROM "03-Dominios/Tecnologia/IA/Economia de Tokens"
WHERE type != "moc"
SORT file.name ASC
```
