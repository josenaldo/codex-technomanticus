...
- [[03-Dominios/Tecnologia/IA/index|index do domínio IA]]
- [[Anatomia dos LLMs]]
- [[Anatomia de Agents]]
- [[Agentes de Codificação]]
- [[03-Dominios/Tecnologia/IA/index|Formação Engenheiro de IA]]
...
TABLE
  title AS "Título",
  status AS "Status"
FROM "03-Dominios/Tecnologia/IA/Ferramentas de IA"
WHERE type != "moc"
SORT file.name ASC
```
