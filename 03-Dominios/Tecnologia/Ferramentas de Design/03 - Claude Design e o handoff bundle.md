...
- Skill local `handoff-design` (`~/.claude/skills/handoff-design/SKILL.md`, v3.1.0) — gera o prompt de handoff completo; linkada, não duplicada, por esta nota.
