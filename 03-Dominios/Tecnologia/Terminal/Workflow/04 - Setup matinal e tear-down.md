...
[[03-Dominios/Tecnologia/Terminal/CLI Utils/06 - atuin — history shell com SQLite e sync|atuin sync]] propaga history de comandos entre máquinas automaticamente. Sessões Zellij **não sincronizam** — cada máquina tem suas próprias sessões.
...
- [[03-Dominios/Tecnologia/Terminal/Multiplexer/04 - Sessões persistentes — detach, attach, gerenciamento|Sessões persistentes (galho 3)]]
