...
Roadmap do domínio `03-Dominios/Tecnologia/Web Performance` (raiz de domínio / galho-pai). Rastreia o **estado dos galhos**. Domínio **em construção**, ritmo B: fecha-se um galho ponta a ponta antes de abrir o próximo. Fonte do roster: `index.md` + [[00-Meta/specs/2026-07-05-dominio-web-performance-design|design 2026-07-05]].
