...
Por que começar pela interface? Porque ela é o ponto de menor compromisso. Ela te dá o desacoplamento do **DIP** (depender do contrato, não da classe concreta — [[03-Dominios/Engenharia/Design de Software/SOLID/index|SOLID]]) sem te amarrar numa hierarquia. Você sempre pode promover uma interface a abstrata depois; o caminho inverso dói muito mais.
