...
Isso conecta direto com a entropia do software: todo sistema tende a apodrecer conforme é tocado por mãos diferentes ao longo de anos. Testes são o que segura a maré — veja [[03-Dominios/Engenharia/Complexidade de Software/14 - Manutenção e evolução|Manutenção e evolução]] pra entender por que a manutenção, e não a escrita inicial, é onde mora o custo real do software.
