...
[^dbt-contracts]: dbt Labs, *Add model contracts*, documentação oficial, desde dbt 1.5 (2023). [^confluent]: Confluent, *Schema Evolution and Compatibility*, documentação de schema registry.
