...
> **CodeOpinion** · 10min · [Architecture Decision Records (ADR) as a LOG That Answers "WHY?"](https://www.youtube.com/watch?v=6H6zfCNeqek) O enquadramento é exatamente o desta nota: ADR não é documentação de arquitetura, é registro de *intenção* — o porquê que o código não consegue carregar. Curto e direto ao ponto que mais importa aqui.

- [From Technical Debt to Cognitive and Intent Debt — Margaret-Anne Storey (arXiv)](https://arxiv.org/abs/2603.22106) — a **fonte primária**: a definição de dívida de intenção ("absence or erosion of explicit rationale, goals, and constraints"). URL: https://arxiv.org/abs/2603.22106
- [The Intent Debt — Addy Osmani](https://addyosmani.com/blog/intent-debt/) — a exposição mais clara: só humanos geram intenção e a economia do cold start. URL: https://addyosmani.com/blog/intent-debt/
- [Fragments: April 2 — Martin Fowler](https://martinfowler.com/fragments/2026-04-02.html) — o substrato ("intent debt lives in artifacts") e o custo da verificação. URL: https://martinfowler.com/fragments/2026-04-02.html
- [Intent Debt: The AI-Era Debt Nobody Is Tracking — Developers Digest](https://www.developersdigest.tech/blog/intent-debt-the-ai-debt-nobody-is-tracking) — os testes de diagnóstico e as práticas de pagamento. URL: https://www.developersdigest.tech/blog/intent-debt-the-ai-debt-nobody-is-tracking
