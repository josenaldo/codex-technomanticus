...
> vale a pena mesmo sendo recomendado), 03 por ter uma atribuição de fonte a verificar/
> corrigir (estatística ~35% creditada ao artigo errado do NN/g). Notas 02, 04 e 05 têm
> núcleo completo e nenhum gap que justifique execução obrigatória — ficam `➖`.
...
- **Núcleo/gaps:** L1 (todos os wikilinks — notas 01, 03, 04 — apontam para dentro da própria pasta "Fundamentos e Modelo Mental"; nenhum link externo à pasta); M1 (ausente — sem callout `[!tip]` com vídeo/podcast; recomendado, não obrigatório na fase Iniciado); P1 N/A (nota conceitual, sem seção de código)
- **Score:** 10/12
- **Plano de execução:**
  - — nenhuma
- **Resultado:** —
...
- **Núcleo/gaps:** M1 (ausente — sem callout `[!tip]` com vídeo/podcast; recomendado, não obrigatório na fase Iniciado); P1 N/A (nota conceitual, sem seção de código)
- **Score:** 11/12
- **Plano de execução:**
  - — nenhuma
- **Resultado:** —
