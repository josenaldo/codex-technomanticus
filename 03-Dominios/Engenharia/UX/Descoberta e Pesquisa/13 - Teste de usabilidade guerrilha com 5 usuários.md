...
> **O que acontece:** o teste é conduzido depois que o design já está "decidido" e vai ao ar de qualquer forma — o objetivo real é confirmar a decisão, não descobrir problema. **Por quê:** perguntas guiadas ("está tudo claro, né?") e a tentação de ajudar o usuário que trava transformam o teste de coleta de dado em ritual de validação — a mesma pesquisa teatral já nomeada na [[03-Dominios/Engenharia/UX/Descoberta e Pesquisa/06 - Generativa vs avaliativa|nota 06]]. **Como evitar:** entre no teste genuinamente disposto a mudar o design se o usuário travar — se a resposta já está decidida de antemão, o teste é decorativo, não avaliativo de verdade.
