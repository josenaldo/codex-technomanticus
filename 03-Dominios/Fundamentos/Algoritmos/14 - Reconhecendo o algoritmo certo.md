...
| "**k-ésimo** maior/menor"; "top-k"; "k mais frequentes" | **Heap** (de tamanho k) ou **quickselect** | Heap-k é O(n log k); quickselect é O(n) médio sem ordenar tudo | [[08 - Busca]] (quickselect) + heap em [[03-Dominios/Fundamentos/Estruturas de Dados/index\|Estruturas de Dados]] |
...
| Hash map | O(n) tempo / O(n) espaço | lookup O(1); par com soma; contar/dedup | [[03-Dominios/Fundamentos/Estruturas de Dados/index\|Estruturas de Dados]] |
| Heap / priority queue | O(n log k) | top-k, k-ésimo maior, merge de k listas, scheduling | [[03-Dominios/Fundamentos/Estruturas de Dados/index\|Estruturas de Dados]] |
...
- Galho irmão: [[03-Dominios/Fundamentos/Estruturas de Dados/index|Estruturas de Dados]] — as estruturas sobre as quais os algoritmos operam; o capstone de lá é [[13 - Escolhendo a estrutura certa]], gêmeo desta nota para o lado das estruturas.
