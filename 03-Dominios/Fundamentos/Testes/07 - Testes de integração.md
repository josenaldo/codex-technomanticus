...
> - **Locking e isolamento** — níveis de isolamento de transação, comportamento de deadlock, `SELECT ... FOR UPDATE`. (Veja [[03-Dominios/Fundamentos/Banco de Dados/index|Banco de Dados]] pra entender por que isso é tão sensível.)
