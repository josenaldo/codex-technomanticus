...
E por que **percentis**, nunca média? Porque média esconde a cauda. Como vimos em [[03-Dominios/Fundamentos/Redes e Protocolos/12 - Latência, throughput e os números|os números de latência]], um serviço com média de 100ms pode ter 5% das requisições em 2 segundos — e esses 5% são justamente os usuários que abrem ticket. O p99 mostra o pior caso plausível; a média mostra um caso que talvez não exista. Por isso o `threshold` do k6 lá em cima é `p(95)<400`, não `avg<400`: o teste de carga **codifica o SLO como uma asserção** e o pipeline falha se a cauda estourar o orçamento.
...
- [[03-Dominios/Fundamentos/Redes e Protocolos/14 - Resiliência de rede|Resiliência de rede]] — os padrões que o chaos engineering valida na prática
- [[03-Dominios/Fundamentos/Redes e Protocolos/12 - Latência, throughput e os números|Latência, throughput e os números]] — os percentis que o load test mede
- [[Testes em Java]] — JMH e microbenchmark no ecossistema Java
- [[03-Dominios/Fundamentos/Testes/index|Testes]]
