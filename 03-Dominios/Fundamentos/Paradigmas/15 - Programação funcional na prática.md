...
O loop guarda *estado* (`total`, `i`); o pipeline guarda *intenção*. Veja o galho de `[[03-Dominios/Java/Collections e Streams/index|Streams (Java)]]` pra fundo dessa máquina.
