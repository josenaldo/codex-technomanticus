...
O motor explora as cláusulas em ordem. Quando uma escolha leva a um beco sem saída, ele **recua** (backtrack) até o último ponto onde havia alternativas — o *choice-point* — e tenta o próximo caminho. É uma busca em profundidade numa árvore de possibilidades. Essa é a mesma técnica de [[03-Dominios/Fundamentos/Algoritmos/index|Algoritmos]] que você escreveria à mão para resolver um labirinto ou as N-rainhas — só que aqui o motor a executa por você, sobre toda a base de conhecimento.
...
- [[03-Dominios/Fundamentos/Algoritmos/index|Algoritmos]] — backtracking como técnica de busca que aqui é automatizada
