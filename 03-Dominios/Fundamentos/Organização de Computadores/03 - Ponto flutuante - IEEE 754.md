...
> Por que a inexatidão é inevitável? Porque os floats são **contáveis** — há exatamente 2³² floats de 32 bits — enquanto os reais entre 0 e 1 são **incontáveis** (veja [[03-Dominios/Fundamentos/Matemática para Computação/13 - Cardinalidade - contável e incontável]]). Quase todo número real não tem representação exata. O IEEE 754 apenas escolhe **qual vizinho** usar.
...
A conexão profunda: os reais são **incontáveis** (veja [[03-Dominios/Fundamentos/Matemática para Computação/13 - Cardinalidade - contável e incontável]]), os floats são **contáveis**. A esmagadora maioria dos reais não tem representação exata — o IEEE 754 apenas escolhe o vizinho mais próximo.
