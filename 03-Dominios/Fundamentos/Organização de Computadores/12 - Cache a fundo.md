...
> [!tip] Conexão com SO
> Eviction de linha de cache é exatamente o mesmo problema de [[03-Dominios/Fundamentos/Sistemas Operacionais/08 - Substituição de páginas e thrashing|substituição de páginas]]. LRU aparece nos dois contextos pelo mesmo motivo: localidade temporal sugere que o que foi usado recentemente será usado de novo.
...
Esse é o argumento cache-consciente central para preferir vetores a listas encadeadas em [[03-Dominios/Fundamentos/Estruturas de Dados/index|Estruturas de Dados]].
