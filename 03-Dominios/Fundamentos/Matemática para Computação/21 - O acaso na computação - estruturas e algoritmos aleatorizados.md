...
Para mais contexto de implementação, veja [[03-Dominios/Fundamentos/Estruturas de Dados/12 - Estruturas especializadas]].
...
O **sorted set do Redis** usa skip list como estrutura primária. A escolha foi documentada por Salvatore Sanfilippo: skip lists são mais fáceis de implementar corretamente em C, têm comportamento de cache comparável e o overhead de memória é aceitável. Para implementação de estruturas similares, veja [[03-Dominios/Fundamentos/Estruturas de Dados/12 - Estruturas especializadas]].
