...
| Compilador, regex, parsing | linguagens formais, autômatos | (toca a [[03-Dominios/Fundamentos/Teoria da Computação/index\|Teoria da Computação]]) |
...
> **A Matemática é dona da FERRAMENTA. A [[03-Dominios/Fundamentos/Teoria da Computação/index|Teoria da Computação]] é dona da TEORIA sobre os limites do computável.**
>
...
> - Fronteira ferramenta/teoria cruzada com a nota [[03-Dominios/Fundamentos/Teoria da Computação/index|Teoria da Computação]] deste mesmo domínio [[03-Dominios/Fundamentos/index|Fundamentos]].
