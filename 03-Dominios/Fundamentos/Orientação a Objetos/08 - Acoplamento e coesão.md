...
> [!summary] Resumo
> Bom design é **baixo acoplamento** (módulos pouco dependentes entre si) com **alta coesão** (responsabilidades muito relacionadas dentro de cada módulo) — e [[03-Dominios/Fundamentos/SOLID/index|SOLID]] é só a engenharia de chegar lá.
...
Essas duas palavras são o vocabulário com que você vai julgar quase todo código pelo resto da carreira. Quase todo princípio de design — incluindo o galho inteiro de [[03-Dominios/Fundamentos/SOLID/index|SOLID]] — é uma técnica para empurrar um sistema na direção desses dois alvos.
...
Se acoplamento e coesão são as **metas**, [[03-Dominios/Fundamentos/SOLID/index|SOLID]] é o **manual de como atingi-las**. Dois exemplos diretos:
...
Os outros três (OCP, LSP, ISP) também são, no fundo, manobras de acoplamento e coesão. O galho [[03-Dominios/Fundamentos/SOLID/index|SOLID]] inteiro é a engenharia de chegar a **baixo acoplamento + alta coesão** sem ter que adivinhar.
...
- [[03-Dominios/Fundamentos/SOLID/index|SOLID]] — a engenharia de atingir baixo acoplamento + alta coesão
