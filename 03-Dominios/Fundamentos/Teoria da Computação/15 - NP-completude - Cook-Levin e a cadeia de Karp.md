...
> Esta nota é a dona do **formal**: definição, redução, teorema, prova. O **prático** — "ok, é NP-difícil, e agora? aproximação, heurística, solver SAT/MILP, parar de buscar o ótimo" — está a fundo em [[03-Dominios/Fundamentos/Algoritmos/13 - Intratabilidade]]. Aqui o único resgate prático é **reconhecer** que o problema é NP-completo. O que fazer em seguida, é lá.
