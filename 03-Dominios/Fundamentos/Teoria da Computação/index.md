...
- **A face prática de P/NP** (NP-difícil como sinal, aproximação, heurística) → [[03-Dominios/Fundamentos/Algoritmos/13 - Intratabilidade|Intratabilidade]]. Aqui mora o **formal** (Cook-Levin, redução polinomial, P vs NP).
...
14 → 15 → 16 + [[03-Dominios/Fundamentos/Algoritmos/13 - Intratabilidade|a face prática em Algoritmos]].
...
FROM "03-Dominios/Fundamentos/Teoria da Computação"
WHERE type = "concept"
SORT file.name ASC
```
...
- [[03-Dominios/Fundamentos/Algoritmos/13 - Intratabilidade|Intratabilidade]] — a face prática de P/NP (NP-difícil, aproximação, heurística)
