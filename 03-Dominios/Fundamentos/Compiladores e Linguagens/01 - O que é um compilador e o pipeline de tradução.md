...
- A teoria que o front-end aplica: [[03-Dominios/Fundamentos/Teoria da Computação/index|Teoria da Computação]] — autômatos finitos para o lexer, gramáticas livres de contexto para o parser
- O alvo que o back-end precisa conhecer: [[03-Dominios/Fundamentos/Organização de Computadores/index|Organização de Computadores]] — ISA, registradores, pipeline, hierarquia de cache
