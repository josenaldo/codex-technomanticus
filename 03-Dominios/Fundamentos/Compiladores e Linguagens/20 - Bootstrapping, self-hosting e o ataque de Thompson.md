...
O ângulo de segurança completo — supply chain, confiança transitiva, e o que isso significa para a segurança moderna — está em [[03-Dominios/Fundamentos/Segurança Conceitual/17 - Confiança transitiva e Trusting Trust]]. Aqui focamos no mecanismo do compilador: por que o self-hosting torna esse ataque possível e por que a verificação de fonte não é suficiente.
...
- Confiança e supply chain: [[03-Dominios/Fundamentos/Segurança Conceitual/17 - Confiança transitiva e Trusting Trust]] — o ataque de Thompson pelo ângulo de segurança, defesa em profundidade e supply chain moderna.
