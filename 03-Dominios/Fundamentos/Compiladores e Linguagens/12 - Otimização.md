...
A consequência direta: para decidir se duas versões de um programa são equivalentes no caso geral, o compilador precisaria resolver o problema da parada ([[03-Dominios/Fundamentos/Teoria da Computação/11 - O problema da parada]]) — e esse problema é indecidível.
...
- [[03-Dominios/Fundamentos/Teoria da Computação/11 - O problema da parada]] — limite teórico do otimizador: Rice e halting explicam por que heurísticas conservadoras são inevitáveis
