...
Vejamos os dois tilings em assembly (alvo x86-64, apenas para ilustrar a diferença de cobertura — para ISA detalhada veja [[03-Dominios/Fundamentos/Organização de Computadores/08 - ISA - a interface hardware-software]]):
...
- [[03-Dominios/Fundamentos/Organização de Computadores/08 - ISA - a interface hardware-software]] — a ISA como alvo (registradores, modos de endereçamento, encodings).
- [[03-Dominios/Fundamentos/Organização de Computadores/09 - Assembly e o modelo de execução]] — o modelo de execução que o scheduling tenta explorar.
