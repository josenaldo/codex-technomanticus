...
- **Comunicação assíncrona** → [[Mensageria]] / [[03-Dominios/Java/Backend/Kafka/Kafka|Kafka]]. A nota de
...
- **Java/produção** (OkHttp, Resilience4j, HikariCP) → [[Spring Boot]]. **Operar o stack** (Nginx, Linux,
  K8s) → [[03-Dominios/Infraestrutura/Linux|Linux]] / [[Nginx]].
...
FROM "03-Dominios/Fundamentos/Redes e Protocolos"
WHERE type = "concept"
SORT file.name ASC
```
