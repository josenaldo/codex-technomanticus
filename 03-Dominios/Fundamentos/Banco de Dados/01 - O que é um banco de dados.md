...
Leitura do diagrama: esta âncora abre a trilha. As fases Iniciado → Adepto → Magus sobem do "o que é" até operar dados distribuídos em produção, fechando no capstone de entrevista ([[16 - Banco de dados em entrevista]]). O mapa completo está no [[03-Dominios/Fundamentos/Banco de Dados/index|índice do galho]].
...
- [[03-Dominios/Fundamentos/Banco de Dados/index|Banco de Dados]] — o índice do galho
