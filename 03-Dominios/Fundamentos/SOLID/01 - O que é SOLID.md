...
Por isso o galho inteiro de SOLID é, no fundo, a engenharia de atingir uma meta que vive lá fora: em [[08 - Acoplamento e coesão]], no galho de [[03-Dominios/Fundamentos/Orientação a Objetos/index|Orientação a Objetos]]. Se você ainda não tem essa nota firme na cabeça, ela é o pré-requisito conceitual de tudo o que vem aqui. Leia-a primeiro, se puder.
...
- [[03-Dominios/Fundamentos/Orientação a Objetos/index|Orientação a Objetos]] — o galho de onde SOLID nasce
