...
- **Concorrência Java específica** (java.util.concurrent, `synchronized`, locks, Loom/virtual threads,
  structured concurrency) → [[03-Dominios/Java/Concorrência e paralelismo/index|Concorrência (Java)]] e [[Java Concurrency]].
...
FROM "03-Dominios/Fundamentos/Concorrência e Paralelismo"
WHERE type = "concept"
SORT file.name ASC
```
...
- [[03-Dominios/Java/Concorrência e paralelismo/index|Concorrência (Java)]] — a mecânica concreta em Java
