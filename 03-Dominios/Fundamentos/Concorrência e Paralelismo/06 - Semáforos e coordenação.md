...
Tudo acima é teoria de SO portável. No mundo Java, cada conceito tem um nome concreto na biblioteca `java.util.concurrent` — detalhado em `[[03-Dominios/Java/Concorrência e paralelismo/index|Concorrência (Java)]]`:
...
- [[03-Dominios/Java/Concorrência e paralelismo/index|Concorrência (Java)]] — `Semaphore`, `CountDownLatch`, `CyclicBarrier`, `Phaser`, `Exchanger`.
