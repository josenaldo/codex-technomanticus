...
Por que isso importa? Por décadas, o modelo mais simples de programar — **uma thread por requisição** — esbarrava no custo das threads de kernel: alguns milhares e o servidor afogava em troca de contexto. As virtual threads destravam esse modelo: você escreve código bloqueante, sequencial, legível, e o runtime cuida de multiplexar milhões de threads virtuais sobre um punhado de threads de kernel. Os detalhes no galho [[03-Dominios/Java/Concorrência e paralelismo/index|Concorrência (Java)]].
