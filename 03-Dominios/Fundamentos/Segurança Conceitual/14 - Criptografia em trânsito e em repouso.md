...
> O protocolo TLS byte a byte — extensões específicas, record layer, formato das mensagens, cipher suites como identificadores numéricos — fica em [[03-Dominios/Fundamentos/Redes e Protocolos/05 - TLS e HTTPS]]. Aqui o foco é o **conceito**: por que cada passo existe, qual primitiva usa, e o que garante.
...
- Protocolo TLS em detalhe: [[03-Dominios/Fundamentos/Redes e Protocolos/05 - TLS e HTTPS]]
