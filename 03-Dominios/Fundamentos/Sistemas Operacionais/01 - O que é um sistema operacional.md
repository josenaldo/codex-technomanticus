...
A linha entre kernel monolítico e microkernel também ecoa em containers e virtualização, onde o isolamento volta com outra roupagem — `[[13 - Virtualização e containers]]`. E o tema da concorrência entre processos, que o kernel orquestra, conecta com `[[Concorrência e Paralelismo]]`. Na prática diária, o SO que você mais toca é o `[[03-Dominios/Infraestrutura/Linux|Linux]]`, monolítico modular por excelência.
