...
- **Usar o SO** (Linux na prática, Docker, K8s, WSL) → [[03-Dominios/Infraestrutura/Linux|Linux]] / [[Infraestrutura]]. Aqui é a teoria.
...
- **Memória e GC do runtime gerenciado** → [[03-Dominios/Java/JVM/index|JVM por dentro]].
...
FROM "03-Dominios/Fundamentos/Sistemas Operacionais"
WHERE type = "concept"
SORT file.name ASC
```
...
- [[03-Dominios/Infraestrutura/Linux|Linux]] — usar o SO na prática
