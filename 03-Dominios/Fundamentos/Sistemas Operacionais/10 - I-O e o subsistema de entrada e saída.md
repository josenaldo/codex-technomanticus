...
Disco e rede são **10³ a 10⁶ vezes mais lentos** que CPU e RAM (veja [[03-Dominios/Fundamentos/Redes e Protocolos/12 - Latência, throughput e os números|os números de latência]] para a tabela completa). Esse abismo é o motivo de tudo que vimos existir.
