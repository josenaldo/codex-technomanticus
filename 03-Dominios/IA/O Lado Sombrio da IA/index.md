...
- [[03-Dominios/IA/index|IA — Formação Engenheiro de IA]] — o domínio que este galho complementa criticamente
...
- [[03-Dominios/IA/Segurança e Guardrails/index|Segurança e Guardrails]] — o eixo de risco técnico (complementar)
...
```dataview
LIST
FROM "03-Dominios/IA/O Lado Sombrio da IA"
WHERE type != "moc"
SORT file.name ASC
```
