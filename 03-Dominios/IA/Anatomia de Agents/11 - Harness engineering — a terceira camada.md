...
- **Skills** — o conhecimento *procedural*: procedimentos operacionais, heurísticas de decisão e restrições normativas que especializam o modelo geral por tarefa. (No vault: [[03-Dominios/IA/Context Engineering/11 - Skills e instructions como contexto|Skills como contexto]] e [[03-Dominios/IA/Claude Code/Skills e MCP/index|Skills e MCP]].)
...
Cada dimensão tem um galho do vault que a aprofunda: o **loop** em [[02 - O loop ReAct e native tool use]] e [[03-Dominios/IA/Claude Code/Mental Model/01 - O loop agentic|O loop agentic]]; **sandboxing/permissions** em [[Segurança e Guardrails]] e [[03-Dominios/IA/Claude Code/Hooks e Guardrails/index|Hooks e Guardrails]]; **observabilidade** em [[Observability]]; **context budget** em [[Context Engineering]] e [[Economia de Tokens]]. O harness, nesse sentido, não é um galho novo — é o **nome da costura** entre os galhos que você já tem.
...
| Procedimento (Skills) + protocolos | [[03-Dominios/IA/Claude Code/Skills e MCP/index\|Skills e MCP]] · [[MCP]] |
| Loop / control flow | [[02 - O loop ReAct e native tool use]] · [[03-Dominios/IA/Claude Code/Mental Model/01 - O loop agentic\|O loop agentic]] |
| Sandboxing / approval / policy | [[Segurança e Guardrails]] · [[03-Dominios/IA/Claude Code/Hooks e Guardrails/index\|Hooks e Guardrails]] |
...
| Instanciação concreta (Claude Code) | [[03-Dominios/IA/Claude Code/Mental Model/09 - O harness como terceira camada\|O harness como terceira camada]] |
...
- [[03-Dominios/IA/Claude Code/Mental Model/09 - O harness como terceira camada|O harness como terceira camada (Claude Code)]] — a instanciação concreta deste conceito num harness real
