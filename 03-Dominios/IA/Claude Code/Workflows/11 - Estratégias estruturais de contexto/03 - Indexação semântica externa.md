...
- [[03-Dominios/IA/Claude Code/Skills e MCP/04 - MCP overview|MCP overview]] — protocolo de extensão usado por todo MCP de indexação
- [[03-Dominios/IA/Claude Code/Skills e MCP/05 - MCP servers essenciais|MCP servers essenciais]] — outras MCPs úteis
- [[03-Dominios/IA/Context Engineering/06 - Dynamic retrieval beyond RAG|Dynamic retrieval beyond RAG]] — contexto teórico de RAG e suas evoluções
