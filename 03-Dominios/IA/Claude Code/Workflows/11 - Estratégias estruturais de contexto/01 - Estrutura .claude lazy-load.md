...
- [[03-Dominios/IA/Claude Code/Configuração/02 - CLAUDE.md anatomia|CLAUDE.md anatomia]] — estrutura do arquivo principal
- [[03-Dominios/IA/Claude Code/Configuração/03 - CLAUDE.md receitas|CLAUDE.md receitas]] — templates por stack
- [[03-Dominios/IA/Claude Code/Configuração/07 - Pasta .claude|Pasta .claude]] — convenções de organização
- [[03-Dominios/IA/Claude Code/Mental Model/07 - Tokens e custo|Tokens e custo]] — fundamentos econômicos
