---
title: "Biblioteca de Desenvolvimento com IA"
created: 2026-05-11
updated: 2026-05-11
type: reference
status: seedling
...
# Biblioteca de Desenvolvimento com IA

> Aqui não existe Real Python e provavelmente não vai existir tão cedo — o campo se move rápido demais para um portal curado vencer a velocidade dos blogs individuais. A referência se monta com leitura quase diária de algumas vozes-chave.
...
- **[awesome-agentic-engineering-resources](https://github.com/EthicalML/awesome-agentic-engineering-resources)** — repositório curado
- **[Matt Pocock no GitHub](https://github.com/mattpocock)** — perfil — Migrou conteúdo para agentic coding ("Skills for Real Engineers", "AI coding jargon explained in plain English"). Cruza com workflows de Claude Code skills.

> [!info] Lacuna em português
> Não há portal brasileiro com a profundidade dos acima nesse tema específico. Conteúdo bom existe pulverizado em LinkedIn, Medium e blogs pessoais, mas nada comparável a Real Python em maturidade. Existe uma vaga.
