...
> O *conteúdo* de cada gate (quais regras, que cobertura, como assinar, o que é um SBOM) é assunto de [[03-Dominios/Java/Build e tooling/16 - Quality gates no build|Quality gates no build]] e [[03-Dominios/Java/Build e tooling/18 - Supply chain e SBOM|Supply chain e SBOM]]. Aqui a gente olha o *fluxo* — onde cada peça encaixa na esteira até produção.
...
- **imagem** — com o jar aprovado, o CI gera uma imagem OCI. Esse passo **reusa Buildpacks ou Jib** — não há Dockerfile novo a manter. Veja [[03-Dominios/Java/Cloud-native e produção/06 - Buildpacks — imagem sem Dockerfile|Buildpacks]] e [[03-Dominios/Java/Cloud-native e produção/07 - Jib — imagem daemonless|Jib]]. A imagem é empurrada para um registry.
...
> *Como* gerar o SBOM, *como* assinar, qual ferramenta — tudo isso é [[03-Dominios/Java/Build e tooling/18 - Supply chain e SBOM|Supply chain e SBOM (Galho 15)]]. O ponto desta nota é *onde* na esteira essas peças entram: o SBOM e a assinatura nascem no estágio de **imagem** e são *verificados* no estágio de **deploy**. A supply chain não é um adendo opcional no fim — é a alça que conecta o que foi testado ao que entra no cluster.
...
Independente de push ou GitOps, *como* a nova versão substitui a antiga é a **estratégia de deploy** — e isso já foi visto em [[03-Dominios/Java/Cloud-native e produção/12 - Graceful shutdown e deploy sem downtime|Graceful shutdown e deploy sem downtime]]:
...
- [[03-Dominios/Java/Build e tooling/18 - Supply chain e SBOM|Supply chain e SBOM (Galho 15)]]
...
- Quality gates e SBOM/assinatura: ver Galho 15 — [[03-Dominios/Java/Build e tooling/16 - Quality gates no build|Quality gates no build]] e [[03-Dominios/Java/Build e tooling/18 - Supply chain e SBOM|Supply chain e SBOM]].
