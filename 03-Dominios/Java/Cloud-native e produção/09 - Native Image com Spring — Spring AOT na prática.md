...
O **Spring AOT** (*Ahead-of-Time processing*) é um motor que roda durante o build e converte a configuração dinâmica do Spring em código e metadados estáticos que o GraalVM consegue analisar. É o que torna uma aplicação Spring Boot compilável para [[03-Dominios/Java/Cloud-native e produção/08 - GraalVM Native Image — conceito e trade-offs|native image]] sem que você precise escrever metadados de reflection na unha pra cada bean.
