...
> O **SBOM** (Software Bill of Materials) — o inventário formal e assinado de tudo que entra na imagem, base da rastreabilidade de supply chain — é assunto do [[03-Dominios/Java/Build e tooling/18 - Supply chain e SBOM|Galho 15]]. Aqui, no Galho 17, o foco é a **imagem de produção** em si: base enxuta, non-root e o scanning que roda sobre ela. Scanner e SBOM se complementam — um lista as vulnerabilidades, o outro lista os componentes —, mas vivem em galhos diferentes.
