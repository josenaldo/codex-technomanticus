...
Mensageria reativa/Reactor Kafka é o galho [[03-Dominios/Java/Mensageria/25 - Mensageria reativa — Reactor Kafka|Mensageria]]; resiliência/backpressure distribuído é o galho [[03-Dominios/Java/Microservices e sistemas distribuídos/21 - Os padrões de falha distribuída|Microservices e sistemas distribuídos]] e segurança reativa/WebFlux Security é fronteira do galho [[03-Dominios/Java/Segurança/index|Segurança]]; testes reativos com `StepVerifier` são o galho [[03-Dominios/Java/Testes/15 - Testando código reativo — StepVerifier e @WebFluxTest|Testes]].
