...
- **Threads (Galho 4)** — O "modelo de threads" que sustenta o não-bloqueante (event loop, e a alternativa moderna dos Virtual Threads / Loom) é assunto do Galho 4. Aqui só usamos o conceito; o aprofundamento está lá. Veja [[03-Dominios/Java/Concorrência e paralelismo/12 - Virtual Threads e Project Loom|Virtual Threads e Project Loom]].
- **Web (Galho 9)** — O stack web *imperativo* (Spring MVC, um thread por request) é o contraponto do reativo na camada web. Está no Galho 9: [[03-Dominios/Java/Web e APIs REST/01 - O que é Spring MVC — a camada web sobre o container|O que é Spring MVC]].
...
- [[03-Dominios/Java/Concorrência e paralelismo/12 - Virtual Threads e Project Loom|Virtual Threads e Project Loom]] — o modelo de threads (Galho 4)
- [[03-Dominios/Java/Web e APIs REST/01 - O que é Spring MVC — a camada web sobre o container|O que é Spring MVC]] — o stack imperativo (Galho 9)
