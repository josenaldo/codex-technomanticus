...
Backpressure é o protocolo de controle de fluxo embutido no [[03-Dominios/Java/Programação Reativa/02 - Reactive Streams — a spec das 4 interfaces e o Flow do Java 9|Reactive Streams]]. A spec o descreve como "asynchronous stream processing with non-blocking back pressure": o objetivo é "govern the exchange of stream data across an asynchronous boundary" de modo que "the receiving side is not forced to buffer arbitrary amounts of data".
...
- [[03-Dominios/Java/Programação Reativa/02 - Reactive Streams — a spec das 4 interfaces e o Flow do Java 9|Reactive Streams]]
