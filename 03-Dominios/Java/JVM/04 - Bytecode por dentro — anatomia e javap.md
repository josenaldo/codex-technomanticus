...
Nenhum campo `name` ou lógica extra — o compilador gerou tudo a partir da declaração do record. A semântica completa de records está em [[03-Dominios/Java/Linguagem e sintaxe moderna/13 - Records e record patterns|Records]].
...
- [[03-Dominios/Java/Linguagem e sintaxe moderna/13 - Records e record patterns|Records]]
