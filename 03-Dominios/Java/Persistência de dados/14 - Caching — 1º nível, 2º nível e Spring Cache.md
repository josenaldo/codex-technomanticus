...
O cache de primeiro nível **é** o persistence context (detalhado na [[03-Dominios/Java/Persistência de dados/03 - O persistence context e os estados da entidade|nota 03]]). Recapitulando o essencial:
...
- [[03-Dominios/Arquitetura/System Design|System Design]]
- [[03-Dominios/Java/Persistência de dados/index|Persistência de dados (MOC do galho)]]
- [[03-Dominios/Java/index|Trilha Java]]
- [[03-Dominios/Java/Dicionário de Java#second-level cache (2º nível)|second-level cache (2º nível)]]
- [[03-Dominios/Java/Dicionário de Java#@Cacheable / Spring Cache|@Cacheable / Spring Cache]]
