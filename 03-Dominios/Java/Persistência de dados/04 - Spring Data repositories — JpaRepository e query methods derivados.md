...
Derived queries são ótimas para condições simples. Quando o nome do método começa a parecer uma frase em inglês de três linhas, é hora de usar `@Query` com JPQL ou SQL nativo. Ver [[03-Dominios/Java/Persistência de dados/09 - Consultas com @Query — JPQL, native e @Modifying|Consultas com @Query]].
...
- [[03-Dominios/Java/Dicionário de Java#JpaRepository|JpaRepository]]
