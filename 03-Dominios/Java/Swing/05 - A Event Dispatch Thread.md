...
| **Worker / background threads** | Executam trabalho demorado fora da EDT (normalmente via [[03-Dominios/Java/Swing/06 - SwingWorker e tarefas em background|SwingWorker]]). |
...
A solução combina as duas: o trabalho pesado vai para uma **thread de background**; quando ele termina e precisa atualizar a tela, **reentra na EDT** via `invokeLater`. Os primitivos de background — criar a thread, usar um `ExecutorService` — pertencem ao galho [[03-Dominios/Java/Concorrência e paralelismo/index|Concorrência e paralelismo]] (veja [[03-Dominios/Java/Concorrência e paralelismo/02 - Threads e seu ciclo de vida|Threads e seu ciclo de vida]]). A EDT é só o ponto de **entrega** do resultado.
...
**Fix (1 linha):** mova o trabalho para background — idealmente um [[03-Dominios/Java/Swing/06 - SwingWorker e tarefas em background|SwingWorker]] (`doInBackground` faz o I/O, `done` atualiza o `JLabel` na EDT).
...
- [[03-Dominios/Java/Swing/04 - O modelo de eventos|O modelo de eventos]]
- [[03-Dominios/Java/Swing/06 - SwingWorker e tarefas em background|SwingWorker e tarefas em background]]
...
- [[03-Dominios/Java/Concorrência e paralelismo/02 - Threads e seu ciclo de vida|Threads e seu ciclo de vida]]
- [[03-Dominios/Java/Dicionário de Java#EDT (Event Dispatch Thread)|EDT]]
- [[03-Dominios/Java/Dicionário de Java#invokeLater / invokeAndWait|invokeLater / invokeAndWait]]
