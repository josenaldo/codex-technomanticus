...
**Fix:** implementar um `AbstractTableModel` que carrega dados por página (ou com limite), delegando o carregamento pesado a um `SwingWorker` e exibindo um indicador de progresso enquanto os dados chegam. Ver [[03-Dominios/Java/Swing/07 - MVC em Swing e os models|MVC em Swing e os models]].
...
- [[03-Dominios/Java/Dicionário de Java#Action API|Action API]]
- [[03-Dominios/Java/Dicionário de Java#InputMap / ActionMap (key bindings)|InputMap / ActionMap]]
