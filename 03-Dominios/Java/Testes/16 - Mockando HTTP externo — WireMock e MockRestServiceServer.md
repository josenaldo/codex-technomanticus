...
Os exemplos usam domínios neutros — um `ExternalOrderClient` que busca pedidos numa API externa. Não re-explicamos o `RestClient` em si; isso é assunto do [[03-Dominios/Java/Web e APIs REST/15 - Clientes HTTP — RestClient, WebClient, RestTemplate|Galho 9]].
...
- [[03-Dominios/Java/Web e APIs REST/15 - Clientes HTTP — RestClient, WebClient, RestTemplate|Clientes HTTP — RestClient, WebClient, RestTemplate]]
- [[03-Dominios/Java/Testes/index|Testes (MOC do galho)]]
- [[03-Dominios/Java/index|Trilha Java]]
- [[03-Dominios/Java/Dicionário de Java]] (verbetes WireMock / MockRestServiceServer)
