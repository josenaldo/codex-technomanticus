...
O `@Warmup` garante que o JIT (Galho 3: [[03-Dominios/Java/JVM/07 - JIT — C1, C2 e tiered compilation|JIT — C1, C2 e tiered compilation]]) já tenha compilado os dois métodos antes da medição; o `@Fork(2)` roda tudo em duas JVMs separadas para checar a estabilidade do número; o `@Param` mostra como a vantagem do `StringBuilder` cresce com o tamanho da entrada. Sem essas anotações, o mesmo código num `@Test` daria um resultado quase aleatório — é o JIT que torna o microbenchmark traiçoeiro.
...
- [[03-Dominios/Java/JVM/07 - JIT — C1, C2 e tiered compilation|JIT — C1, C2 e tiered compilation]]
- [[03-Dominios/Java/Testes/index|Testes (MOC do galho)]]
- [[03-Dominios/Java/index|Trilha Java]]
- [[03-Dominios/Java/Dicionário de Java]] (verbete JMH (microbenchmark))
