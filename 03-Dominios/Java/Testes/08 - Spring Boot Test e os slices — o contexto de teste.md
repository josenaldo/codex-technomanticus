...
O contexto que esses testes montam **é exatamente** o `ApplicationContext` do [[03-Dominios/Java/Spring Core e Boot/06 - ApplicationContext — o container e seu ciclo|Galho 8]] — mesmo container, mesmo ciclo de vida, mesma resolução de beans. Não há um "contexto de teste" mágico à parte.
...
> Cada slice é, no fundo, uma seleção de auto-configs ligadas/desligadas — o mesmo mecanismo de [[03-Dominios/Java/Spring Core e Boot/15 - Auto-configuration e starters|auto-configuration e starters]] do Galho 8, só que recortado para uma camada. Não há motor novo aqui; há um recorte do motor que você já conhece.
...
- [[03-Dominios/Java/Spring Core e Boot/06 - ApplicationContext — o container e seu ciclo|ApplicationContext — o container e seu ciclo]]
