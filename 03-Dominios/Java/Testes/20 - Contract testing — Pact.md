...
- [[03-Dominios/Java/Testes/19 - Fitness functions — ArchUnit (testes de arquitetura)|Fitness functions — ArchUnit]]
- [[03-Dominios/Java/Testes/16 - Mockando HTTP externo — WireMock e MockRestServiceServer|Mockando HTTP externo]]
