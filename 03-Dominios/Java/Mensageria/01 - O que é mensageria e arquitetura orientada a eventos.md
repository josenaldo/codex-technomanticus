...
- [[03-Dominios/Java/Backend/Kafka/index|Kafka (a infra)]] — os fundamentos de infra (partições, offsets, replicação) que este galho assume e não re-explica
- [[03-Dominios/Java/Spring Core e Boot/11 - Eventos do ApplicationContext|Eventos do ApplicationContext]] — o event bus in-process do Spring (Galho 8)
