...
Saga é o padrão irmão do [[03-Dominios/Java/Mensageria/21 - O padrão Outbox|O padrão Outbox]]: cada passo da saga precisa atualizar o banco **e** publicar um evento de forma confiável, e é exatamente esse problema de atomicidade local que o Outbox resolve.
