...
> Aqui tratamos das *semânticas*, não dos mecanismos do broker. Para offset, commit e como o consumidor confirma posição, veja a nota dedicada do galho (linkada em **Veja também**); para o lado transacional, veja [[03-Dominios/Java/Mensageria/13 - Transações e exactly-once no Spring Kafka|Transações e exactly-once no Spring Kafka]].
