...
A consequência prática: se o seu único controle de acesso fosse CORS, qualquer atacante com `curl` leria tudo. Por isso **CORS nunca substitui autenticação/autorização**. Pense nele como uma conveniência do navegador, não como um portão. O portão é o filter chain de segurança (ver [[03-Dominios/Java/Segurança/06 - A arquitetura do filter chain em profundidade|A arquitetura do filter chain]]).
...
- [[03-Dominios/Java/Segurança/06 - A arquitetura do filter chain em profundidade|A arquitetura do filter chain]] (o `CorsFilter` na cadeia)
- [[03-Dominios/Java/Web e APIs REST/11 - Interceptors vs Filters|Interceptors vs Filters]] (onde o Galho 9 tratou filtros/CORS na camada MVC)
- [[03-Dominios/Java/Segurança/index|Segurança (MOC do galho)]]
- [[03-Dominios/Java/index|Trilha Java]]
- [[03-Dominios/Java/Dicionário de Java]] (verbete CORS)
