...
O foco é **servlet/MVC**: a segurança reativa (WebFlux Security) é fronteira pra frente. Testes de segurança (Galho 13 planejado), segurança em microservices (Galho 16 planejado) e segredos/cloud security (Galho 17 planejado) não têm cobertura aqui.
