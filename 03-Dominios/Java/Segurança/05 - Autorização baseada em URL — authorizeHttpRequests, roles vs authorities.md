...
- **`/actuator/**` está protegido com `hasRole("ADMIN")`** — sem isso, métricas, env e beans ficariam expostos. Combine com a configuração de exposição do [[03-Dominios/Java/Spring Core e Boot/17 - Actuator e observabilidade|Actuator]].
...
- [[03-Dominios/Java/Spring Core e Boot/17 - Actuator e observabilidade|Actuator e observabilidade]] (proteger os endpoints)
- [[03-Dominios/Java/Segurança/index|Segurança (MOC do galho)]]
- [[03-Dominios/Java/index|Trilha Java]]
- [[03-Dominios/Java/Dicionário de Java]] (verbetes authorizeHttpRequests / hasRole vs hasAuthority / RBAC)
