...
> [!note] JPMS e módulos
> Quando o projeto usa o sistema de módulos, a versão-alvo também influencia o que o `module-info` enxerga; veja [[03-Dominios/Java/JVM/08 - JPMS — o sistema de módulos|JPMS (Galho 3)]] para o lado da linguagem/runtime. Toolchain só decide *qual JDK* compila — não muda as regras de módulos.
...
- [[03-Dominios/Java/Build e tooling/09 - Distribuições do JDK e o ecossistema|Distribuições do JDK]]
- [[03-Dominios/Java/JVM/01 - A JVM — o que é e o pipeline de execução|A JVM (Galho 3)]]
- [[03-Dominios/Java/JVM/08 - JPMS — o sistema de módulos|JPMS (Galho 3)]]
