...
No ecossistema Java o SBOM costuma ser gerado pelo próprio build (Maven/Gradle), porque é o build que conhece o grafo de dependências resolvido — o mesmo grafo que você estuda em [[03-Dominios/Java/Build e tooling/10 - Resolução de dependências e conflitos de versão|resolução de dependências]].
...
- [[03-Dominios/Java/Build e tooling/17 - Reprodutibilidade e reproducible builds|Reprodutibilidade]]
- [[03-Dominios/Java/Build e tooling/19 - Publicação de artefatos|Publicação de artefatos]]
- [[03-Dominios/Java/Build e tooling/10 - Resolução de dependências e conflitos de versão|Resolução de dependências]]
