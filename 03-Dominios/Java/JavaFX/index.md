...
Este galho é um **refator com poda integral** do tronco [[JavaFX]] (`Frontend/JavaFX.md`): a seção JavaFX foi extraída, aprofundada e reorganizada em notas atômicas por fase. Fecha o **par desktop** da trilha Java junto com [[03-Dominios/Java/Swing/index|Swing (Galho 5)]].

**Fronteiras importantes:** a teoria geral de UI thread — single-thread model, Event Dispatch Thread, deadlock AWT — está no Galho 5 ([[03-Dominios/Java/Swing/05 - A Event Dispatch Thread|EDT]]); o sistema de módulos JPMS como conceito (requires/exports, classpath vs. module path) está no Galho 3 ([[03-Dominios/Java/JVM/08 - JPMS — o sistema de módulos|JPMS]]); concorrência de baixo nível (locks, executors, Java Memory Model) está no Galho 4.
...
- [[03-Dominios/Java/JVM/index|JVM por dentro (Galho 3)]]
- [[03-Dominios/Java/Concorrência e paralelismo/index|Concorrência e paralelismo (Galho 4)]]
- [[03-Dominios/Java/Swing/index|Swing (Galho 5)]]
