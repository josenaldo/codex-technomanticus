...
A **fronteira-assinatura** deste galho é que ele **linka, não re-explica**. A mecânica da linguagem mora em outro lugar e é de lá que se estuda; aqui fica só o recorte de prova. Concretamente: o [[03-Dominios/Java/Linguagem e sintaxe moderna/index|Galho 1]] cobre linguagem e sintaxe; o [[03-Dominios/Java/Collections e Streams/index|Galho 2]] cobre collections, streams, `java.time` e I/O com NIO; o [[03-Dominios/Java/JVM/index|Galho 3]] cobre a JVM e o sistema de módulos (JPMS); o [[03-Dominios/Java/Concorrência e paralelismo/index|Galho 4]] cobre concorrência; e o Galho 6 cobre `jlink`/`jpackage`. Cada domínio do exame aqui aponta de volta para essas notas. Não duplique conteúdo — siga o link.

## Sobre a prova

- [[03-Dominios/Java/Certificação OCP/01 - A certificação OCP — o que é, por que (e por que não) fazer|A certificação OCP — o que é, por que (e por que não) fazer]] — o valor real e as críticas honestas; OCA acabou.
- [[03-Dominios/Java/Certificação OCP/02 - Qual prova mirar — Java 21 (1Z0-830) vs Java 25 (1Z0-831)|Qual prova mirar — Java 21 (1Z0-830) vs Java 25 (1Z0-831)]] — as duas provas vigentes e como escolher.
- [[03-Dominios/Java/Certificação OCP/03 - Formato, logística e mecânica da prova|Formato, logística e mecânica da prova]] — 50 questões, ~68%, online proctored, as características traiçoeiras.
- [[03-Dominios/Java/Certificação OCP/04 - O mapa objetivo → galho — revisar a trilha pra prova|O mapa objetivo → galho — revisar a trilha pra prova]] — a nota-coração: cada domínio do exame mapeado às notas exatas dos galhos.

## Os domínios do exame

- [[03-Dominios/Java/Certificação OCP/05 - Domínio 1 — Datas, texto, números e booleanos|Domínio 1 — Datas, texto, números e booleanos]]
- [[03-Dominios/Java/Certificação OCP/06 - Domínio 2 — Controle de fluxo|Domínio 2 — Controle de fluxo]]
...
- [[03-Dominios/Java/Certificação OCP/09 - Domínio 5 — Arrays e coleções|Domínio 5 — Arrays e coleções]]
...
- [[03-Dominios/Java/Certificação OCP/15 - O catálogo de pegadinhas clássicas|O catálogo de pegadinhas clássicas]] — Integer cache, String pool, try/finally, static hiding, type erasure e companhia.
- [[03-Dominios/Java/Certificação OCP/16 - Estratégia de estudo e recursos|Estratégia de estudo e recursos]] — plano, livro Sybex, Enthuware, caderno de erros.
- [[03-Dominios/Java/Certificação OCP/17 - O dia da prova e depois|O dia da prova e depois]] — gestão de tempo, mentalidade, após passar ou reprovar.
...
- [[03-Dominios/Java/Collections e Streams/index|Collections e Streams (Galho 2)]]
...
- [[03-Dominios/Java/Core/Certificação Java OCP|Certificação OCP (tronco legado)]]
