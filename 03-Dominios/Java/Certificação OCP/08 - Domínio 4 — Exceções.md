...
- [[03-Dominios/Java/Linguagem e sintaxe moderna/10 - Exceções e tratamento de erros|Exceções e tratamento de erros (G1)]] — toda a mecânica.
...
> Mais armadilhas de fluxo e compilação estão reunidas em [[03-Dominios/Java/Certificação OCP/15 - O catálogo de pegadinhas clássicas|catálogo de pegadinhas]].
