...
- [[03-Dominios/Java/Linguagem e sintaxe moderna/02 - Tipos, variáveis e operadores|Tipos, variáveis e operadores (G1)]] — primitivos, wrappers, literais, operadores.
- [[03-Dominios/Java/Linguagem e sintaxe moderna/04 - Strings e text blocks|Strings e text blocks (G1)]] — String, pool, text blocks, StringBuilder.
- [[03-Dominios/Java/Collections e Streams/11 - java.time — Date e Time API|java.time — Date e Time API (G2)]] — toda a API de data/hora e formatação.
...
Para o conjunto completo, veja o [[03-Dominios/Java/Certificação OCP/15 - O catálogo de pegadinhas clássicas|catálogo de pegadinhas]].
