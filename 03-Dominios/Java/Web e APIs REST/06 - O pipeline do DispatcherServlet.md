...
- [[03-Dominios/Java/Jakarta EE/03 - Servlet API — o alicerce HTTP|Servlet API]] (a spec por baixo — o DispatcherServlet É um servlet, singleton multi-thread)
- [[03-Dominios/Java/Spring Core e Boot/16 - SpringApplication e o embedded server|SpringApplication e o embedded server]] (quem registra o DispatcherServlet)
- [[03-Dominios/Java/Web e APIs REST/index|Web e APIs REST]]
- [[03-Dominios/Java/index|Trilha Java]]
- Verbetes: [[03-Dominios/Java/Dicionário de Java#DispatcherServlet|DispatcherServlet]], [[03-Dominios/Java/Dicionário de Java#HandlerMapping|HandlerMapping]], [[03-Dominios/Java/Dicionário de Java#HandlerAdapter|HandlerAdapter]], [[03-Dominios/Java/Dicionário de Java#front controller|front controller]]
