...
- [[03-Dominios/Java/Spring Core e Boot/10 - Self-invocation e os limites do proxy|Self-invocation e os limites do proxy]] — por que a chamada interna via `this` fura o proxy, e como contornar.
- [[03-Dominios/Java/Jakarta EE/13 - CDI avançado — interceptors, decorators e extensões|CDI avançado — interceptors, decorators e extensões]] — o AOP da plataforma Jakarta é **interceptor-based** (o container intercepta via metadata de interceptor binding); o Spring é **proxy-based** (embrulha o bean num objeto-proxy). Mesma meta — modularizar *concerns* transversais — mecanismo diferente.
- [[03-Dominios/Java/Linguagem e sintaxe moderna/11 - Annotations|Annotations]] — a mecânica de annotations que sustenta `@Aspect`, `@Around` e os pointcuts `@annotation`.
- [[03-Dominios/Java/Spring Core e Boot/index|Spring Core e Boot (MOC do galho)]]
- [[03-Dominios/Java/index|Trilha Java]]
- Verbetes: [[03-Dominios/Java/Dicionário de Java#Spring AOP|Spring AOP]] · [[03-Dominios/Java/Dicionário de Java#advice (Spring AOP)|advice (Spring AOP)]] · [[03-Dominios/Java/Dicionário de Java#pointcut|pointcut]]
