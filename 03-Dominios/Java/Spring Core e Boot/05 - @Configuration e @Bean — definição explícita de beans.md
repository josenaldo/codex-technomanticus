...
- [[03-Dominios/Java/Jakarta EE/06 - CDI — qualifiers, producers e eventos|CDI — qualifiers, producers e eventos]] — o `@Produces` do CDI resolve a mesma necessidade (fabricar objetos que não são beans anotáveis), mas com mecanismo próprio do padrão Jakarta
- [[03-Dominios/Java/Spring Core e Boot/14 - Conditional beans — @Conditional e os @ConditionalOn|Conditional beans]] — combinando `@Bean` com `@ConditionalOnMissingBean` para registros opcionais
- [[03-Dominios/Java/Spring Core e Boot/index|Spring Core e Boot (MOC do galho)]]
- [[03-Dominios/Java/index|Trilha Java]]
- [[03-Dominios/Java/Dicionário de Java#@Configuration|@Configuration]]
- [[03-Dominios/Java/Dicionário de Java#@Bean|@Bean]]
