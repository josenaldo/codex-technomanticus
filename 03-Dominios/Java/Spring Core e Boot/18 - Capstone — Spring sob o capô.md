...
| --- | --- |
| "o que é Spring vs Boot vs ecossistema?" | [[03-Dominios/Java/Spring Core e Boot/01 - O que é Spring — Framework, Boot e o ecossistema\|01]] |
| "como o container injeta dependências?" | [[03-Dominios/Java/Spring Core e Boot/02 - IoC e injeção de dependência no Spring\|02]] |
| "quando uso @Service vs @Component?" | [[03-Dominios/Java/Spring Core e Boot/03 - Beans e estereótipos — @Component, @Service, @Repository, @Controller\|03]] |
| "construtor, setter ou field injection?" | [[03-Dominios/Java/Spring Core e Boot/04 - Tipos de injeção — constructor, setter, field\|04]] |
| "como definir um bean explicitamente?" | [[03-Dominios/Java/Spring Core e Boot/05 - @Configuration e @Bean — definição explícita de beans\|05]] |
| "o que é o ApplicationContext e seu ciclo?" | [[03-Dominios/Java/Spring Core e Boot/06 - ApplicationContext — o container e seu ciclo\|06]] |
| "ordem do ciclo de vida e escopos?" | [[03-Dominios/Java/Spring Core e Boot/07 - Ciclo de vida e escopos de beans\|07]] |
| "dois candidatos, qual o Spring escolhe?" | [[03-Dominios/Java/Spring Core e Boot/08 - Qualificação de beans — @Qualifier, @Primary, @Profile\|08]] |
| "como o AOP/proxy funciona?" | [[03-Dominios/Java/Spring Core e Boot/09 - AOP e proxies no Spring\|09]] |
| "por que @Transactional não pegou nesta chamada?" | [[03-Dominios/Java/Spring Core e Boot/10 - Self-invocation e os limites do proxy\|10]] |
| "como reagir a eventos do contexto?" | [[03-Dominios/Java/Spring Core e Boot/11 - Eventos do ApplicationContext\|11]] |
| "como separar config por ambiente?" | [[03-Dominios/Java/Spring Core e Boot/12 - Configuração e profiles\|12]] |
| "onde a auto-config mexe nas definitions?" | [[03-Dominios/Java/Spring Core e Boot/13 - BeanPostProcessor e BeanFactoryPostProcessor\|13]] |
| "como condicionar um bean ao classpath?" | [[03-Dominios/Java/Spring Core e Boot/14 - Conditional beans — @Conditional e os @ConditionalOn\|14]] |
| "como o Boot configura tudo sozinho?" | [[03-Dominios/Java/Spring Core e Boot/15 - Auto-configuration e starters\|15]] |

## Veja também

- [[03-Dominios/Java/Spring Core e Boot/02 - IoC e injeção de dependência no Spring|IoC e injeção de dependência no Spring]] — o motor de DI que esta capstone rastreia
- [[03-Dominios/Java/Spring Core e Boot/09 - AOP e proxies no Spring|AOP e proxies no Spring]] — onde os proxies da etapa 7 nascem
- [[03-Dominios/Java/Spring Core e Boot/13 - BeanPostProcessor e BeanFactoryPostProcessor|BeanPostProcessor e BeanFactoryPostProcessor]] — os dois pontos de extensão centrais do ciclo
- [[03-Dominios/Java/Spring Core e Boot/15 - Auto-configuration e starters|Auto-configuration e starters]] — o detalhe completo da camada do Boot
- [[03-Dominios/Java/Jakarta EE/14 - Jakarta EE hoje — a plataforma sob o Spring|Jakarta EE hoje — a plataforma sob o Spring]] — a capstone contraparte do Galho 7
- [[03-Dominios/Java/Jakarta EE/index|Jakarta EE]]
