...
- [[03-Dominios/Java/Jakarta EE/06 - CDI — qualifiers, producers e eventos|CDI — qualifiers, producers e eventos]] — os eventos do CDI (`@Observes` / `Event<T>`) são a versão da spec Jakarta do mesmo pub/sub in-process; o modelo conceitual é idêntico, a API é diferente.
- [[03-Dominios/Java/Concorrência e paralelismo/index|Concorrência e paralelismo]] — `@Async` delega a execução a um `TaskExecutor`; compreender pools de threads e `CompletableFuture` ajuda a dimensionar e depurar listeners assíncronos (Galho 4).
- [[03-Dominios/Java/Spring Core e Boot/index|Spring Core e Boot (MOC do galho)]]
- [[03-Dominios/Java/index|Trilha Java]]
- [[03-Dominios/Java/Dicionário de Java#@EventListener|@EventListener]] — verbete no dicionário da trilha.
