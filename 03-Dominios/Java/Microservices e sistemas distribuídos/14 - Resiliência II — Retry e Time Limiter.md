...
São dois padrões de resiliência complementares ao [[03-Dominios/Java/Microservices e sistemas distribuídos/13 - Resiliência I — a falha distribuída e o Circuit Breaker|Circuit Breaker]], implementados no Resilience4j (versão de referência: **2.4.0**, sobre Java 17 — não existe linha 3.x estável).
...
- [[03-Dominios/Java/Mensageria/20 - Idempotência — o pilar do at-least-once|Idempotência (Galho 14)]]
