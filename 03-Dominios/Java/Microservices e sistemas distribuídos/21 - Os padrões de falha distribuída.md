...
Os quatro padrões desta nota — timeout, retry seguro, circuit breaker, graceful degradation — existem todos para domar esse terceiro estado. As notas [[03-Dominios/Java/Microservices e sistemas distribuídos/13 - Resiliência I — a falha distribuída e o Circuit Breaker|13]] a [[03-Dominios/Java/Microservices e sistemas distribuídos/16 - Resiliência IV — compondo os padrões|16]] ensinaram *como* cada um funciona no Resilience4j (versão estável **2.4.0**, baseline Java 17). Esta nota é a **síntese de arquitetura**: como eles se encaixam numa postura coerente.
...
- [[03-Dominios/Java/Microservices e sistemas distribuídos/20 - Consistência em sistemas distribuídos|Consistência distribuída]]
