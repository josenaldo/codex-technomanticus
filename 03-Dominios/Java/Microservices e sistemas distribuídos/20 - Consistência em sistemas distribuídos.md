...
> **Como** se reconcilia a consistência entre serviços — o padrão **Saga** (transações distribuídas por eventos), o padrão **Outbox** (publicação confiável de eventos) e **idempotência** (reprocessar sem duplicar efeito) — é território do **Galho 14 (Mensageria)**. Esta nota explica *por que* a inconsistência é inevitável e *qual* é o trade-off; os mecanismos de resolução têm notas próprias. Veja [[03-Dominios/Java/Mensageria/22 - Saga — transações distribuídas por eventos|Saga (Galho 14)]] e [[03-Dominios/Java/Mensageria/21 - O padrão Outbox|Outbox (Galho 14)]]. Aqui a gente **linka, não re-deriva**.
...
- [[03-Dominios/Java/Mensageria/22 - Saga — transações distribuídas por eventos|Saga (Galho 14)]]
- [[03-Dominios/Java/Mensageria/21 - O padrão Outbox|Outbox (Galho 14)]]
