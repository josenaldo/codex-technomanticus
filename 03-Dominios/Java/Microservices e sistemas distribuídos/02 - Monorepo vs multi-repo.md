...
**Por que erra:** são eixos diferentes. Multi-módulo é a estrutura interna de **um build** (um projeto, vários `pom.xml` filhos compilados juntos), tema do [[03-Dominios/Java/Build e tooling/12 - Projetos multi-módulo|Galho 15]]. Multi-repo é a organização de **repositórios de serviços deployáveis**, com release e ownership independentes. Um único repo pode conter um projeto multi-módulo; um monorepo pode conter dezenas de projetos single-module.
...
- [[03-Dominios/Java/Microservices e sistemas distribuídos/01 - O que são microservices e a tese honesta|O que são microservices]]
...
- [[03-Dominios/Java/Build e tooling/12 - Projetos multi-módulo|Projetos multi-módulo (Galho 15)]]
