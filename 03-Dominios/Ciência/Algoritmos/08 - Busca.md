...
> Para "k-ésimo *maior*" há uma solução alternativa com **heap de tamanho k**: mantenha um min-heap dos k maiores vistos até agora, em O(n log k) — veja [[03-Dominios/Ciência/Estruturas de Dados/index|Estruturas de Dados]]. Qual escolher?
...
- k-ésimo via heap (alternativa de streaming): [[03-Dominios/Ciência/Estruturas de Dados/index|Estruturas de Dados]].
