...
Problema: uma lista encadeada pode ter um **ciclo** (um nó cujo `next` aponta de volta pra um nó anterior). Como detectar, **sem espaço extra**? (Veja [[03-Dominios/Ciência/Estruturas de Dados/index|Estruturas de Dados]] para a linked list.)
...
- Estruturas de apoio (linked list, HashSet/HashMap): [[03-Dominios/Ciência/Estruturas de Dados/index|Estruturas de Dados]]
