...
- **MOC do galho:** [[03-Dominios/Ciência/Algoritmos/index|Algoritmos]] — o mapa completo: análise, famílias de algoritmos clássicos e o capstone de reconhecimento de padrões.
- **Relacionada:** [[03-Dominios/Ciência/Estruturas de Dados/index|Estruturas de Dados]] — algoritmos não vivem no vácuo; eles operam sobre estruturas, e a escolha da estrutura muda a complexidade do algoritmo.
