...
Isso é a realização física da **máquina de Turing universal**: o programa *é* a fita, lida e interpretada pelo mesmo mecanismo. Veja a conexão formal em [[03-Dominios/Ciência/Teoria da Computação/10 - Decidível, reconhecível e a máquina universal]].
...
Para a conexão formal com decidibilidade e a prova de que a UTM existe, veja [[03-Dominios/Ciência/Teoria da Computação/10 - Decidível, reconhecível e a máquina universal]].
