...
> `eval()` de input de usuário é a forma mais rápida de introduzir injeção de código. Nunca execute código arbitrário vindos de fontes não confiáveis. Essa é a categoria de vulnerabilidade "code injection" — mencionada em [[03-Dominios/Engenharia/Segurança/16 - Classes de vulnerabilidade]].
