---
title: Prova social e portfolio fractional
created: 2026-07-08
updated: 2026-07-08
type: concept
status: seedling
...
> [!question]- Por que "confia em mim" não converte, mesmo sendo verdade?
> Porque decisão de contratar fractional é decisão de risco compartilhado — o cliente está apostando meses de orçamento e, frequentemente, decisões estruturais da empresa nas suas mãos. Prova social reduz esse risco percebido transformando afirmação ("eu resolvo esse tipo de problema") em evidência ("aqui está um caso concreto, com número, de alguém que teve exatamente esse problema resolvido").

A prova social eficaz se constrói em três camadas, que se reforçam:

| Camada | O que é | Por que funciona |
|--------|---------|-------------------|
| **Case studies com métrica** | Desafio específico → ação tomada → resultado mensurável (antes/depois) | Dá ao cliente algo concreto pra comparar com o próprio problema — não é opinião, é registro |
| **Presença pública consistente** | Conteúdo técnico regular (LinkedIn, blog, palestras) sobre o nicho escolhido | Cria familiaridade antes do primeiro contato; ~metade dos fractionals aponta presença online como principal alavanca de crescimento |
| **Ativos que geram confiança antes da conversa** | Auditoria gratuita curta, checklist, relatório de diagnóstico rápido | Demonstra competência na prática, em pequena escala, antes de pedir compromisso de retainer |

### Case studies: o formato que converte

> [!question]- O que exatamente entra num case study, se o contrato tem cláusula de confidencialidade?
> Case studies fractional raramente citam o nome do cliente sem autorização explícita — o padrão é anonimizar ("uma fintech Series A") mantendo o que importa: o desafio específico, a ação tomada, e o resultado com número. "Ajudei uma fintech Series A a reduzir o tempo de deploy de 3 dias para 40 minutos, permitindo iterar 2x mais rápido antes da rodada seguinte" carrega prova mesmo sem revelar quem é o cliente. Confidencialidade e prova social não são incompatíveis — só exigem negociar de antemão, no contrato, o que pode virar case study público (ver [[13 - Anatomia de um contrato internacional de serviço]]).
...
> [!info] Sobre este bloco de notas
...
| Auditoria gratuita | Free audit / complimentary assessment |
| Marca pessoal | Personal brand |
| Ativo de confiança | Trust-building asset |

## Veja também

- [[03-Dominios/Carreira/Entrevistas/STAR Method|STAR Method]] — a mesma disciplina de contar resultado com evidência concreta, aplicada a entrevistas em vez de venda fractional
...
- [[07 - Canais de prospecção e marketplaces fractional]] — onde publicar, buscar e ser encontrado
- [[09 - Do discovery call ao contrato assinado]] — como converter interesse em contrato

## Fontes

- **Prose Media** — [How to make the leap to fractional work (and actually get clients)](https://www.prosemedia.com/blog/how-to-make-the-leap-to-fractional-work-and-actually-get-clients) — especificidade, credibilidade e consistência como traços de marca pessoal que converte
- **Executive Career Partners** — [Fractional Clients for Executives](https://www.ecp-careers.com/fractional-executive-branding-client-acquisition/) — impacto de branding em taxa de retainer (+40% para perfis visíveis) e ativos de confiança pré-venda
- **Umbrex** — [Building a Career as a Fractional Executive](https://umbrex.com/resources/fractional-executive-playbook/building-a-career-as-a-fractional-executive/) — papel da rede existente nos primeiros clientes
