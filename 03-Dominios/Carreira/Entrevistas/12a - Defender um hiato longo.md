...
aliases:
  ...
  - Como responder sobre o gap na entrevista
  - Gap answer
  - A pergunta por baixo da pergunta
  - Hiato de saúde em entrevista
---
...
graph TD
    ...
    R3 --> R4["4. Ancorar num<br/>par de números"]
    R4 --> R5["5. Declarar o custo<br/>antes que descubram"]

    P -.atalho tentador.-> E1["Cronologia da ausência —<br/>a resposta da Helena<br/>na primeira versão"]
