...
- **Estado:** ✅ **podada para ponte (2026-08-21)** · fase: iniciado · ~89 linhas
- **Escopo:** desde que o galho [[03-Dominios/Carreira/Currículo/index|Currículo]] (27 notas) abriu, esta nota deixou de ser a casa da mecânica do bullet, do formato ATS e do LinkedIn — virou nota-ponte, no mesmo padrão da nota 09. Mantém só o que pertence a Entrevistas: onde os dois artefatos se encaixam na etapa de triagem do funil, e o que a triagem está de fato medindo (aderência e clareza no currículo; descoberta e consistência no LinkedIn). A fórmula da linha de bullet e a crítica a "responsável por" migraram para a [[03-Dominios/Carreira/Currículo/11 - A linha de bullet|nota 11]]; as armadilhas de formato e de LinkedIn para as notas [[03-Dominios/Carreira/Currículo/05 - Formato e legibilidade de máquina|05]] e [[03-Dominios/Carreira/Currículo/23 - LinkedIn — o par que responde a busca|23]]; as especificidades de mercado internacional para a [[03-Dominios/Carreira/Currículo/24 - Mercados, e o Brazilian Cultural Bug|nota 24]]; a adaptação por vaga para a [[03-Dominios/Carreira/Currículo/18 - Adaptar por vaga sem reescrever|nota 18]]. Fecha o bloco Iniciado.
...
#### 12a - Defender um hiato longo   [substantivo, broto]
- **Estado:** ✅ escrita (2026-08-31) · fase: magus · broto sob a nota 12
- **Origem:** fora do plano original das 14 notas. Aberta em 2026-08-31 junto com [[03-Dominios/Carreira/Currículo/16a - Lacuna longa e reentrada|Currículo/16a]], depois de um grep confirmar que o galho inteiro não tinha **nenhuma** ocorrência de hiato/gap/retorno ao mercado — e que a pergunta sobre vão no histórico não cabe em nenhuma das sete famílias comportamentais da nota 07 (não é "conte uma vez que...", é pergunta de trajetória).
- **Tese:** o hiato não é a red flag — a resposta sobre ele é. Aplicação direta da nota 12 a um fato que o candidato não produziu.
- **Escopo:** o erro estrutural de responder à pergunta literal em vez da pergunta por baixo ("você é confiável agora?"); os **cinco movimentos** (reformulação em uma frase → nomear a pergunta real → a restrição como origem da disciplina → evidência com dado duro → trade-off cultural declarado), estendendo o procedimento de 3 movimentos da nota 19 do Currículo; o eixo legal que quase nenhum guia menciona — ADA/EEOC proíbe pergunta médica **antes da oferta condicional** nos EUA, LGPD trata saúde como dado sensível no Brasil, e o valor disso é **postural, não jurídico** (nunca citar a lei numa entrevista); 5 armadilhas (detalhe médico na abertura, apologético, guerreiro, pedir compreensão, não ensaiar); tabela de calibragem por etapa do funil (60s em triagem × 2,5-3min com hiring manager); 4 follow-ups previsíveis; 2 casos práticos (hiato **com** projeto dentro × hiato **sem** nada dentro, que é o caso honesto que os guias fingem não existir).
- **Interfaces produzidas:** o par com `Currículo/16a`; item novo em "O que vem a seguir" da nota 12; entrada no `index.md` como sub-item da 12. Seção "Como explicar em inglês" com o script de 4 frases + 10 termos PT↔EN.
- **Verificação:** Mermaid validado (1 bloco, 0 quebrados); wikilinks conferidos na mesma rodada do 16a, 0 quebrados nesta nota. Fontes: EEOC (2 páginas, consultadas ao vivo 2026-08-31), LGPD Art. 5º II, Kroft/Lange/Notowidigdo (QJE 2013).
- **Correção de 2026-08-31:** o caso real foi reescrito depois de o autor esclarecer que o afastamento termina em nov/2019, no projeto de pesquisa, e que o período seguinte é freelance. Entrou uma armadilha nova — **"Estender a defesa para além do afastamento"** —, que é o erro simétrico e autoinfligido: aplicar o tom grave dos cinco movimentos a intervalo entre contratos transforma ritmo normal de freelance em confissão.
- **Pendências:** M1 (mídia). A estrutura de 5 movimentos foi **generalizada** de material privado de preparação do autor — a nota não referencia nem cita esse material, conforme o isolamento público/apocrypha.
