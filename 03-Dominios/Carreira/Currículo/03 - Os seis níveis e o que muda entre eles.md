---
title: "Os seis níveis e o que muda entre eles"
created: 2026-08-20
updated: 2026-08-20
type: concept
status: seedling
...
aliases:
  ...
  - Níveis de senioridade em currículo de TI
  - Estagiário, trainee, júnior, pleno, sênior, staff
  - Regra de páginas do currículo por nível
---
...
graph LR
    ...
    Pl -.cresce.-> S1
    Sr -.cresce mais.-> S2["liderança técnica<br/>sem cargo de gestão"]
    Sr -.cresce mais.-> S3["decisão de<br/>arquitetura"]
    St -.no máximo.-> S4["mentoria<br/>em escala"]

    Est -.no máximo.-> D1["stack linha<br/>a linha"]
    Jr -.ainda forte.-> D2["tarefa de<br/>dia a dia"]
    Pl -.enfraquece.-> D3["certificação<br/>básica"]
    Sr -.quase some.-> D1
    St -.quase some.-> D2
