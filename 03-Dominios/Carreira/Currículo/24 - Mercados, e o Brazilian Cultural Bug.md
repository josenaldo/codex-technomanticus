---
title: "Mercados, e o Brazilian Cultural Bug"
created: 2026-08-20
updated: 2026-08-20
type: concept
status: seedling
...
tags:
  ...
  - mercados
  - internacionalizacao
  - brazilian-cultural-bug
publish: true
aliases:
  - Mercados, e o Brazilian Cultural Bug
  - Brazilian Cultural Bug
  - Currículo internacional
  - Brasil x EUA x Europa no currículo
  - BLUF vs. alto contexto
---
...
graph LR
    ...
    subgraph BR["Padrão brasileiro de alto contexto"]
        ...
        B3["Postura apologética"]
        B4["'Nós' difuso"]
        B5["Vender sacrifício"]
        B6["Ancorar em custo de vida"]
    end
    subgraph EX["Padrão executivo internacional"]
        E1["BLUF"]
        E2["Verbo de propriedade"]
        E3["Abrir pelo impacto"]
        E4["'Eu' cravado"]
        E5["Vender alavancagem"]
        E6["Ancorar em valor entregue"]
    end
    B1 -->|"mesmo fato,<br/>ordem invertida"| E1
    B2 -->|"mesmo fato,<br/>sujeito explicitado"| E2
    B3 -->|"mesma dificuldade,<br/>dita depois"| E3
    B4 -->|"mesmo crédito,<br/>contribuição isolada"| E4
