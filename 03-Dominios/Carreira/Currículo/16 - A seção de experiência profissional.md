---
title: "A seção de experiência profissional"
created: 2026-08-20
updated: 2026-08-20
type: concept
status: seedling
...
tags:
  ...
  - lacuna-de-emprego
  - pj-e-freelance
  - agencia-e-consultoria
publish: true
aliases:
  - A seção de experiência profissional
  - Ordem e densidade da experiência no currículo
  - Lacuna de emprego no currículo
  - PJ, freelance e agência no currículo
  - Mesmo empregador, vários cargos
  - Sobreposição de vínculos no currículo
---
...
graph TD
    A["Cargo atual /<br/>mais recente"] --> B["4-6 bullets<br/>detalhe completo"]
    C["Cargo de<br/>5-8 anos atrás"] --> D["2-3 bullets<br/>menos contexto"]
    E["Experiência inicial<br/>de carreira"] --> F{"Ainda relevante<br/>para a vaga?"}
    F -->|"pouco, mas presente"| G["Uma linha:<br/>cargo, empresa, período"]
    F -->|"vários itens curtos<br/>do mesmo período"| H["Agrupar sob<br/>um cabeçalho comum"]
    F -->|"nenhuma relação<br/>com a direção atual"| I["Omitir<br/>(curadoria, não ocultação)"]
...
> [!example] Caso real
> A trajetória pública do autor deste vault registra exatamente esse padrão, entre outubro de 2011 e outubro de 2012, como Senior Backend Developer na TQI, em Uberlândia. O vínculo formal era com a TQI; o trabalho acontecia alocado no cliente Buscapé — uma grande plataforma brasileira de comparação de preços de e-commerce —, projetando arquitetura backend de alto tráfego junto ao time do cliente. A descrição pública nomeia as duas empresas lado a lado: o cargo e a contratação formal são da TQI, e a linha de ação registra explicitamente "worked directly at Buscapé client site, collaborating closely with their teams" — o trabalho técnico real pertence ao contexto de Buscapé, não ao nome que consta no cabeçalho. Um leitor que só visse "TQI", sem essa segunda camada, perderia o dado mais relevante para avaliar o peso técnico: que se tratava de arquitetura para uma grande plataforma brasileira de e-commerce, não de um projeto interno de porte desconhecido. (Fonte: [josenaldo.com.br/experiences](https://josenaldo.com.br/experiences), verificado ao vivo em 2026-08-20.)
