...
aliases:
  ...
  - Levantamento de evidência para o currículo
  - O que já existe antes de sair procurando o que falta
  - Converter trajetória em material de currículo
---
...
flowchart LR
    ...
    subgraph Portas["Porta de entrada (nota 02)"]
        ...
        P1["1. Estágio"]
        P2["2. Trainee"]
        P3["3. Iniciação científica"]
        P4["4. Curso técnico"]
        P5["5. Bootcamp"]
        P6["6. Autodidata"]
        P7["7. Transição de carreira"]
        P8["8. Virada interna"]
        P9["9. Projeto próprio"]
        P10["10. Open source"]
    end

    subgraph Evidencia["Onde a evidência está esquecida"]
        direction TB
        E1["Avaliação do supervisor"]
        E2["Devolutiva de cada área"]
        E3["Relatório / resumo publicado"]
        E4["Projeto de bancada"]
        E5["Repositório de projetos do curso"]
        E6["Histórico de commits"]
        E7["Relatório da área anterior"]
        E8["E-mail de reconhecimento"]
        E9["Analytics / recibo de cliente"]
        E10["Discussão de PR / issue"]
    end

    subgraph Duvida["Dúvida do leitor"]
        direction TB
        D1["Autonomia"]
        D2["Área final + seletividade"]
        D3["Prazo comercial"]
        D4["Maturidade e continuidade"]
        D5["Profundidade real"]
        D6["Consistência sem supervisão"]
        D7["Compromisso com a mudança"]
        D8["Há quanto tempo, de fato"]
        D9["Viés de autorrelato"]
        D10["Substância vs. pontual"]
    end
