...
**Wilson, K. & Caliskan, A.**, num estudo publicado na AAAI/ACM AIES 2024, testaram exatamente isso: um sistema de recuperação por modelo de linguagem ranqueando mais de 500 currículos reais contra mais de 500 descrições de vaga reais — o cruzamento entre os dois lados é o que dá força ao resultado, não uma pilha isolada de documentos. O resultado, medido, não estimado: **nomes associados a candidatos brancos foram preferidos em 85,1% dos casos**, enquanto nomes associados a mulheres foram favorecidos em **apenas 11,1% dos casos** — o eixo de gênero pesa contra as mulheres, não a favor dos homens como se poderia supor de relance. E o cruzamento das duas dimensões é o dado mais duro do estudo: **homens negros foram desfavorecidos em até 100% dos casos** nas interseções de raça e gênero testadas — não é a categoria "mais penalizada" num sentido brando, é a penalização no limite máximo que a medição permite. Um estudo de acompanhamento da Universidade de Washington, de novembro de 2025, foi além e testou o efeito em cascata: quando humanos avaliam candidatos depois de ver um ranking já enviesado gerado por IA, **eles tendem a absorver o mesmo viés no próprio julgamento**, mesmo sem saber que o ranking anterior era tendencioso.
...
- **Wilson, K. & Caliskan, A.** — "Gender, Race, and Intersectional Bias in Resume Screening via Language Model Retrieval", AAAI/ACM AIES 2024 — <https://arxiv.org/abs/2407.20371>. Mede viés real em triagem automatizada por modelo de linguagem sobre mais de 500 currículos reais cruzados com mais de 500 descrições de vaga reais; não mede nada sobre ATS tradicional baseado em regras, nem sobre os três mitos desta nota — é a âncora de evidência sólida para a nota 25, não para esta. Números conferidos diretamente no abstract em 2026-08-20 (ver `roadmap.md`).
