---
title: "As portas de entrada no mercado"
created: 2026-08-20
updated: 2026-08-20
type: concept
status: seedling
...
aliases:
  ...
  - Portas de entrada em tecnologia
  - Estágio e trainee não são níveis
  - Caminhos de entrada no mercado de TI
---
...
graph TD
    ...
    M --> P1["1. Estágio"]
    M --> P3["3. Iniciação científica"]
    M --> P4["4. Curso técnico / IF"]
    M -.recém-formado.-> P2["2. Trainee"]

    S -.porta fechada.-> FECH["Sem acesso a<br/>estágio e IC"]
    P1 -.exige M.-> FECH2["fechada para quem<br/>não estuda"]

    S --> P5["5. Bootcamp"]
    S --> P6["6. Autodidata puro"]
    S --> P7["7. Transição de carreira"]
    S --> P8["8. Virada interna"]
    S --> P9["9. Projeto próprio / freelance"]
    S --> P10["10. Comunidade / open source"]
    M --> P5
    M --> P6
    M --> P7
    M --> P8
    ...
    P1 --> EST["Estagiário<br/>até 2 anos (Art. 11)"]
    P3 --> EST
    P4 --> EST
    P2 --> TRA["Trainee<br/>12-24 meses (mercado)"]

    EST -.acúmulo de evidência.-> JR["Júnior"]
    TRA -.acúmulo de evidência.-> JR
    P5 --> JR
    P6 -.sem crivo institucional,<br/>entra direto.-> JR
    P7 --> JR
    P8 --> JR
    P9 --> JR
    P10 --> JR
...
> [!example] Caso real
> Em 1999, Josenaldo Matos fez seu primeiro software: um sistema em Access para uma empresa de Itabuna. Entrou sem saber nada sobre a ferramenta, aprendeu ali mesmo, no próprio trabalho — implementou tabelas, consultas, relatórios e menus, e deu manutenção ao sistema durante o ano inteiro. É a porta 8 desta nota, virar dev por dentro da própria oportunidade, num momento em que ele ainda nem tinha entrado numa graduação. Foi essa experiência que o motivou a entrar no curso de graduação em 2000. Foi bolsista de iniciação científica no laboratório Labbi, na UESC, de abril de 2003 a agosto de 2004, num projeto que se estendeu até 2005 — a porta 3 — e é essa a experiência que ele mesmo considera sua primeira experiência profissional de fato, ainda que, tecnicamente, fosse uma bolsa acadêmica, não um vínculo empregatício. (A distinção entre a duração do projeto e a duração da própria bolsa é, ela mesma, o tipo de detalhe que um currículo malfeito costuma borrar, e que quem entrevista confere contra o LinkedIn.) Em novembro de 2003, entrou no CEPEDI como Java Júnior — não como estagiário —, contratação viabilizada pelo orientador do Labbi, que era diretor da instituição naquele momento. Em 2005 ou 2006, foi para a PROPP, a pró-reitoria de pós-graduação e pesquisa da UESC, com o mesmo orientador — agora pró-reitor —, antes de retornar ao CEPEDI. Link verificável: [josenaldo.com.br/experiences](https://josenaldo.com.br/experiences).
